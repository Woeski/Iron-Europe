  ...
  ("game_profile_banner_selection", 0, mesh_load_window, [
    (ti_on_presentation_load, [
      ...
      (try_for_range, ":cur_banner_mesh", banner_meshes_begin, banner_meshes_end_minus_one),
        (lt, ":cur_banner_mesh", "mesh_banner_d11"), #We haven't made banners after this yet
    ...
    (ti_on_presentation_event_state_change, [
      ...
      (try_begin),
        ...
        (val_mod, "$g_presentation_page_no", 5), #8
        (presentation_set_duration, 0),
  ...
  ("game_multiplayer_admin_panel", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
	  ...
	  (else_try),
		(this_or_next|eq, "$g_multiplayer_selected_map", "scn_mp_beach_morning"),
        (eq, "$g_multiplayer_selected_map", "scn_mp_beach_evening"),
        (assign, ":map_image", "mesh_scn_mp_russian_village_select"),
	 (else_try),
		(this_or_next|eq, "$g_multiplayer_selected_map", "scn_mp_dust"),
        (eq, "$g_multiplayer_selected_map", "scn_mp_dust_night"),
        (assign, ":map_image", "mesh_scn_mp_walloon_farm_select"),
      (else_try),
      ...
      (try_begin),
        ...
        (val_add, ":cur_y", ":cur_y_adder"), #one more option for these modes
        (eq, "$g_multiplayer_game_type", multiplayer_game_type_commander),
        (val_add, ":cur_y", ":cur_y_adder"), #three more options for this mode
        (val_add, ":cur_y", ":cur_y_adder"),
        (val_add, ":cur_y", ":cur_y_adder"),
      (try_end),
      ...
      (create_number_box_overlay, "$g_presentation_obj_admin_panel_54", 0, 1001),
      (position_set_x, pos1, ":number_box_x"),
      (position_set_y, pos1, ":cur_y"),
      ...
      (create_number_box_overlay, "$g_presentation_obj_admin_panel_55", 0, 1001),
      (position_set_x, pos1, ":number_box_x"),
      (position_set_y, pos1, ":cur_y"),
      ...
      (create_number_box_overlay, "$g_presentation_obj_admin_panel_8", 3, multiplayer_game_max_points),
      (position_set_x, pos1, ":number_box_x"),
      (position_set_y, pos1, ":cur_y"),
      ...
      (try_begin),
        ...
        # (val_sub, ":cur_y", ":cur_y_adder"), useless riflemen subclass  stuff - replaced by snipers
        ...
        (overlay_set_val, "$g_presentation_obj_admin_panel_46", "$g_limit_machinegunner"),

        (val_sub, ":cur_y", ":cur_y_adder"),
        
        # (create_text_overlay, reg0, "str_limit_lancer", 0), crap for cavalry subclasses
        # (position_set_x, pos1, 0),
        # (position_set_y, pos1, ":cur_y"),
        # (overlay_set_position, reg0, pos1),
        ...
        (create_text_overlay, reg0, "str_limit_sentry", 0),
        (position_set_x, pos1, 0),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),

        (create_number_box_overlay, "$g_presentation_obj_admin_panel_73", 0, 101),
        (position_set_x, pos1, ":number_box_x"),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_admin_panel_73", pos1),
        (overlay_set_val, "$g_presentation_obj_admin_panel_73", "$g_limit_sentry"),
		
	   (val_sub, ":cur_y", ":cur_y_adder"),
		
		(create_text_overlay, reg0, "str_limit_medic", 0),
        (position_set_x, pos1, 0),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        ...
        (overlay_set_val, "$g_presentation_obj_admin_panel_74", "$g_limit_medic"),
		 
		(val_sub, ":cur_y", ":cur_y_adder"),
		
	
		
		(create_text_overlay, reg0, "str_limit_heavy_grenadier", 0),
        (position_set_x, pos1, 0),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),

        (create_number_box_overlay, "$g_presentation_obj_admin_panel_75", 0, 101),
        (position_set_x, pos1, ":number_box_x"),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_admin_panel_75", pos1),
        (overlay_set_val, "$g_presentation_obj_admin_panel_75", "$g_limit_heavy_grenadier"),
		
	   (val_sub, ":cur_y", ":cur_y_adder"),
		
		(create_text_overlay, reg0, "str_limit_general_new", 0),
        (position_set_x, pos1, 0),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),

        (create_number_box_overlay, "$g_presentation_obj_admin_panel_76", 0, 101),
        (position_set_x, pos1, ":number_box_x"),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_admin_panel_76", pos1),
        (overlay_set_val, "$g_presentation_obj_admin_panel_76", "$g_limit_general_new"),
...
##        (try_end),
	 ...
	 (else_try),
         ...
         (multiplayer_send_2_int_to_server, multiplayer_event_admin_set_mod_variable, mod_variable_limit_sentry, ":value"),
	(else_try),
         (eq, ":object", "$g_presentation_obj_admin_panel_74"),
         (multiplayer_send_2_int_to_server, multiplayer_event_admin_set_mod_variable, mod_variable_limit_medic, ":value"),
	(else_try),
         (eq, ":object", "$g_presentation_obj_admin_panel_75"),
         (multiplayer_send_2_int_to_server, multiplayer_event_admin_set_mod_variable, mod_variable_limit_heavy_grenadier, ":value"),
	(else_try),
         (eq, ":object", "$g_presentation_obj_admin_panel_76"),
         (multiplayer_send_2_int_to_server, multiplayer_event_admin_set_mod_variable, mod_variable_limit_general_new, ":value"),
      (try_end),
      ]),
    (ti_on_presentation_run,
     [
      ...
      (else_try),
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (assign,":faction_base_troop", "trp_britishStandardInfantry"),
          (else_try),
            (eq,":my_faction","fac_france"),
            (assign,":faction_base_troop", "trp_frenchStandardInfantry"),
          (else_try),
            (eq,":my_faction","fac_prussia"),
            (assign,":faction_base_troop", "trp_germanStandardInfantry"),
          (else_try),
     ...
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (try_begin),
		  ...
		  (try_begin),
            (eq,"$g_original_selected_troop","trp_french_chauchat_gunner"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_mg_gunner", 0),
          (else_try),
            (eq,"$g_original_selected_troop","trp_german_machinegunner"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_mg_gunner", 0),
		(else_try),
			(eq,"$g_original_selected_troop","trp_germanstormtrooper"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_pioneer", 0),
		  (else_try),
            (eq,"$g_original_selected_troop","trp_frenchbomber"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_french_bomber", 0),
		 (else_try),
            (eq,"$g_original_selected_troop","trp_french_arty"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_artilleryman", 0),
		(else_try),
            (eq,"$g_original_selected_troop","trp_prussian_arty_mortar"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_mortar_squad", 0),
		 (else_try),
            (eq,"$g_original_selected_troop","trp_prussian_arty"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_artilleryman", 0),
		 (else_try),
            (eq,"$g_original_selected_troop","trp_german_heavy_mg_gunner"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_mg_gunner", 0),
		 (else_try),
            (eq,"$g_original_selected_troop","trp_german_heavy_mg_assistant"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_mg_assistant", 0),
		 (else_try),
            (eq,"$g_original_selected_troop","trp_german_heavy_mg_ammo_carrier"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_mg_ammo_bearer", 0),
          (else_try),
            (eq,"$g_original_selected_troop","trp_french_heavy_mg_gunner"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_mg_gunner", 0),
		 (else_try),
            (eq,"$g_original_selected_troop","trp_french_heavy_mg_assistant"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_mg_assistant", 0),
		 (else_try),
            (eq,"$g_original_selected_troop","trp_french_heavy_mg_ammo_carrier"),
            (create_button_overlay, "$g_presentation_obj_rank_select_1", "str_mg_ammo_bearer", 0),
          (else_try),
...
#              (troop_get_inventory_slot, ":item_id", ":cur_troop", ":i_slot"),
              ...
              (try_begin), #Check for multiple versions of item type
                ...
                (this_or_next|eq,":item_class",multi_item_class_type_sword), #Swords
  ...
  ("multiplayer_escape_menu", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (assign, "$g_presentation_obj_escape_menu_19", -1),
      # Vincenzo end
      (try_begin),
        (multiplayer_get_my_team,":my_team"),
      ...
      (try_begin),
        ...
        (create_button_overlay, "$g_presentation_obj_escape_menu_16", "str_freeze_player", 0),
        (overlay_set_color, "$g_presentation_obj_escape_menu_16", 0xFFFFFF),
        (create_button_overlay, "$g_presentation_obj_escape_menu_17", "str_swap_player", 0),
        (overlay_set_color, "$g_presentation_obj_escape_menu_17", 0xFFFFFF),
        (create_button_overlay, "$g_presentation_obj_escape_menu_18", "str_spec_player", 0),
        (overlay_set_color, "$g_presentation_obj_escape_menu_18", 0xFFFFFF),
        (create_button_overlay, "$g_presentation_obj_escape_menu_19", "str_admin_cheats", 0),
        (overlay_set_color, "$g_presentation_obj_escape_menu_19", 0xFFFFFF),
        # Vincenzo end
      (try_end),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (else_try),
		  ...
		  (overlay_set_text, "$g_admin_chat_2","str_intern_admin_chat"),
  ...
  ("multiplayer_cheat_menu", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_end),
      (try_begin),
        (create_button_overlay, "$g_presentation_obj_cheat_menu_6", "str_cheat_heal_player", 0),
        (overlay_set_color, "$g_presentation_obj_cheat_menu_6", 0xFFFFFF),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_cheat_menu_6", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
      (try_end),
      (try_begin),
        (create_button_overlay, "$g_presentation_obj_cheat_menu_7", "str_cheat_ammo_player", 0),
        (overlay_set_color, "$g_presentation_obj_cheat_menu_7", 0xFFFFFF),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_cheat_menu_7", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
      (try_end),
      (try_begin),
        (create_button_overlay, "$g_presentation_obj_cheat_menu_8", "str_cheat_beacon_player", 0),
        (overlay_set_color, "$g_presentation_obj_cheat_menu_8", 0xFFFFFF),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_cheat_menu_8", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
      (try_end),
      (try_begin),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_cheat_menu_6"),
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", players_list_action_heal), # heal player
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_cheat_menu_7"),
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", players_list_action_ammo,0xFFFFF0), # ammo player
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_cheat_menu_8"),
        (presentation_set_duration, 0),
...
##            (call_script, "script_update_order_panel", ":player_team"),
  ...
  ("multiplayer_music", prsntf_manual_end_only, 0, [ #MM
   ...
   ("conquest_flag_select",prsntf_manual_end_only,0,[
      (ti_on_presentation_load,
      [
        (set_fixed_point_multiplier, 1000),
...
#          (try_end),
   ...
   ("radio_map",prsntf_manual_end_only,0,[
      (ti_on_presentation_load,
      [
        (set_fixed_point_multiplier, 1000),
		
		(assign, ":instance_id", "$g_cur_radio_instance"),
		(prop_instance_is_valid, ":instance_id"),
		(prop_instance_play_sound, ":instance_id", "snd_ie_tune_radio"),
...
#          (try_end),
        ...
        (overlay_set_size, "$g_presentation_obj_flag_done", pos51),
		 ...
		 (create_button_overlay, "$g_presentation_obj_flag_call_artillery", "str_call_artillery", 0),
        (try_begin),
          (gt,"$g_current_selected_flag",-1),
          (overlay_set_color, "$g_presentation_obj_flag_call_artillery", 0xFFFFFF),
          (overlay_set_hilight_color, "$g_presentation_obj_flag_call_artillery", 0x55FF50),
        (else_try),
          (overlay_set_color, "$g_presentation_obj_flag_call_artillery", 0x888888),
          (overlay_set_hilight_color, "$g_presentation_obj_flag_call_artillery", 0x888888),
        (try_end),
        (position_set_x, pos51, 600),
        (position_set_y, pos51, 80),
        (overlay_set_position, "$g_presentation_obj_flag_call_artillery", pos51),
        (position_set_x, pos51, 1500),
        (position_set_y, pos51, 1500),
        (overlay_set_size, "$g_presentation_obj_flag_call_artillery", pos51),
      ...
      [
		  ...
		  (else_try),
			(eq, ":object", "$g_presentation_obj_flag_call_artillery"),
			...
			(try_begin),
				(eq, "$g_artillery_callable_from_radio", 20),
				(store_mission_timer_a_msec, ":timer"), #milliseconds the mission has started from. 10 seconds = 10.000
				(store_add, ":cooldown", "$g_time_artillery_called_at", 120000), #60.000 = one minute. 1 second = 1.000
				(lt, ":timer", ":cooldown"), 
				(store_sub, ":remaining_time", ":cooldown", ":timer"), #Time left to call artillery
				(store_div, ":divided_time",":remaining_time", 1000), #convert into seconds
				
				(assign, reg0, ":divided_time"),
				(display_message, "@You still neeed to wait {reg0} seconds for the next artillery strike",0xFF0000),
				
				
			(else_try),
				(eq, "$g_artillery_callable_from_radio", 0),
				(assign, ":instance_id", "$g_cur_radio_instance"),
				(prop_instance_is_valid, ":instance_id"),
				(prop_instance_play_sound, ":instance_id", "snd_ie_ger_radio_artillery"),
				
				(str_store_string, s60, "@Artillery Inbound!"),
				
				(assign, "$g_presentation_server_notice_colour", colour_green),
				(start_presentation, "prsnt_display_server_notice"), #tell the player art is coming!
			
				(store_mission_timer_a_msec, ":timer"),
				(assign, "$g_time_artillery_called_at", ":timer"), #store it into a global variable
				
				(assign, "$g_artillery_callable_from_radio", 20), #means you cannot call the artillery anymore
				
				#(assign, "$g_artillery_general_agent_caller", ":agent_id"),
				
				#(assign, "$g_artillery_incoming_splash", 1),
				
				(multiplayer_send_2_int_to_server, multiplayer_event_zombie, 27, ":agent_id"),
				
				(assign, reg1, "$g_art_coordinates_x_position",),
				(assign, reg2, "$g_art_coordinates_y_position", ),
				(assign, reg3, "$g_art_coordinates_z_position", ),
				
				(display_message, "@In presentation, {reg1} , {reg2} , {reg3}"),
				
				(assign, ":val_x", "$g_art_coordinates_x_position"),
				(assign, ":val_y", "$g_art_coordinates_y_position"),
				(assign, ":val_z", "$g_art_coordinates_z_position"),
				
				(multiplayer_send_4_int_to_server, multiplayer_event_zombie, 28, ":val_x", ":val_y", ":val_z" ),
      ...
      (ti_on_presentation_run, [
		...
		(try_begin),
			...
			(else_try),
				...
				(assign, ":instance_id", "$g_cur_radio_instance"),
				(prop_instance_get_position, pos60, ":instance_id"), #radio's position
				(agent_get_position, pos61, ":agent_id"), 

				(get_distance_between_positions, ":dist", pos60, pos61),
				(ge, ":dist", 300), #if you go further than 3 meters
				(presentation_set_duration, 0),
			(try_end),
	  (try_end),
  ...
  ("multiplayer_cannon_crosshair", prsntf_read_only|prsntf_manual_end_only, 0, [ #MM
   ...
   ("spyglass_german_dummy", prsntf_read_only|prsntf_manual_end_only, 0,
   [
    (ti_on_presentation_load,
      [
          (call_script,"script_client_get_my_agent"),
          ...
          (overlay_set_position, reg0, pos1),
          (position_set_x, pos1, 110), #-1
          (position_set_y, pos1, 90), #-1
          (overlay_set_size, reg0, pos1),
    ...
    (ti_on_presentation_run,
      [ 
          ...
          (else_try),
            ...
            (neq,":item_id","itm_german_spyglass"),
            (assign,":continue",1),
		 (else_try),
			(neg|agent_is_alive, ":agent_id"), #if agent dies
			(presentation_set_duration, 0),
			(set_zoom_amount,0),
	    ...
	    ("spyglass_british_dummy", prsntf_read_only|prsntf_manual_end_only, 0,
   [
    (ti_on_presentation_load,
      [
          (call_script,"script_client_get_my_agent"),
    ...
    (ti_on_presentation_run,
      [ 
          ...
          (else_try),
            (agent_get_wielded_item,":item_id",":agent_id",0),
            (neq,":item_id","itm_french_spyglass"),
            (assign,":continue",1),
		  (else_try),
			(neg|agent_is_alive, ":agent_id"), #if agent dies
			(presentation_set_duration, 0),
   ...
   ("spyglass_french_dummy", prsntf_read_only|prsntf_manual_end_only, 0,
   [
    (ti_on_presentation_load,
      [
          (call_script,"script_client_get_my_agent"),
    ...
    (ti_on_presentation_run,
      [ 
          ...
          (else_try),
            (agent_get_wielded_item,":item_id",":agent_id",0),
            (neq,":item_id","itm_french_working_spyglass"),
            (assign,":continue",1),
		  (else_try),
			(neg|agent_is_alive, ":agent_id"), #if agent dies
			(presentation_set_duration, 0),
      ...
      [ 
        ...
        (try_begin),
          ...
          (else_try), #Count light inf and riflemen as the same
            (eq,":my_class",multi_troop_class_mm_rifle),
            (assign,":my_class",multi_troop_class_mm_skirmisher),
		(else_try),
			(eq, ":my_class", multi_troop_class_ie_sentry),
			(assign, ":my_class", multi_troop_class_ie_sentry),
		(else_try),
			(eq, ":my_class", multi_troop_class_ie_medic),
			(assign, ":my_class", multi_troop_class_ie_medic),
		(else_try),
			(eq, ":my_class", multi_troop_class_ie_general),
			(assign, ":my_class", multi_troop_class_ie_general),
		(else_try),
			(eq, ":my_class", multi_troop_class_ie_heavy_grenadier),
			(assign, ":my_class", multi_troop_class_ie_heavy_grenadier),
			
          (else_try), #Count all cavalry as the same
            (this_or_next|eq,":my_class",multi_troop_class_mm_lancer),
            (this_or_next|eq,":my_class",multi_troop_class_mm_hussar),
            (this_or_next|eq,":my_class",multi_troop_class_mm_dragoon),
            (this_or_next|eq,":my_class",multi_troop_class_mm_cuirassier),
            (eq,":my_class",multi_troop_class_mm_heavycav),
            (assign,":my_class",multi_troop_class_ie_machine_gunner),
          (else_try), #Count rockets and standard artillery as the same - danyele
		 ...
		 (else_try), #Count rockets and standard artillery as the same - danyele
            ...
            (assign,":my_class",multi_troop_class_mm_rocket),
          (try_end),
          ...
          (try_begin),
            ...
            (this_or_next|eq,":my_class",multi_troop_class_ie_machine_gunner),
          ...
          (try_for_agents,":cur_agent"),
			...
			(else_try),
				(eq, ":cur_agent_class", multi_troop_class_ie_sentry), #my_class
				(assign, ":cur_agent_class", multi_troop_class_ie_sentry), #my_class
			(else_try),
				(eq, ":cur_agent_class", multi_troop_class_ie_medic),
				(assign, ":cur_agent_class", multi_troop_class_ie_medic),
			(else_try),
				(eq, ":cur_agent_class", multi_troop_class_ie_general),
				(assign, ":cur_agent_class", multi_troop_class_ie_general),	
			(else_try),
				(eq, ":cur_agent_class", multi_troop_class_ie_heavy_grenadier),
				(assign, ":cur_agent_class", multi_troop_class_ie_heavy_grenadier),
            (else_try), #Count light inf and riflemen as the same
              (eq,":cur_agent_class",multi_troop_class_mm_rifle),
              (assign,":cur_agent_class",multi_troop_class_mm_skirmisher),
            (else_try), #Count all cavalry as the same
              (this_or_next|eq,":cur_agent_class",multi_troop_class_mm_lancer),
              (this_or_next|eq,":cur_agent_class",multi_troop_class_mm_hussar),
              (this_or_next|eq,":cur_agent_class",multi_troop_class_mm_dragoon),
              (this_or_next|eq,":cur_agent_class",multi_troop_class_mm_cuirassier),
              (eq,":cur_agent_class",multi_troop_class_mm_heavycav),
              (assign,":cur_agent_class",multi_troop_class_ie_machine_gunner),
            (else_try), #Count rockets and standard artillery as the same
              (eq,":cur_agent_class",multi_troop_class_mm_artillery),
              (assign,":cur_agent_class",multi_troop_class_mm_artillery),
		  (else_try),
			  (eq, ":cur_agent_class", multi_troop_class_mm_rocket),
				(assign, ":cur_agent_class", multi_troop_class_mm_rocket),
            (try_end),
          ...
          (try_begin),
            ...
            (else_try),
              (eq,":my_class",multi_troop_class_ie_machine_gunner),
  ...
  ("multiplayer_artillery_icons", prsntf_read_only|prsntf_manual_end_only, 0, [ #this is for showing artillery icons.
    (ti_on_presentation_load, [
      ...
      (create_mesh_overlay, "$g_presentation_obj_arty_icon_call_artillery", "mesh_arty_icon_call_artillery"), ##ie
      ...
      (overlay_set_display, "$g_presentation_obj_arty_icon_call_artillery", 0), #ie 
	  (overlay_set_size, "$g_presentation_obj_arty_icon_call_artillery", pos1), #ie
      (presentation_set_duration, 999999),
      ]),
    (ti_on_presentation_run, [
      (set_fixed_point_multiplier, 1000),
      (try_begin),
        ...
        (this_or_next|eq,":troop_class",multi_troop_class_ie_general),
        ...
        (try_begin), #For normal artillery
          (this_or_next|eq,":troop_class",multi_troop_class_mm_artillery),
          (eq,":troop_class",multi_troop_class_ie_general),

					
			(try_begin),
		  ####CALL ARTILLERY 'MURICA BEGIN ####
		    (assign,":cur_closest_instance",-1),
            (assign,":min_distance",99999999999), #in cm
            (scene_prop_get_num_instances,":num_instances","spr_ie_call_artillery"),
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_ie_call_artillery",":cur_instance"),
            ...
            (try_begin),
              ...
              (overlay_set_position, "$g_presentation_obj_arty_icon_call_artillery", pos5),
              (overlay_set_display, "$g_presentation_obj_arty_icon_call_artillery", 1),
            (else_try),
              (overlay_set_display, "$g_presentation_obj_arty_icon_call_artillery", 0),
            (try_end),
          # (else_try), 
            # (overlay_set_display, "$g_presentation_obj_arty_icon_call_artillery", 0),
		  #####CALL ARTILLERY 'MURICA END ####
		  (try_end),
          ...
          (try_begin),
            ...
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_round_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
              (assign,":cur_closest_instance",":prop_no"),
            (try_end),
            (scene_prop_get_num_instances,":num_instances","spr_mm_shell_button"),
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_shell_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
              (assign,":cur_closest_instance",":prop_no"),
            (try_end),
            (scene_prop_get_num_instances,":num_instances","spr_mm_canister_button"),
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_canister_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
              (assign,":cur_closest_instance",":prop_no"),
            (try_end),
            (scene_prop_get_num_instances,":num_instances","spr_mm_bomb_button"),
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_bomb_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
              (assign,":cur_closest_instance",":prop_no"),
            (try_end),
			 (scene_prop_get_num_instances,":num_instances","spr_mm_gran_bomb_button"),
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_gran_bomb_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
          ...
          (try_begin),
            ...
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_load_cartridge_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
              (assign,":cur_closest_instance",":prop_no"),
            (try_end),
            (scene_prop_get_num_instances,":num_instances","spr_mm_load_bomb_button"),
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_load_bomb_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
          ...
          (try_begin),
            ...
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_reload_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
          ...
          (try_begin),
            (assign,":cur_closest_instance",-1),
            (assign,":min_distance",500), #in cm
            (scene_prop_get_num_instances,":num_instances","spr_mm_12pdr_push_button"),
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_12pdr_push_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
              (assign,":cur_closest_instance",":prop_no"),
            (try_end),
            (scene_prop_get_num_instances,":num_instances","spr_mm_howitzer_push_button"),
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_howitzer_push_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
              (assign,":cur_closest_instance",":prop_no"),
            (try_end),
            (scene_prop_get_num_instances,":num_instances","spr_mm_fort_push_button"),
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_fort_push_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
              (assign,":cur_closest_instance",":prop_no"),
            (try_end),
            (scene_prop_get_num_instances,":num_instances","spr_mm_naval_push_button"),
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_naval_push_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
          ...
          (try_begin),
            ...
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_aim_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
        ...
        (else_try), #For rocket artillery
          ...
          (try_begin),
            ...
            (try_for_range,":cur_instance",0,":num_instances"),
              (scene_prop_get_instance,":prop_no","spr_mm_load_rocket_button",":cur_instance"),
              (prop_instance_get_position, pos1, ":prop_no"),
              (get_distance_between_positions,":dist",pos1,pos17),
              (lt,":dist",":min_distance"),
              (assign,":min_distance",":dist"),
  ...
  ("zombie_backpack_hud", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load, [      
        (set_fixed_point_multiplier, 1000),
        ...
        (create_text_overlay, "$backpack_hud1", "str_ammo_count"),
    (overlay_set_color,"$backpack_hud1",0xEDE3D6),
        (overlay_set_position, "$backpack_hud1", pos1),
		...
		(try_begin),
		  ...
		  (agent_is_alive,":agent_no"),
		   ...
		   (agent_get_wielded_item, ":weapon", ":agent_no"),
		   (neq, ":weapon", -1),
		   (item_get_slot,":guntype",":weapon",slot_item_guntype), #what type of weapon is 
		   (try_for_range,":slot",0,4), #begin getting ammo in gun
			(agent_get_item_slot,":item",":agent_no",":slot"),
			(eq,":item",":weapon"),
			(agent_get_ammo_for_slot,":ammo_in_weapon",":agent_no",":slot"),
		   (try_end), #end getting ammo in gun
		   (try_begin),
				(this_or_next|eq, ":guntype", 3),
				(eq, ":guntype",4),
		  (agent_get_slot,":rifle_count", ":agent_no", slot_agent_backpack_rifle_ammo),
				(assign,reg1,":rifle_count"),
				(assign, reg0, ":ammo_in_weapon"),
		   (else_try),
			 (eq, ":guntype", 1),
		  (agent_get_slot,":pistol_count", ":agent_no", slot_agent_backpack_pistol_ammo),
			 (assign,reg1,":pistol_count"),
			 (assign, reg0, ":ammo_in_weapon"),
		   (else_try),
			(assign, reg1, 0),
			(assign, reg0, 0),
		  ...
		  (overlay_set_text, "$backpack_hud1", "str_ammo_count"),
                (overlay_set_color,"$backpack_hud1",0xEDE3D6),
		  (overlay_set_display, "$backpack_hud1", 1),
		(else_try),  
		  (overlay_set_display, "$backpack_hud1", 0),
		(try_end),
   ...
   ("french_sniper_view", prsntf_read_only|prsntf_manual_end_only, 0,
   [
    (ti_on_presentation_load,
      [
          (call_script,"script_client_get_my_agent"),
          ...
          (create_mesh_overlay, reg0, "mesh_ie_sniper_view"),
          (position_set_x, pos1, 50), #-1
          (position_set_y, pos1, 37), #-1 it was 40
          (overlay_set_position, reg0, pos1),
          (position_set_x, pos1, 100), #-1
          (position_set_y, pos1, 100), #-1
          (overlay_set_size, reg0, pos1),
    ...
    (ti_on_presentation_run,
      [ 
	    (store_trigger_param_1,":cur_time"),
		 ...
		 #(agent_is_alive, ":agent_id"),
         (agent_is_active,":agent_id"),
		 (agent_get_animation, ":anim_upper", ":agent_id", 1),
      (try_begin),
        (gt,":cur_time",200),
        (this_or_next|key_clicked, key_escape),
        (this_or_next|game_key_clicked, gk_zoom), 
        (this_or_next|eq, ":anim_upper", "anim_fire_boltaction_high_recoil"), 
        (this_or_next|eq, ":anim_upper", "anim_fire_boltaction_low_recoil"), 
        ...
        (set_zoom_amount,0),   
	  (else_try),
	  (neg|agent_is_alive, ":agent_id"), #stop aiming if you die
	  (set_fixed_point_multiplier,100),
      (set_zoom_amount,0),
      (agent_set_visibility, ":agent_id", 1),
      (presentation_set_duration, 0),
       (try_end),	  
          ...
          (try_begin),
            (agent_get_wielded_item,":item_id",":agent_id",0),
            (neq,":item_id","itm_frenchlebelrifle_sniper"),
            (assign,":continue",1),
          (try_end),
          (eq,":continue",1),
          (set_fixed_point_multiplier,100),
...
#       ("british_sniper_view_smle", prsntf_read_only|prsntf_manual_end_only, 0,
#   [
#    (ti_on_presentation_load,
#      [
#          (call_script,"script_client_get_my_agent"),
...
#          (try_begin),
#            (agent_get_wielded_item,":item_id",":agent_id",0),
#            (neq,":item_id","itm_britishsmle_sniper"),
#            (assign,":continue",1),
#          (try_end),
#          (eq,":continue",1),
#          (set_fixed_point_multiplier,100),
...
#      ]),
   ...
   ("german_sniper_view_gewehr", prsntf_read_only|prsntf_manual_end_only, 0,
   [
    (ti_on_presentation_load,
      [
          (call_script,"script_client_get_my_agent"),
    ...
    (ti_on_presentation_run,
	  ...
	  (else_try),
       ...
       (try_end),	  
		...
		(neq,":item_id","itm_germangewehr98_sniper"),
            (assign,":continue",1),
          (try_end),
          (eq,":continue",1),
          (set_fixed_point_multiplier,100),
    ...
    ("walking_icon", prsntf_read_only|prsntf_manual_end_only, 0,
   [
   ...
   (ti_on_presentation_load,
      [
          (set_fixed_point_multiplier,100),
			  ...
			  (create_mesh_overlay, "$g_standing_icon", "mesh_ie_standing_icon"),
			  (position_set_x, pos1, 86), 
			  (position_set_y, pos1, 9),
			  (overlay_set_position, "$g_standing_icon", pos1),
			  (position_set_x, pos1, 100), 
			  (position_set_y, pos1, 100), 
			  (overlay_set_size, "$g_standing_icon", pos1),
			  (overlay_set_display, "$g_standing_icon", 0),
			  
			   (create_mesh_overlay, "$g_running_icon", "mesh_ie_running_icon"),
			  (position_set_x, pos1, 86), 
			  (position_set_y, pos1, 9),
			  (overlay_set_position, "$g_running_icon", pos1),
			  (position_set_x, pos1, 100), 
			  (position_set_y, pos1, 100), 
			  (overlay_set_size, "$g_running_icon", pos1),
			  (overlay_set_display, "$g_running_icon", 0),
			  
			   (create_mesh_overlay, "$g_walking_icon", "mesh_ie_walkicon_1"),
			  (position_set_x, pos1, 86), 
			  (position_set_y, pos1, 9),
			  (overlay_set_position, "$g_walking_icon", pos1),
			  (position_set_x, pos1, 100), 
			  (position_set_y, pos1, 100), 
			  (overlay_set_size, "$g_walking_icon", pos1),
			  (overlay_set_display, "$g_walking_icon", 0),
			  
			   (create_mesh_overlay, "$g_crouching_icon", "mesh_ie_crouching_icon"),
			  (position_set_x, pos1, 86), 
			  (position_set_y, pos1, 9),
			  (overlay_set_position, "$g_crouching_icon", pos1),
			  (position_set_x, pos1, 100), 
			  (position_set_y, pos1, 100), 
			  (overlay_set_size, "$g_crouching_icon", pos1),
			  (overlay_set_display, "$g_crouching_icon", 0),
    ...
    (ti_on_presentation_run,
      [
		  ...
		  (try_begin),
          (agent_is_alive,":agent_id"),
		  (agent_get_animation, ":anim_lower", ":agent_id",0),
          (set_fixed_point_multiplier,100),
		  (try_begin),
			  (le, ":anim_lower", 73),#anim_run_forward
			  (ge, ":anim_lower", 26), #anim_run_left_hips_left
			  (overlay_set_display, "$g_standing_icon", 0),
			  (overlay_set_display, "$g_running_icon", 1),
			  (overlay_set_display, "$g_walking_icon", 0),
			  (overlay_set_display, "$g_crouching_icon", 0),
		   (else_try),
			 (eq, ":anim_lower", "anim_stand_to_crouch"),
			  ...
			  (overlay_set_display, "$g_running_icon", 0),
			  (overlay_set_display, "$g_walking_icon", 0),
			  (overlay_set_display, "$g_crouching_icon", 1),
		   (else_try),
			  (le, ":anim_lower", 122),#anim_walk_forward
			  (ge, ":anim_lower", 74), #anim_walk_forward_crouch
			  (overlay_set_display, "$g_standing_icon", 0),
			  (overlay_set_display, "$g_running_icon", 0),
			  (overlay_set_display, "$g_walking_icon", 1),
			  (overlay_set_display, "$g_crouching_icon", 0),
			(else_try),
			  (overlay_set_display, "$g_standing_icon", 1),
			  (overlay_set_display, "$g_running_icon", 0),
			  (overlay_set_display, "$g_walking_icon", 0),
			  (overlay_set_display, "$g_crouching_icon", 0),
				(try_end),
	...
	("wounded_player_icon", prsntf_read_only|prsntf_manual_end_only, 0,
       [
        (ti_on_presentation_load,
          [
              (set_fixed_point_multiplier,1000),
              ...
              (try_for_range, ":current_troop_index", 1, 12), # Create 30 overlays we can use.
                (create_mesh_overlay, reg1, "mesh_ie_wounded_player_icon"),
                (overlay_set_size, reg1, pos1),
                (overlay_set_display, reg1, 0),
                (troop_set_slot, "trp_medic_dummy", ":current_troop_index", reg1),
              (try_end),
          ...
          (ti_on_presentation_run, [
            ...
            (try_begin),
              ...
              (agent_is_alive, ":my_agent"),
              (agent_get_troop_id, ":troop_id", ":my_agent"),
              (this_or_next|eq, ":troop_id", "trp_french_medical_corps"),
              (eq, ":troop_id", "trp_german_medical_corps"), #if i'm a doctor
             
              (try_for_range, ":tot_players" ,0, multiplayer_player_loops_end),
                (player_is_active, ":tot_players"),
                (lt,":current_troop_index",11), # not more than 10 displays
               
                (player_get_agent_id, ":cur_agent", ":tot_players"),
                (agent_is_active, ":cur_agent"),
                (agent_is_alive, ":cur_agent"),
               
                (agent_slot_eq, ":cur_agent", slot_agent_bleeding, 1), # hes bleedin
               
                (neq, ":cur_agent", ":my_agent"), #to prevent it from showing up on your head
                (agent_is_ally, ":cur_agent"), #if that player is in MY team
               
                (agent_get_position, pos1, ":my_agent"), #pos of my agent
                (agent_get_position, pos2, ":cur_agent"), #pos of all agents
                (get_distance_between_positions_in_meters, ":distance", pos1, pos2),
                (le, ":distance", 15),
                (position_move_z, pos2, 220, 1), #move it up above the head
                (position_get_screen_projection, pos5, pos2), #store into pos5 where all agents are looking
                (position_get_x, ":x_pos", pos5), #get x axis coordinates
                (position_get_y, ":y_pos", pos5),  #get y axis coordinates
                (is_between, ":x_pos", -100, 1100),
                (is_between, ":y_pos", -100, 850), #if you're looking within certain limits?
                #(overlay_set_position, "$g_presentation_wounded_player_icon", pos5),
               
                (troop_get_slot, ":cur_overlay_id", "trp_medic_dummy", ":current_troop_index"),
               
               
                (overlay_set_position, ":cur_overlay_id", pos5),
                (overlay_set_display, ":cur_overlay_id", 1), #finally show it
                
                (val_add, ":current_troop_index",1),
              (try_end),
            (try_end),
           
            (try_begin),
              (lt,":current_troop_index",11),
             
              (try_for_range, ":cur_index", ":current_troop_index", 11), # Create 30 overlays we can use.
                (troop_get_slot, ":cur_overlay_id", "trp_medic_dummy", ":cur_index"),
               
                (overlay_set_display, ":cur_overlay_id", 0), #dont display others.
              (try_end),
            (try_end),
   ...
   ("german_sniper_view_kahr", prsntf_read_only|prsntf_manual_end_only, 0,
   [
    (ti_on_presentation_load,
      [
          (call_script,"script_client_get_my_agent"),
	...
	("ammobox_menu",prsntf_manual_end_only,0,[
	...
	(ti_on_presentation_load,
	    ...
	    (agent_is_alive,":agent_id"),
	   	(agent_is_active,":agent_id"),
		(set_fixed_point_multiplier, 1000),
		(create_mesh_overlay,reg0, "mesh_mp_ingame_menu"), #Which cool mesh should we use?
		(position_set_x,pos1,253),
		(position_set_y,pos1,107),	
		(overlay_set_position, reg0, pos1), #its position
		
	    (create_button_overlay, "$g_presentation_ammobox_1", "@Refill Rifle Ammo", 0),
        (position_set_x, pos1, 315),
		(position_set_y, pos1, 600),
        (overlay_set_color, "$g_presentation_ammobox_1", 0xFFFFFF),
		(overlay_set_position, "$g_presentation_ammobox_1", pos1),
		
		(create_button_overlay, "$g_presentation_ammobox_2", "@Refill Pistol Ammo", 0),
        (position_set_x, pos1, 315),
		(position_set_y, pos1, 550),
        (overlay_set_color, "$g_presentation_ammobox_2", 0xFFFFFF),
		(overlay_set_position, "$g_presentation_ammobox_2", pos1),
		
		(create_button_overlay, "$g_presentation_ammobox_5", "@Refill Bandages", 0),
        (position_set_x, pos1, 315),
		(position_set_y, pos1, 500),
        (overlay_set_color, "$g_presentation_ammobox_5", 0xFFFFFF),
		(overlay_set_position, "$g_presentation_ammobox_5", pos1),
		
		(create_button_overlay, "$g_presentation_ammobox_6", "@Refill Morphine", 0),
        (position_set_x, pos1, 315),
		(position_set_y, pos1, 450),
        (overlay_set_color, "$g_presentation_ammobox_6", 0xFFFFFF),
		(overlay_set_position, "$g_presentation_ammobox_6", pos1),
		
		(create_button_overlay, "$g_presentation_ammobox_3", "@Leave Menu", 0),
        (position_set_x, pos1, 295),
		(position_set_y, pos1, 160),
        (overlay_set_color, "$g_presentation_ammobox_3", 0xFFFFFF),
		(overlay_set_position, "$g_presentation_ammobox_3", pos1),
		
        (create_button_overlay, "$g_presentation_ammobox_4", "@Pick up Ammo Box", 0),
        (position_set_x, pos1, 520),
		(position_set_y, pos1, 160),
        (overlay_set_color, "$g_presentation_ammobox_4", 0xFFFFFF),
		(overlay_set_position, "$g_presentation_ammobox_4", pos1),
			   
		(presentation_set_duration, 999999), #Endless
	...
	#(store_trigger_param_2, ":cur_instance"),
		(try_begin),
			(eq, ":object", "$g_presentation_ammobox_1"),
			(multiplayer_get_my_player,":player_no"),
			(assign, ":cur_instance", "$g_cur_ammobox_instance"),
			(multiplayer_send_3_int_to_server,multiplayer_event_zombie,14,":player_no",":cur_instance"),
		(else_try),
			(eq, ":object", "$g_presentation_ammobox_2"),
			(multiplayer_get_my_player, ":player_no"),
			(multiplayer_send_3_int_to_server,multiplayer_event_zombie,15,":player_no","$g_cur_ammobox_instance"),
		(else_try),
			(eq, ":object", "$g_presentation_ammobox_5"),
			(multiplayer_get_my_player, ":player_no"),
			(multiplayer_send_2_int_to_server,multiplayer_event_zombie,26,":player_no"),
		(else_try),
			(eq, ":object", "$g_presentation_ammobox_6"),
			(multiplayer_get_my_player, ":player_no"),
			(multiplayer_send_2_int_to_server, multiplayer_event_zombie, 25, ":player_no"),
		(eq, ":object", "$g_presentation_ammobox_2"),
			(multiplayer_get_my_player, ":player_no"),
			(multiplayer_send_3_int_to_server,multiplayer_event_zombie,2,":player_no","$g_cur_ammobox_instance"),
		(else_try),
			...
			(multiplayer_send_3_int_to_server,multiplayer_event_zombie,16,":player_no",":cur_instance"),
		(try_end),
	...
	("mg_ammobox_menu",prsntf_manual_end_only,0,[
	...
	(ti_on_presentation_load,
	    ...
	    (create_button_overlay, "$g_presentation_ammobox_1", "@Refill Light Machinegun Ammo", 0),
        (position_set_x, pos1, 315),
		(position_set_y, pos1, 600),
        (overlay_set_color, "$g_presentation_ammobox_1", 0xFFFFFF),
		(overlay_set_position, "$g_presentation_ammobox_1", pos1),
		...
		(create_button_overlay, "$g_presentation_ammobox_5", "@Grab Heavy Machinegun Ammo", 0),
        (position_set_x, pos1, 315),
		(position_set_y, pos1, 500),
        (overlay_set_color, "$g_presentation_ammobox_5", 0xFFFFFF),
		(overlay_set_position, "$g_presentation_ammobox_5", pos1),
	...
	(store_trigger_param_1, ":object"),
		(try_begin),
			(eq, ":object", "$g_presentation_ammobox_1"),
			(multiplayer_get_my_player,":player_no"),
			(assign, ":cur_instance", "$g_cur_mg_ammobox_instance"),
			(multiplayer_send_3_int_to_server,multiplayer_event_zombie,17,":player_no",":cur_instance"),
		(else_try),
			(eq, ":object", "$g_presentation_ammobox_3"),
			(presentation_set_duration, 0),
		(else_try),
			(eq, ":object", "$g_presentation_ammobox_4"),
			(presentation_set_duration, 0),
			...
			(multiplayer_send_3_int_to_server,multiplayer_event_zombie,18,":player_no",":cur_instance"),	
		(else_try),
			(eq, ":object", "$g_presentation_ammobox_5"),
			(presentation_set_duration, 0),
			(multiplayer_get_my_player, ":player_no"),
			...
			(multiplayer_send_3_int_to_server,multiplayer_event_zombie,23,":player_no",":cur_instance"),	
		(try_end),
	...
	(ti_on_presentation_run,
      [
       ...
       (try_begin),
		...
		(presentation_set_duration, 0),
       (try_end),
       # (try_begin),   #For finding the mouse position
         # (key_clicked,key_left_control),
         # (mouse_get_position, pos2),
         # (position_get_x,":pos_x",pos2),
         # (position_get_y,":pos_y",pos2),
	...
	("ammobox_menu_closed",prsntf_manual_end_only,0,[
	...
	#(store_trigger_param_2, ":cur_instance"),
		(try_begin),
			(eq, ":object", "$g_presentation_ammobox_1"),
			(multiplayer_get_my_player,":player_no"),
			(assign, ":cur_instance", "$g_cur_ammobox_closed_instance"),
			(multiplayer_send_3_int_to_server,multiplayer_event_zombie,20,":player_no",":cur_instance"),
		(else_try),
			(eq, ":object", "$g_presentation_ammobox_2"),
			(multiplayer_get_my_player, ":player_no"),
			(multiplayer_send_3_int_to_server,multiplayer_event_zombie,15,":player_no","$g_cur_ammobox_closed_instance"),
		(else_try),
			(eq, ":object", "$g_presentation_ammobox_3"),
			(presentation_set_duration, 0),
		# (else_try),
...
("mg_ammobox_menu_closed",prsntf_manual_end_only,0,[
	...
	(ti_on_presentation_load,
	    ...
	    (create_button_overlay, "$g_presentation_ammobox_1", "@Refill LMG Ammo", 0),
        (position_set_x, pos1, 315),
		(position_set_y, pos1, 600),
        (overlay_set_color, "$g_presentation_ammobox_1", 0xFFFFFF),
		(overlay_set_position, "$g_presentation_ammobox_1", pos1),
	...
	(store_trigger_param_1, ":object"),
		(try_begin),
			(eq, ":object", "$g_presentation_ammobox_1"),
			(multiplayer_get_my_player,":player_no"),
			(assign, ":cur_instance", "$g_cur_mg_ammobox_mg_instance_closed"),
			(multiplayer_send_3_int_to_server,multiplayer_event_zombie,22,":player_no",":cur_instance"),
		(else_try),
			(eq, ":object", "$g_presentation_ammobox_3"),
			(presentation_set_duration, 0),
		# (else_try),
