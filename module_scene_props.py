...
check_mm_use_cannon_prop_start_trigger = (ti_on_scene_prop_start_use,
  [
    ...
    (else_try),
      ...
      #(assign, ":anim_id", "anim_"),
    (else_try),
      (eq, ":scene_prop_id", "spr_mm_load_rocket_button"), #spr_mm_load_rocket_button
	...
	(else_try),
      (eq, ":scene_prop_id", "spr_mm_gran_bomb_button"),
      #(assign, ":anim_id", "anim_"),
    (try_end),
...
check_common_destructible_props_destroy_trigger = (ti_on_scene_prop_destroy,
  [
    ...
    (try_begin),
      ...
      (assign,":prop_to_spawn",-1),
      (try_begin),
        (eq,":prop_kind","spr_ie_iron_plank_d"),
        (assign,":prop_to_spawn","spr_ie_iron_plank"),
      (else_try),
      ...
      (else_try),
        (eq,":prop_kind","spr_ie_barbedwire_destructible"),
        (assign,":prop_to_spawn","spr_ie_barbedwire_construct"),
      (else_try),
        (eq,":prop_kind","spr_gabiondeploy_destructible"),
        (assign,":prop_to_spawn","spr_gabiondeploy_construct"),
      (else_try),
        (eq,":prop_kind","spr_ie_barbedwire"),
        (assign,":prop_to_spawn","spr_ie_barbedwired"),  
      (try_end),
  ...
  [
    (try_begin),
      ...
      (try_begin),
        ...
        (else_try),
          (eq,":prop_kind","spr_ie_iron_plank"),
          (assign,":prop_to_spawn","spr_ie_iron_plank_d"),
        (else_try),
        ...
        (else_try),
          (eq,":prop_kind","spr_ie_barbedwire_construct"),
          (assign,":prop_to_spawn","spr_ie_barbedwire_destructible"),
        (else_try),
          (eq,":prop_kind","spr_gabiondeploy_construct"),
          (assign,":prop_to_spawn","spr_gabiondeploy_destructible"),
        (else_try),
          (eq,":prop_kind","spr_ie_barbedwired"),
          (assign,":prop_to_spawn","spr_ie_barbedwire"),
        (try_end),
    ...
    (try_begin),
      ...
      (try_begin), # not a pioneer
        ...
        (try_begin), # for construction objects hit by anyone else then pioneers dont do anything.
          (is_between,":prop_kind","spr_mm_palisadedd","spr_ie_iron_plank"), # a construction object that is not placable by sapper.
          (assign,":hit_sound",-1),
          (assign,":hit_smoke",-1),
          (assign,":hit_particles",-1),
...
################################
    ...
    ("mm_tree_pine1" ,sokf_handle_as_flora,"mm_pine1" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine2" ,sokf_handle_as_flora,"mm_pine2" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine3" ,sokf_handle_as_flora,"mm_pine3" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine4" ,sokf_handle_as_flora,"mm_pine4" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine5" ,sokf_handle_as_flora,"mm_pine5" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine6" ,sokf_handle_as_flora,"mm_pine6" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine7" ,sokf_handle_as_flora,"mm_pine7" ,"bo_mm_aspen1" , []),
    
    ("mm_tree_pine_snowy1" ,sokf_handle_as_flora,"mm_pine1s" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine_snowy2" ,sokf_handle_as_flora,"mm_pine2s" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine_snowy3" ,sokf_handle_as_flora,"mm_pine3s" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine_snowy4" ,sokf_handle_as_flora,"mm_pine4s" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine_snowy5" ,sokf_handle_as_flora,"mm_pine5s" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine_snowy6" ,sokf_handle_as_flora,"mm_pine6s" ,"bo_mm_aspen1" , []),
    ("mm_tree_pine_snowy7" ,sokf_handle_as_flora,"mm_pine7s" ,"bo_mm_aspen1" , []),
...
("aagreenscreen" ,0,"greenscreen" ,"0" , []),
 ...
 # la haye saint
   ...
   ("mm_ice4" ,0,"ice4" ,"bo_ice4" , []),
    ...
    ("ie_iron_plank_d", sokf_static_movement|sokf_dont_move_agent_over|sokf_show_hit_point_bar|sokf_destructible, "ie_wellblechzaun_1_1" , "bo_ie_wellblechzaun_1_1" , 
     [
    ...
    ("ie_barbedwire_destructible", sokf_static_movement|sokf_dont_move_agent_over|sokf_show_hit_point_bar|sokf_destructible, "ie_barbedwire_2_1" , "bo_ie_barbedwire_2_1" , 
     [
       check_common_constructable_prop_on_hit_trigger,
       check_common_destructible_props_destroy_trigger,
       (ti_on_scene_prop_use,[]),
    ...
    ("ie_barbedwire", sokf_static_movement|sokf_dont_move_agent_over|sokf_show_hit_point_bar|sokf_destructible, "ie_barbedwire_1_1", "bo_ie_barbedwire_1_1" ,
    [    
       check_common_constructable_prop_on_hit_trigger,
       check_common_destructible_props_destroy_trigger,
       (ti_on_scene_prop_use,[]),
    ...
    ("crate_explosive_end", 0,"0" ,"0" , []),
     ...
     ("ie_airplane",sokf_moveable,"ie_french_airplane" ,"bo_ie_french_airplane", []),
     # [
       # (ti_on_scene_prop_destroy,
        # [
          # (try_begin),
  ...
  ("doors_end", 0,"0" ,"0" , []),
   ...
   #   check_common_construction_props_start_use_trigger,
    ...
    ("ie_iron_plank",sokf_static_movement|sokf_dont_move_agent_over|sokf_show_hit_point_bar|sokf_destructible,"ie_wellblechzaun_1_2" ,"bo_ie_wellblechzaun_1_2" , [
   #   check_common_construction_props_start_use_trigger,
    #  check_common_construction_props_use_trigger,
      check_common_constructable_prop_on_hit_trigger,
  ...
  #    check_common_construction_props_start_use_trigger,
   ...
   #   check_common_construction_props_use_trigger,
    ...
    ("ie_barbedwire_construct" ,sokf_static_movement|sokf_dont_move_agent_over|sokf_show_hit_point_bar|sokf_destructible,"ie_barbedwire_2_2" ,"bo_ie_barbedwire_2_2" , [  
   #   check_common_construction_props_start_use_trigger,
   #   check_common_construction_props_use_trigger,
      check_common_constructable_prop_on_hit_trigger,
      check_common_constructible_props_destroy_trigger,
  ...
  #    check_common_construction_props_start_use_trigger,
   #   check_common_construction_props_use_trigger,
    ...
    ("ie_barbedwired" ,sokf_static_movement|sokf_dont_move_agent_over|sokf_show_hit_point_bar|sokf_destructible,"ie_barbedwire_1_3" ,"bo_ie_barbedwire_1_3" , [
   #   check_common_construction_props_start_use_trigger,
    #  check_common_construction_props_use_trigger,
      check_common_constructable_prop_on_hit_trigger,
      check_common_constructible_props_destroy_trigger,
  ...
  #    check_common_construction_props_use_trigger,
    ...
    ("mm_ammobox_cannon", sokf_static_movement|sokf_dont_move_agent_over, "ammobox_cannon" , "OLD_bo_ie_ammobox_new", []),
    ("mm_ammobox_howitzer", sokf_static_movement|sokf_dont_move_agent_over, "ammobox_howitzer" , "OLD_bo_ie_ammobox_new", []),
    ...
    ("mm_shrine",0,"mmshrines","bo_shrines", []),
    ("mm_shrine1",0,"mmshrine1","bo_shrines", []),
    ("mm_shrine2",0,"mmshrine2","bo_shrines", []),
    ("mm_shrine3",0,"mmshrine3","bo_shrines", []),
    ("mm_shrine4",0,"mmshrine4","bo_shrines", []),
    ("mm_arc",0,"arc","bo_arc", []),
   ...
   # ("mm_sp_rich_street6",0,"sp_rich_village_street6","bo_sp_rich_village_street6", []),
    ...
    ("ie_french_mortar58mm" ,sokf_moveable,"ie_french58mm_mortar" ,"0" , []),
    ("ie_german_granatenwerfer" ,sokf_moveable,"ie_germanGrenatenwerfer_full" ,"0" , []),
    ("ie_german_minenwerfer" ,sokf_moveable,"ie_germanMinenwerfer_full" ,"0" , []),
    ...
    ("fr_mm_cannon_rocket" ,sokf_moveable,"fr_heavymobilemg08_lower" ,"0" , []), #heavy_mg08_full
    ("mm_cannon_rocket" ,sokf_moveable,"heavy_mg08_full" ,"0" , []), #heavy_mg08_full
    ...
    # Static cannon bits.
    ("mm_cannon_mortar_static",sokf_static_movement,"0","0",[]),
    ("ie_german_granatenwerfer_static",sokf_static_movement,"0","0",[]),
    ("ie_german_minenwerfer_static",sokf_static_movement,"0","0",[]),
    ("mm_cannon_fort_static",sokf_static_movement,"cannon_fort_static","0",[]),
    ("mm_cannon_rocket_static",sokf_static_movement,"0","0",[]),
    ("fr_mm_cannon_rocket_static",sokf_static_movement,"0","0",[]),
    
    # loaded ammo cannon bits.
    ("ie_cannon_mortar_loaded_ammo",sokf_static_movement,"ie_french58mm_mortarloaded_ammo","0",[]),
    ("ie_german_granatenwerfer_loaded_ammo",sokf_static_movement,"ie_germanGrenatenwerfer_launcherloaded","0",[]),
    ("ie_german_minenwerfer_loaded_ammo",sokf_static_movement,"0","0",[]),
    ("mm_cannon_rocket_loaded_ammo",sokf_static_movement,"heavy_mg_ammo_scnprp","0",[]),
    ("fr_mm_cannon_rocket_loaded_ammo",sokf_static_movement,"fr_heavy_mg_ammo_scnprp","0",[]),
    ("mm_loaded_ammos_end", 0, "0" , "0" , []),
    
    # Code cannonballs for trajectory
    ("mm_cannonball_code_only_6pd",sokf_static_movement,"ie_french58mm_ammo","0",[]),   #cannonball_6pd
    ("mm_cannonball_code_only_12pd",sokf_static_movement,"ie_french58mm_ammo","0",[]), #cannonball_12pd
    ("mm_cannonball_code_only_24pd",sokf_static_movement,"ie_french58mm_ammo","0",[]), #cannonball_24pd
    ("mm_cannonball_code_only_36pd",sokf_static_movement,"ie_french58mm_ammo","0",[]), #cannonball_36pd
    ...
    ("mm_cannon_mortar_wood" ,sokf_static_movement,"ie_french58mm_mortar_static" ,"bo_ie_french58mm_mortar_static" , []),
    ("ie_german_granatenwerfer_wood" ,sokf_static_movement,"ie_germanGrenatenwerfer_fixed" ,"bo_ie_germanGrenatenwerfer_fixed" , []),
    ("ie_german_minenwerfer_wood" ,sokf_static_movement,"ie_germanMinenwerfer_base" ,"bo_ie_germanGrenatenwerfer_fixed" , []),
    ...
    ("fr_mm_cannon_rocket_wood" ,sokf_static_movement,"fr_moving_rotatingaroundYaxis_mg08" ,"bo_moving_rotatingaroundYaxis_mg08" , []),
    ("mm_cannon_rocket_wood" ,sokf_static_movement,"moving_rotatingaroundYaxis_mg08" ,"bo_moving_rotatingaroundYaxis_mg08" , []),
    ...
    ("mm_cannon_mortar_barrel" ,sokf_static_movement,"ie_french58mm_mortar_barrel" ,"0" , []),
    ("ie_german_granatenwerfer_barrel" ,sokf_static_movement,"ie_germanGrenatenwerfer_barrel" ,"0" , []),
    ("ie_german_minenwerfer_barrel" ,sokf_static_movement,"ie_germanMinenwerfer_barrel" ,"0" , []),
    ...
    ("mm_cannon_rocket_barrel" ,sokf_static_movement,"moving_rotatingaroundZaxis_mg08" ,"0" , []),
    ("fr_mm_cannon_rocket_barrel" ,sokf_static_movement,"fr_moving_rotatingaroundZaxis_mg08" ,"0" , []),
    ...
    ("mm_cannon_12pdr_limber" ,sokf_moveable|sokf_dont_move_agent_over|spr_use_time(10),"cannon_12pdr_limber" ,"bo_cannon5_limber" , [
      check_mm_use_cannon_prop_start_trigger,
      check_mm_use_cannon_prop_end_trigger,
      check_mm_use_cannon_prop_cancel_trigger,
    ]),
    ...
    ("mm_pickup_rocket_button", sokf_moveable|spr_use_time(5), "0" , "cannon_button_collision" , [
      check_mm_use_cannon_prop_start_trigger,
      check_mm_use_cannon_prop_end_trigger,
      check_mm_use_cannon_prop_cancel_trigger,
    ]),
    ...
    ("mm_load_rocket_button", sokf_moveable|spr_use_time(4), "0" , "cannon_button_collision" , [
      check_mm_use_cannon_prop_start_trigger,
      check_mm_use_cannon_prop_end_trigger,
      check_mm_use_cannon_prop_cancel_trigger,
    ]),
    ...
    ("mm_bomb_button", sokf_moveable|spr_use_time(2), "ie_french58mm_ammunitioncrate" , "bo_ie_french58mm_ammunitioncrate" , [
      check_mm_use_cannon_prop_start_trigger,
      check_mm_use_cannon_prop_end_trigger,
      check_mm_use_cannon_prop_cancel_trigger,
    ]),
	
	("mm_gran_bomb_button", sokf_moveable|spr_use_time(2), "ie_germanGrenatenwerfer_crate" , "bo_ie_germanGrenatenwerfer_crate" , [
      check_mm_use_cannon_prop_start_trigger,
      check_mm_use_cannon_prop_end_trigger,
      check_mm_use_cannon_prop_cancel_trigger,
    ]),
	...
	("ie_call_artillery", sokf_moveable|spr_use_time(0), "0" , "cannon_button_collision" , [
    ]),
...
("ambience_sound_global_city_empty",0,"0" ,"0" , [
 ...
 [
  ...
  ("sw_grenade_tmp",0,"germanStielhandgranate","0", []),
  
  ("sw_french_grenade_tmp",0,"frenchF1Grenade","0", []),
    ("sw_british_grenade_tmp",0,"british_MillsBomb","0", []),

  ("explosive_grenade_tmp",0,"germanGeballteLadung","0",[]),
  
  ("ie_rifle_ammobox",spr_use_time(2)|sokf_moveable,"ie_ammobox","bo_ie_ammoboxolaf", [
   (ti_on_scene_prop_use,
    [
	 (store_trigger_param_1, ":agent_id"),
	 (store_trigger_param_2, ":cur_instance"),
     (agent_is_active, ":agent_id"),
	 (agent_is_alive, ":agent_id"),
	
	(agent_get_player_id, ":player_id", ":agent_id"),
	(multiplayer_send_3_int_to_player,":player_id",multiplayer_event_secessionclient,41,":cur_instance"),
    ]),
  ]),
  
  ("ie_mg_ammobox",spr_use_time(2)|sokf_moveable,"ie_ammoboxmg","bo_ie_ammoboxolaf", [
   (ti_on_scene_prop_use,
    [
	 (store_trigger_param_1, ":agent_id"),
	 (store_trigger_param_2, ":cur_instance"),
	...
	(agent_get_player_id, ":player_id", ":agent_id"),
	(multiplayer_send_3_int_to_player,":player_id",multiplayer_event_secessionclient,42,":cur_instance"),
    ]),
  ]),
  
  ("ie_ammoboxes_end",0,"empty_mesh","0", []),
  
  ("ie_trench_plank1_half" ,0,"ie_trench_plank1_half" ,"bo_ie_trench_plank1_half" , []),
  ("ie_trench_plank1_long" ,0,"ie_trench_plank1_long" ,"bo_ie_trench_plank1_long" , []),
  ("ie_trench_plank1_roof" ,0,"ie_trench_plank1_roof" ,"bo_ie_trench_plank1_roof" , []),
  ("ie_trench_plank1_short" ,0,"ie_trench_plank1_short" ,"bo_ie_trench_plank1_short" , []),
  ("ie_trench_plank1_duckboards" ,0,"ie_trench_plank1_duckboards" ,"bo_ie_trench_plank1_duckboards" , []),
  ("ie_trench_plank1_duckboards2" ,0,"ie_trench_plank1_duckboards2" ,"bo_ie_trench_plank1_duckboards2" , []),
  ("ie_trench_plank1_firestep" ,0,"ie_trench_plank1_firestep" ,"bo_ie_trench_plank1_firestep" , []),
  ("ie_trench_plank1_smallbunker" ,0,"ie_trench_plank1_smallbunker" ,"bo_ie_trench_plank1_smallbunker" , []),
  ("ie_trench_plank1_bunkerroof" ,0,"ie_trench_plank1_bunkerroof" ,"0" , []),
  ("ie_trench_dirt_firestep" ,0,"ie_trench_dirt_firestep" ,"bo_ie_trench_dirt_firestep" , []),
  ("ie_trench_dirt_craterlarge" ,0,"ie_trench_dirt_craterlarge" ,"bo_ie_trench_dirt_craterlarge" , []),
  ("ie_trench_dirt_cratersmall" ,0,"ie_trench_dirt_cratersmall" ,"bo_ie_trench_dirt_cratersmall" , []),
  ("ie_trench_dirt_fakeground" ,0,"ie_trench_dirt_fakeground" ,"bo_ie_trench_dirt_fakeground" , []),
  ("ie_trench_dirtbase_cornerinside" ,0,"ie_trench_dirtbase_cornerinside" ,"bo_ie_trench_dirtbase_cornerinside" , []),
  ("ie_trench_dirtbase_corneroutside" ,0,"ie_trench_dirtbase_corneroutside" ,"bo_ie_trench_dirtbase_corneroutside" , []),
  ("ie_trench_dirtbase_crossroad" ,0,"ie_trench_dirtbase_crossroad" ,"bo_ie_trench_dirtbase_crossroad" , []),
  ("ie_trench_dirtbase_curve" ,0,"ie_trench_dirtbase_curve" ,"bo_ie_trench_dirtbase_curve" , []),
  ("ie_trench_dirtbase_halfshort" ,0,"ie_trench_dirtbase_halfshort" ,"bo_ie_trench_dirtbase_halfshort" , []),
  ("ie_trench_dirtbase_straightlong" ,0,"ie_trench_dirtbase_straightlong" ,"bo_ie_trench_dirtbase_straightlong" , []),
  ("ie_trench_dirtbase_turn" ,0,"ie_trench_dirtbase_turn" ,"bo_ie_trench_dirtbase_turn" , []),
  ("ie_trench_dirtbase_tunnelentrance" ,0,"ie_trench_dirtbase_tunnelentrance" ,"bo_ie_trench_dirtbase_tunnelentrance" , []),
  ("ie_trench_snow_firestep" ,0,"ie_trench_snow_firestep" ,"bo_ie_trench_dirt_firestep" , []),
  ("ie_trench_snow_cratersmall" ,0,"ie_trench_snow_cratersmall" ,"bo_ie_trench_snow_cratersmall" , []),
  ("ie_trench_snow_craterlarge" ,0,"ie_trench_snow_craterlarge" ,"bo_ie_trench_snow_craterlarge" , []),
  ("ie_trench_snow_fakeground" ,0,"ie_trench_snow_fakeground" ,"bo_ie_trench_snow_fakeground" , []),
  ("ie_trench_snowbase_cornerinside" ,0,"ie_trench_snowbase_cornerinside" ,"bo_ie_trench_snowbase_cornerinside" , []),
  ("ie_trench_snowbase_corneroutside" ,0,"ie_trench_snowbase_corneroutside" ,"bo_ie_trench_snowbase_corneroutside" , []),
  ("ie_trench_snowbase_crossroad" ,0,"ie_trench_snowbase_crossroad" ,"bo_ie_trench_snowbase_crossroad" , []),
  ("ie_trench_snowbase_curve" ,0,"ie_trench_snowbase_curve" ,"bo_ie_trench_snowbase_curve" , []),
  ("ie_trench_snowbase_half" ,0,"ie_trench_snowbase_half" ,"bo_ie_trench_snowbase_half" , []),
  ("ie_trench_snowbase_straightlong" ,0,"ie_trench_snowbase_straightlong" ,"bo_ie_trench_snowbase_straightlong" , []),
  ("ie_trench_snowbase_turn" ,0,"ie_trench_snowbase_turn" ,"bo_ie_trench_snowbase_turn" , []),
  ("ie_trench_snowbase_tunnelentrance" ,0,"ie_trench_snowbase_tunnelentrance" ,"bo_ie_trench_snowbase_tunnelentrance" , []),
    ("ie_field_phone",spr_use_time(0),"ie_field_phone","bo_ie_field_phone", [
   (ti_on_scene_prop_use,
    [
	 (store_trigger_param_1, ":agent_id"),
	 (store_trigger_param_2, ":cur_instance"),
	...
	(try_begin),
		...
		(eq, ":troop_id", "trp_prussian_blucher"),
		(multiplayer_send_3_int_to_player,":player_id",multiplayer_event_secessionclient,55,":cur_instance"),
	(else_try),
	   (multiplayer_send_3_int_to_player,":player_id",multiplayer_event_secessionclient,56,":cur_instance"),
	
	(try_end),
    ]),
  ]),
  ("ie_trench_gasbell",0,"ie_trench_gasbell","bo_ie_trench_gasbell", []),
  ("ie_trench_periscope",0,"ie_trench_periscope","bo_ie_trench_periscope", []),
  ("ie_hangingwaterbottle",0,"ie_hangingwaterbottle","bo_ie_hangingwaterbottle", []),
  ("ie_hangingcoat_german",0,"ie_hangingcoat_german","bo_ie_hangingcoat_german", []),
  ("ie_hangingcoat_french",0,"ie_hangingcoat_french","bo_ie_hangingcoat_french", []),
  ("ie_trenchprop_shield",0,"ie_trenchprop_shield","bo_ie_trenchshield", []),
  ("ie_bunk_bed",0,"ie_bunk_bed","bo_ie_bunk_bed", []),
  ("ie_trench_snow_fakeground" ,0,"ie_trench_snow_fakeground" ,"bo_ie_trench_snow_fakeground" , []),
  ("ie_static_airplane", 0,"ie_french_airplane" ,"bo_ie_french_airplane", []),
  ("ie_woodentrench", 0,"ie_woodentrench" ,"bo_ie_woodentrench", []),
  ("ie_battleship", 0,"ie_battleship" ,"ie_battleship", []),
  ("ie_sandbag" ,0,"ie_sandbag" ,"bo_ie_sandbag" , []),
  ("ie_sandbag_pair", 0,"ie_sandbag_pair" ,"bo_ie_sandbag_pair", []),
  ("ie_sandbags_1", 0,"ie_sandbags_1" ,"bo_ie_sandbags_1", []),
  ("ie_sandbags_2", 0,"ie_sandbags_2" ,"bo_ie_sandbags_2", []),
  ("ie_ladder", 0,"ie_ladder" ,"bo_ie_ladder", []),
  ("ie_woodenbarricade_1_1", 0,"ie_woodenbarricade_1_1" ,"bo_ie_woodenbarricade_1_1", []),
  ("ie_ammobox_closed", spr_use_time(2),"ie_ammobox_sceneprop" ,"bo_ie_ammoboxolaf", [
    (ti_on_scene_prop_use,
    [
	 (store_trigger_param_1, ":agent_id"),
	 (store_trigger_param_2, ":cur_instance"),
	...
	(agent_get_player_id, ":player_id", ":agent_id"),
	(multiplayer_send_3_int_to_player,":player_id",multiplayer_event_secessionclient,43,":cur_instance"),
    ]),
  ]),
  ("ie_ammoboxmg_closed", spr_use_time(2)|sokf_moveable,"ie_ammoboxmg_sceneprop" ,"bo_ie_ammoboxolaf", [
   (ti_on_scene_prop_use,
    [
	 (store_trigger_param_1, ":agent_id"),
	 (store_trigger_param_2, ":cur_instance"),
	...
	(agent_get_player_id, ":player_id", ":agent_id"),
	(multiplayer_send_3_int_to_player,":player_id",multiplayer_event_secessionclient,45,":cur_instance"),
      ]),
	]),
  ("ie_woodentrench_long", 0,"ie_woodentrench_long" ,"bo_ie_woodentrench_long", []),
  ("ie_woodentrench_corner", 0,"ie_woodentrench_corner" ,"bo_ie_woodentrench_corner", []),
  ("ie_lamp",0,"ie_lamp","0", []),
  ("ie_barbedwire_barricade",0,"ie_barbedwire_barricade","bo_ie_barbedwire_barricade",[]),
  ("ie_british_tank", 0,"Mark4","bo_Mark4", []),
  
("ie_trench_dirtbase_halflong",0,"ie_trench_dirtbase_halflong","bo_ie_trench_dirtbase_halflong",[]),
  ("ie_trench_dirtbase_exit",0,"ie_trench_dirtbase_exit","bo_ie_trench_dirtbase_exit",[]),
  ("ie_trench_dirtbase_mgposition",0,"ie_trench_dirtbase_mgposition","bo_ie_trench_dirtbase_mgposition",[]),
  ("ie_trench_dirtbase_smalldugout",0,"ie_trench_dirtbase_smalldugout","bo_ie_trench_dirtbase_smalldugout",[]),
  ("ie_trench_plank1_plank",0,"ie_trench_plank1_plank","bo_ie_trench_plank1_plank",[]),
  ("ie_sandbags_3",0,"ie_sandbags_3","bo_ie_sandbags_3",[]),
  ("ie_trench_sandbagplank_short",0,"ie_trench_sandbagplank_short","bo_ie_trench_sandbagplank_short",[]),
  ("ie_trench_sandbagplank_long",0,"ie_trench_sandbagplank_long","bo_ie_trench_sandbagplank_long",[]),
  ("ie_trench_builtplank1_cornerinside" ,0,"ie_trench_builtplank1_cornerinside" ,"bo_ie_trench_builtplank1_cornerinside" , []),
  ("ie_trench_builtplank1_corneroutside" ,0,"ie_trench_builtplank1_corneroutside" ,"bo_ie_trench_builtplank1_corneroutside" , []),
  ("ie_trench_builtplank1_crossroad" ,0,"ie_trench_builtplank1_crossroad" ,"bo_ie_trench_builtplank1_crossroad" , []),
  ("ie_trench_builtplank1_curve" ,0,"ie_trench_builtplank1_curve" ,"bo_ie_trench_builtplank1_curve" , []),
  ("ie_trench_builtplank1_exit" ,0,"ie_trench_builtplank1_exit" ,"bo_ie_trench_builtplank1_exit" , []),
  ("ie_trench_builtplank1_halflong" ,0,"ie_trench_builtplank1_halflong" ,"bo_ie_trench_builtplank1_halflong" , []),
  ("ie_trench_builtplank1_mgposition" ,0,"ie_trench_builtplank1_mgposition" ,"bo_ie_trench_builtplank1_mgposition" , []),
  ("ie_trench_builtplank1_smallbunker" ,0,"ie_trench_builtplank1_smallbunker" ,"bo_ie_trench_builtplank1_smallbunker" , []),
  ("ie_trench_builtplank1_straightlong" ,0,"ie_trench_builtplank1_straightlong" ,"bo_ie_trench_builtplank1_straightlong" , []),
  ("ie_trench_builtplank1_straightshort" ,0,"ie_trench_builtplank1_straightshort" ,"bo_ie_trench_builtplank1_straightshort" , []),
  ("ie_trench_builtplank1_turn" ,0,"ie_trench_builtplank1_turn" ,"bo_ie_trench_builtplank1_turn" , []),
  ("ie_trench_builtplank1_halfshort" ,0,"ie_trench_builtplank1_halfshort" ,"bo_ie_trench_builtplank1_halfshort" , []),

  ("ie_grm_trch_corner_in" ,0,"grm_trch_corner_in" ,"bo_grm_trch_corner_in" , []),
  ("ie_grm_trch_deep_dugout" ,0,"grm_trch_deep_dugout" ,"bo_grm_trch_deep_dugout" , []),
  ("ie_grm_trch_exit" ,0,"grm_trch_exit" ,"bo_grm_trch_exit" , []),
  ("ie_grm_trch_corner_out" ,0,"grm_trch_corner_out" ,"bo_grm_trch_corner_out" , []),
  ("ie_grm_trch_curve_45" ,0,"grm_trch_curve_45" ,"bo_grm_trch_curve_45" , []),
  ("ie_grm_trch_mg_pos" ,0,"grm_trch_mg_pos" ,"bo_grm_trch_mg_pos" , []),
  ("ie_grm_trch_straight_1" ,0,"grm_trch_straight_1" ,"bo_grm_trch_straight_1" , []),
  ("ie_grm_trch_straight_2" ,0,"grm_trch_straight_2" ,"bo_grm_trch_straight_2" , []),
  ("ie_grm_trch_straight_3" ,0,"grm_trch_straight_3" ,"bo_grm_trch_straight_3" , []),
  ("ie_grm_trch_cross_to_spprt" ,0,"grm_trch_cross_right" ,"bo_grm_trch_cross_right" , []),
  ("ie_grm_trch_support_right" ,0,"grm_trch_support_right" ,"bo_grm_trch_support_right" , []),
  ("ie_grm_trch_support_right_firestep_begin" ,0,"grm_trch_support_right_firestep_begin" ,"bo_grm_trch_support_right_firestep_begin" , []),
  ("ie_grm_trch_corner_out_back" ,0,"grm_trch_corner_out_back" ,"bo_grm_trch_corner_out_back" , []),
  ("ie_grm_trch_straight_1_front" ,0,"grm_trch_straight_1_front" ,"bo_grm_trch_straight_1_front" , []),
  ("ie_grm_trch_corner_out_front" ,0,"grm_trch_corner_out_front" ,"bo_grm_trch_corner_out_front" , []),
  ("ie_grm_trch_straight_1_back" ,0,"grm_trch_straight_1_back" ,"bo_grm_trch_straight_1_back" , []),
  ("ie_grm_trch_support_corner_1" ,0,"grm_trch_support_corner_1" ,"bo_grm_trch_support_corner_1" , []),
  ("ie_destroyed_house_1" ,0,"ie_destroyed_house_1" ,"bo_ie_destroyed_house_1" , []),
  ("ie_destroyed_house_2" ,0,"ie_destroyed_house_2" ,"bo_ie_destroyed_house_2" , []),
  ("ie_destroyed_house_3" ,0,"ie_destroyed_house_3" ,"bo_ie_destroyed_house_3" , []),
  ("ie_destroyed_house_4" ,0,"ie_destroyed_house_4" ,"bo_ie_destroyed_house_3" , []),
  ("ie_destroyed_house_5" ,0,"ie_destroyed_house_5" ,"bo_ie_destroyed_house_5" , []),
  ("ie_destroyed_house_6" ,0,"ie_destroyed_house_6" ,"bo_ie_destroyed_house_5" , []),
  ("ie_feldkueche" ,0,"feldkueche" ,"bo_feldkueche" , []),
  
  ("ie_trench_builtweave1_cornerinside" ,0,"ie_trench_builtweave1_cornerinside" ,"bo_ie_trench_builtweave1_cornerinside" , []),
  ("ie_trench_builtweave1_corneroutside" ,0,"ie_trench_builtweave1_corneroutside" ,"bo_ie_trench_builtweave1_corneroutside" , []),
  ("ie_trench_builtweave1_crossroad" ,0,"ie_trench_builtweave1_crossroad" ,"bo_ie_trench_builtweave1_crossroad" , []),
  ("ie_trench_builtweave1_curve" ,0,"ie_trench_builtweave1_curve" ,"bo_ie_trench_builtweave1_curve" , []),
  ("ie_trench_builtweave1_exit" ,0,"ie_trench_builtweave1_exit" ,"bo_ie_trench_builtweave1_exit" , []),
  ("ie_trench_builtweave1_halfshort" ,0,"ie_trench_builtweave1_halfshort" ,"bo_ie_trench_builtweave1_halfshort" , []),
  ("ie_trench_builtweave1_halflong" ,0,"ie_trench_builtweave1_halflong" ,"bo_ie_trench_builtweave1_halflong" , []),
  ("ie_trench_builtweave1_mgposition" ,0,"ie_trench_builtweave1_mgposition" ,"bo_ie_trench_builtweave1_mgposition" , []),
  ("ie_trench_builtweave1_smallbunker" ,0,"ie_trench_builtweave1_smallbunker" ,"bo_ie_trench_builtweave1_smallbunker" , []),
  ("ie_trench_builtweave1_straightlong" ,0,"ie_trench_builtweave1_straightlong" ,"bo_ie_trench_builtweave1_straightlong" , []),
  ("ie_trench_builtweave1_straightshort" ,0,"ie_trench_builtweave1_straightshort" ,"bo_ie_trench_builtweave1_straightshort" , []),
  ("ie_pine_1" ,0,"ie_pine_1" ,"bo_ie_pine_1" , []),
  ("ie_pine_2" ,0,"ie_pine_2" ,"bo_ie_pine_2" , []),
  ("ie_destroyed_tree_4" ,0,"ie_destroyed_tree_4" ,"bo_ie_destroyed_tree_4" , []),
  ("ie_destroyed_tree_3" ,0,"ie_destroyed_tree_3" ,"bo_ie_destroyed_tree_3" , []),
  ("ie_destroyed_tree_2" ,0,"ie_destroyed_tree_2" ,"bo_ie_destroyed_tree_2" , []),
  ("ie_destroyed_tree_1" ,0,"ie_destroyed_tree_1" ,"bo_ie_destroyed_tree_1" , []),
  ("ie_large_trench",0, "ie_large_trench", "bo_ie_large_trench", []),
  ("ie_large_trench2",0, "ie_large_trench2", "bo_ie_large_trench2", []),
  ("ie_large_trench3",0, "ie_large_trench3", "bo_ie_large_trench3", []),
  ("ie_large_trench4",0, "ie_large_trench4", "bo_ie_large_trench4", []),
  ("ie_large_trench5",0, "ie_large_trench5", "bo_ie_large_trench5", []),
  ("ie_sandbags_5",0, "ie_sandbags_5", "bo_ie_sandbags_5", []),
  ("ie_sandbags_4",0, "ie_sandbags_4", "bo_ie_sandbags_4", []),
  ("ie_trench_builtweave1_turn",0, "ie_trench_builtweave1_turn", "bo_ie_trench_builtweave1_turn", []),
  ("bo_ie_trench_dirtbase_straightshort",0, "ie_trench_dirtbase_straightshort", "bo_ie_trench_dirtbase_straightshort", []),
  ("ie_trench_plank1_ladder",0, "ie_trench_plank1_ladder", "bo_ie_trench_plank1_ladder", []),
  ("ie_pillbox_1",0, "ie_pillbox_1", "bo_ie_pillbox_1", []),
  ("ie_pillbox_2",0, "ie_pillbox_2", "bo_ie_pillbox_2", []),
  ("ie_pillbox_3",0, "ie_pillbox_3", "bo_ie_pillbox_3", []),
  ("ie_destroyed_house_7",0, "ie_destroyed_house_7", "bo_ie_destroyed_house_7", []),
  ("ie_destroyed_house_8",0, "ie_destroyed_house_8", "bo_ie_destroyed_house_7", []),
  
    ("ie_newtrench_forest_plain_corneroutside",0, "ie_newtrench_forest_plain_corneroutside", "bo_ie_newtrench_forest_plain_corneroutside", []),
  ("ie_newtrench_forest_plain_cornerinside",0, "ie_newtrench_forest_plain_cornerinside", "bo_ie_newtrench_forest_plain_cornerinside", []),
  ("ie_newtrench_forest_plain_crossroad",0, "ie_newtrench_forest_plain_crossroad", "bo_ie_newtrench_forest_plain_crossroad", []),
  ("ie_newtrench_forest_plain_curve",0, "ie_newtrench_forest_plain_curve", "bo_ie_newtrench_forest_plain_curve", []),
  ("ie_newtrench_forest_plain_exit",0, "ie_newtrench_forest_plain_exit", "bo_ie_newtrench_forest_plain_exit", []),
  ("ie_newtrench_forest_plain_halflong",0, "ie_newtrench_forest_plain_halflong", "bo_ie_newtrench_forest_plain_halflong", []),
  ("ie_newtrench_forest_plain_halfshort",0, "ie_newtrench_forest_plain_halfshort", "bo_ie_newtrench_forest_plain_halfshort", []),
  ("ie_newtrench_forest_plain_mgposition",0, "ie_newtrench_forest_plain_mgposition", "bo_ie_newtrench_forest_plain_mgposition", []),
  ("ie_newtrench_forest_plain_tunnelentrance",0, "ie_newtrench_forest_plain_tunnelentrance", "bo_ie_newtrench_forest_plain_tunnelentrance", []),
  ("ie_newtrench_forest_plain_straightlong",0, "ie_newtrench_forest_plain_straightlong", "bo_ie_newtrench_forest_plain_straightlong", []),
  ("ie_newtrench_forest_plain_straightshort",0, "ie_newtrench_forest_plain_straightshort", "bo_ie_newtrench_forest_plain_straightshort", []),
  ("ie_newtrench_forest_plain_turn",0, "ie_newtrench_forest_plain_turn", "bo_ie_newtrench_forest_plain_turn", []),
  ("ie_newtrench_forest_plain_firestep",0, "ie_newtrench_forest_plain_firestep", "bo_ie_newtrench_forest_plain_firestep", []),
  ("ie_newtrench_forest_plain_mound1",0, "ie_newtrench_forest_plain_mound1", "bo_ie_newtrench_forest_plain_mound1", []),
  ("ie_newtrench_forest_plain_mound2",0, "ie_newtrench_forest_plain_mound2", "bo_ie_newtrench_forest_plain_mound2", []),
  ("ie_newtrench_forest_plain_mound3",0, "ie_newtrench_forest_plain_mound3", "bo_ie_newtrench_forest_plain_mound3", []),
  ("ie_newtrench_forest_plain_mound4",0, "ie_newtrench_forest_plain_mound4", "bo_ie_newtrench_forest_plain_mound4", []),
  ("ie_newtrench_forest_plain_mound5",0, "ie_newtrench_forest_plain_mound5", "bo_ie_newtrench_forest_plain_mound5", []),
  ("ie_newtrench_forest_plain_fakeground",0, "ie_newtrench_forest_plain_fakeground", "bo_ie_newtrench_forest_plain_fakeground", []),
  ("ie_newtrench_forest_plain_crater",0, "ie_newtrench_forest_plain_crate", "bo_ie_newtrench_forest_plain_crate", []),
  
  ("ie_newtrench_forest_plank1_corneroutside",0, "ie_newtrench_forest_plank1_corneroutside", "bo_ie_newtrench_forest_plank1_corneroutside", []),
  ("ie_newtrench_forest_plank1_cornerinside",0, "ie_newtrench_forest_plank1_cornerinside", "bo_ie_newtrench_forest_plank1_cornerinside", []),
  ("ie_newtrench_forest_plank1_crossroad",0, "ie_newtrench_forest_plank1_crossroad", "bo_ie_newtrench_forest_plank1_crossroad", []),
  ("ie_newtrench_forest_plank1_curve",0, "ie_newtrench_forest_plank1_curve", "bo_ie_newtrench_forest_plank1_curve", []),
  ("ie_newtrench_forest_plank1_exit",0, "ie_newtrench_forest_plank1_exit", "bo_ie_newtrench_forest_plank1_exit", []),
  ("ie_newtrench_forest_plank1_halflong",0, "ie_newtrench_forest_plank1_halflong", "bo_ie_newtrench_forest_plank1_halflong", []),
  ("ie_newtrench_forest_plank1_halfshort",0, "ie_newtrench_forest_plank1_halfshort", "bo_ie_newtrench_forest_plank1_halfshort", []),
  ("ie_newtrench_forest_plank1_mgposition",0, "ie_newtrench_forest_plank1_mgposition", "bo_ie_newtrench_forest_plank1_mgposition", []),
  ("ie_newtrench_forest_plank1_smallbunker",0, "ie_newtrench_forest_plank1_smallbunker", "bo_ie_newtrench_forest_plank1_smallbunker", []),
  ("ie_newtrench_forest_plank1_straightlong",0, "ie_newtrench_forest_plank1_straightlong", "bo_ie_newtrench_forest_plank1_straightlong", []),
  ("ie_newtrench_forest_plank1_straightshort",0, "ie_newtrench_forest_plank1_straightshort", "bo_ie_newtrench_forest_plank1_straightshort", []),
  ("ie_newtrench_forest_plank1_turn",0, "ie_newtrench_forest_plank1_turn", "bo_ie_newtrench_forest_plank1_turn", []),
  ("ie_newtrench_forest_plank1_shelter",0, "ie_newtrench_forest_plank1_shelter", "bo_ie_newtrench_forest_plank1_shelter", []),
  ("ie_newtrench_forest_plank1_firestep",0, "ie_newtrench_forest_plank1_firestep", "bo_ie_newtrench_forest_plank1_firestep", []),
  ("ie_newtrench_forest_plank1_ladder",0, "ie_newtrench_forest_plank1_ladder", "bo_ie_newtrench_forest_plank1_ladder", []),
  ("ie_newtrench_forest_plank1_roof",0, "ie_newtrench_forest_plank1_roof", "bo_ie_newtrench_forest_plank1_roof", []),
  ("ie_newtrench_forest_plank1_duckboards",0, "ie_newtrench_forest_plank1_duckboards", "bo_ie_newtrench_forest_plank1_duckboards", []),
  ("ie_newtrench_forest_plank1_duckboards2",0, "ie_newtrench_forest_plank1_duckboards2", "bo_ie_newtrench_forest_plank1_duckboards2", []),
  
  ("ie_newtrench_forest_plank1sand_halflong",0, "ie_newtrench_forest_plank1sand_halflong", "bo_ie_newtrench_forest_plank1_halflong", []),
  ("ie_newtrench_forest_plank1sand_halfshort",0, "ie_newtrench_forest_plank1sand_halfshort", "bo_ie_newtrench_forest_plank1_halfshort", []),
  ("ie_newtrench_forest_plank1sand_corneroutside",0, "ie_newtrench_forest_plank1sand_corneroutside", "bo_ie_newtrench_forest_plank1_corneroutside", []),
  ("ie_newtrench_forest_plank1sand_cornerinside",0, "ie_newtrench_forest_plank1sand_cornerinside", "bo_ie_newtrench_forest_plank1_cornerinside", []),
  
  ("ie_newtrench_forest_weave1_corneroutside",0, "ie_newtrench_forest_weave1_corneroutside", "bo_ie_newtrench_forest_plank1_corneroutside", []),
  ("ie_newtrench_forest_weave1_cornerinside",0, "ie_newtrench_forest_weave1_cornerinside", "bo_ie_newtrench_forest_plank1_cornerinside", []),
  ("ie_newtrench_forest_weave1_crossroad",0, "ie_newtrench_forest_weave1_crossroad", "bo_ie_newtrench_forest_plank1_crossroad", []),
  ("ie_newtrench_forest_weave1_curve",0, "ie_newtrench_forest_weave1_curve", "bo_ie_newtrench_forest_plank1_curve", []),
  ("ie_newtrench_forest_weave1_exit",0, "ie_newtrench_forest_weave1_exit", "bo_ie_newtrench_forest_plank1_exit", []),
  ("ie_newtrench_forest_weave1_halflong",0, "ie_newtrench_forest_weave1_halflong", "bo_ie_newtrench_forest_plank1_halflong", []),
  ("ie_newtrench_forest_weave1_halfshort",0, "ie_newtrench_forest_weave1_halfshort", "bo_ie_newtrench_forest_plank1_halfshort", []),
  ("ie_newtrench_forest_weave1_mgposition",0, "ie_newtrench_forest_weave1_mgposition", "bo_ie_newtrench_forest_plank1_mgposition", []),
  ("ie_newtrench_forest_weave1_smallbunker",0, "ie_newtrench_forest_weave1_smallbunker", "bo_ie_newtrench_forest_plank1_smallbunker", []),
  ("ie_newtrench_forest_weave1_straightlong",0, "ie_newtrench_forest_weave1_straightlong", "bo_ie_newtrench_forest_plank1_straightlong", []),
  ("ie_newtrench_forest_weave1_straightshort",0, "ie_newtrench_forest_weave1_straightshort", "bo_ie_newtrench_forest_plank1_straightshort", []),
  ("ie_newtrench_forest_weave1_turn",0, "ie_newtrench_forest_weave1_turn", "bo_ie_newtrench_forest_plank1_turn", []),
  ("ie_newtrench_forest_weave1_shelter",0, "ie_newtrench_forest_weave1_shelter", "bo_ie_newtrench_forest_plank1_shelter", []),
  ("ie_newtrench_forest_weave1_firestep",0, "ie_newtrench_forest_weave1_firestep", "bo_ie_newtrench_forest_weave1_firestep", []),
  ("ie_newtrench_forest_weave1_ladder",0, "ie_newtrench_forest_weave1_ladder", "bo_ie_newtrench_forest_weave1_ladder", []),
  ("ie_newtrench_forest_weave1_duckboards",0, "ie_newtrench_forest_weave1_duckboards", "bo_ie_newtrench_forest_weave1_duckboards", []),
  ("ie_newtrench_forest_weave1_duckboards2",0, "ie_newtrench_forest_weave1_duckboards2", "bo_ie_newtrench_forest_weave1_duckboards2", []),
 
  ("ie_bunker_corner",0, "bunker_corner", "bo_bunker_corner", []),
  ("ie_bunker_roof_and_floor",0, "bunker_roof_and_floor", "bo_bunker_roof_and_floor", []),
  ("ie_bunker_corner_slit",0, "bunker_corner_slit", "bo_bunker_corner_slit", []),
  ("ie_bunker_door",0, "bunker_door", "bo_bunker_door", []),
  ("ie_bunker_entrance",0, "bunker_entrance", "bo_bunker_entrance", []),
  ("ie_bunker_invert_corner",0, "bunker_invert_corner", "bo_bunker_invert_corner", []),
  ("ie_bunker_mg_nest",0, "bunker_mg_nest", "bo_bunker_mg_nest", []),
  ("ie_bunker_wall",0, "bunker_wall", "bo_bunker_wall", []),
