...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_greatsword", 0, amf_client_prediction,
   [6.0, "stand_melee", 0, 80, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
 ],
 ["stand_staff", 0, amf_client_prediction,
   [4.0, "stand_rifle", 0, 60, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
 ],
...
#   [0.8, "run_normal", 0, 12, arf_use_walk_progress|arf_cyclic|blend_in_walk,pack2f(0.4,0.9)], 
 ...
 ["run_forward_staff", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   ...
   [0.8, "run_rifle_new", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
 ["run_forward_greatsword", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [0.8, "BI_customrun", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 ["crouch_greatsword", 0, amf_client_prediction,
   [6.0, "stand_melee", 0, 170, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
 ],
 ...
 ["reload_musket_full", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
  [3.0, "man_reload", 0, 50, arf_stick_item_to_left_hand|arf_blend_in_3|arf_make_custom_sound, pack2f(0.10, 1.00)],
 ],
 ...
 ["horn", acf_enforce_lowerbody,amf_play|amf_keep|amf_priority_mount,
    [3.0, "whistle_check", 0, 4, arf_blend_in_5|arf_cyclic],
  ],
 ...
 ["spyglass", 0, amf_play|amf_keep|amf_priority_mount,
   [1.0, "binoculars", 1, 2,  arf_blend_in_5],   
 ],
...
# ["unused_human_anim_21", 0, 0, [1.0, "anim_human", 0, 1, 0]],
 ...
 ["aim_boltaction",acf_rot_vertical_bow|acf_enforce_all, amf_priority_kick|amf_play|amf_use_weapon_speed|amf_client_owner_prediction|amf_keep, [2.5, "aim_boltaction", 1, 3, arf_blend_in_8],],
 ["fire_boltaction_high_recoil",acf_rot_vertical_bow|acf_enforce_all, amf_priority_die|amf_play|amf_use_weapon_speed, [1.2, "shoot_boltaction_high_recoil", 30, 86, arf_stick_item_to_left_hand],],
 ["fire_boltaction_low_recoil",acf_rot_vertical_bow|acf_enforce_all, amf_priority_die|amf_play|amf_use_weapon_speed, [1.2, "shoot_boltaction_low_recoil", 30, 86, arf_stick_item_to_left_hand],],
 ["fix_bayonet",acf_rot_vertical_bow, amf_priority_rear|amf_play|amf_use_weapon_speed, [4.0, "fix_bayonet", 0, 107,arf_stick_item_to_left_hand|arf_blend_in_8]],
 ["fix_bayonet_end",acf_rot_vertical_bow, amf_priority_rear|amf_play|amf_use_weapon_speed, [0.1, "fix_bayonet", 0, 107,arf_stick_item_to_left_hand|arf_blend_in_8]],
 ["reload_bolt_single",acf_enforce_all, amf_priority_kick|amf_priority_attack|amf_play|amf_use_weapon_speed, [1.0, "reload_bolt_single2", 0, 29,arf_stick_item_to_left_hand|arf_blend_in_1],],
 ["reload_bolt_german",acf_enforce_all, amf_priority_kick|amf_priority_attack|amf_play|amf_use_weapon_speed, [4.8, "reload_bolt_german", 0, 116,arf_stick_item_to_left_hand|arf_blend_in_1],],
 ["clear_anim", acf_enforce_all, amf_priority_kick|amf_play|amf_use_weapon_speed, [0, "staff_cstance", 10, 11, arf_blend_in_8]],
 ["aim_lmg",acf_rot_vertical_bow|acf_enforce_all, amf_priority_kick|amf_play|amf_use_weapon_speed|amf_client_owner_prediction|amf_keep, [2.5, "shoot_lmg", 1, 3, arf_blend_in_8],],
 ["fire_lmg",acf_rot_vertical_bow|acf_enforce_all, amf_priority_die|amf_play|amf_use_weapon_speed, [0.29, "shoot_lmg", 0, 12, 0],],
 ["fire_m4",acf_rot_vertical_bow|acf_enforce_all, amf_priority_die|amf_play|amf_use_weapon_speed, [0.15, "shoot_lmg", 0, 11, 0],],
 ["reload_lmg",acf_enforce_all, amf_priority_kick|amf_priority_attack|amf_play|amf_use_weapon_speed, [2.5, "reload_lmg", 0, 34, arf_blend_in_8],],
 ["reload_german_lmg",acf_enforce_all, amf_priority_kick|amf_priority_attack|amf_play|amf_use_weapon_speed, [3.8, "reload_lmg", 0, 34, arf_blend_in_8],],
 ["reload_lmg_standing",acf_enforce_all, amf_priority_kick|amf_priority_attack|amf_play|amf_use_weapon_speed,  [2.5, "reload_lmg_standing", 0, 33, arf_blend_in_8],], 
 #["aim_pistol",acf_rot_vertical_bow|acf_enforce_all, amf_priority_kick|amf_play|amf_use_weapon_speed|amf_client_owner_prediction|amf_keep, [2.5, "pistol_fire_new", 14, 13, arf_blend_in_8],],
 ["reload_pistol_single",acf_enforce_all, amf_priority_die|amf_play|amf_use_weapon_speed, [0.4, "reload_pistol", 0, 22, arf_blend_in_8],],
 ["unfix_bayonet", acf_rot_vertical_bow, amf_priority_rear|amf_play|amf_use_weapon_speed, [4.0, "unfix_bayonet", 0, 106,arf_stick_item_to_left_hand|arf_blend_in_8]],
 ["reload_pistol_magazine",acf_enforce_all, amf_priority_kick|amf_priority_attack|amf_play|amf_use_weapon_speed,  [2.5, "reload_pistol_magazine", 0, 100, arf_blend_in_8],],
 ["aim_standing_lmg",acf_rot_vertical_bow|acf_enforce_all, amf_priority_kick|amf_play|amf_use_weapon_speed|amf_client_owner_prediction|amf_keep, [1, "shoot_lmg_standing", 0, 1, arf_blend_in_8],],
 ["fire_lmg_standing",acf_rot_vertical_bow|acf_enforce_all, amf_priority_die|amf_play|amf_use_weapon_speed, [0.25, "shoot_lmg_standing", 0, 11, 0],],
 ["fire_pistol_recoil_heavy",acf_rot_vertical_bow|acf_enforce_all, amf_priority_die|amf_play|amf_use_weapon_speed, [0.25, "shoot_pistol", 0, 15, 0],],
 ["fire_pistol_recoil",acf_rot_vertical_bow|acf_enforce_all, amf_priority_die|amf_play|amf_use_weapon_speed, [0.25, "pistol_fire_new", 0, 14, 0],],
 ["aim_pistol_recoil_heavy",acf_rot_vertical_bow|acf_enforce_all, amf_priority_kick|amf_play|amf_use_weapon_speed|amf_client_owner_prediction|amf_keep, [2.5, "shoot_pistol", 13, 14, arf_blend_in_8],],
 ["aim_pistol_recoil",acf_rot_vertical_bow|acf_enforce_all, amf_priority_kick|amf_play|amf_use_weapon_speed|amf_client_owner_prediction|amf_keep, [2.5, "pistol_fire_new", 13, 14, arf_blend_in_8],],
 ["reload_pistol_single_recoil",acf_enforce_all, amf_priority_kick|amf_priority_attack|amf_play|amf_use_weapon_speed,  [0.4, "reload_pistol_recoil", 0, 22, arf_blend_in_8],],
 ["artillery_cover", acf_rot_vertical_bow|acf_enforce_all, amf_priority_die|amf_play|amf_use_weapon_speed, [1.5, "artillery_cover", 3, 8,arf_stick_item_to_left_hand|arf_blend_in_4],],
 ["fix_grenade", acf_rot_vertical_bow, amf_priority_rear|amf_play|amf_use_weapon_speed, [3.0, "fix_grenade", 0, 119, arf_blend_in_8]],
 ["fix_grenade_end", 0, amf_priority_mount|amf_priority_equip|amf_play, [3.5, "fix_grenade", 50, 119, arf_blend_in_1]],
 ["fix_scope", acf_rot_vertical_bow, amf_priority_rear|amf_play|amf_use_weapon_speed, [3.0, "fix_scope", 0, 43, arf_blend_in_8]],
 ["aim_lmg_german",acf_rot_vertical_bow|acf_enforce_all, amf_priority_kick|amf_play|amf_use_weapon_speed|amf_client_owner_prediction|amf_keep, [2.5, "shoot_lmg_german", 1, 3, arf_blend_in_8],],
 ["fire_lmg_german",acf_rot_vertical_bow|acf_enforce_all, amf_priority_die|amf_play|amf_use_weapon_speed, [0.25, "shoot_lmg_german", 0, 12, 0],],
 ["grammophone_dance", acf_enforce_lowerbody,amf_play|amf_keep|amf_priority_mount, [4.0, "french_officer", 0, 148, arf_blend_in_5|arf_cyclic],],
 ["forced_aim_grenadelauncher",acf_rot_vertical_bow|acf_enforce_all, amf_priority_equip|amf_priority_kick|amf_play|amf_use_weapon_speed|amf_client_owner_prediction, [0.1, "french_vivenb_aim", 0, 1, arf_blend_in_8],],
 ["aim_grenadelauncher",acf_rot_vertical_bow|acf_enforce_all, amf_priority_kick|amf_play|amf_use_weapon_speed|amf_client_owner_prediction|amf_keep, [6.0, "french_vivenb_aim", 0, 1, arf_blend_in_8],],
 ["salute", 0, amf_play|amf_keep|amf_priority_mount,[1.0, "salute", 1, 2,  arf_blend_in_5],   ],
 ["salute_end", 0, amf_play|amf_priority_mount,[0.1, "salute", 0, 24, arf_blend_in_5],],
 ["call_medic", acf_enforce_all, amf_play|amf_keep|amf_priority_mount,[4, "call_medic", 0, 12, arf_blend_in_5|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["call_medic_end", 0, amf_play|amf_priority_mount,[0.1, "call_medic", 0, 148, arf_blend_in_5],],
