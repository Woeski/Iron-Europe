...
meshes = [
  ...
  #("grid_map",0,"grid_map",0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("flag_project_sr", 0, "empty_mesh", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("flag_project_sr_miss", 0, "empty_mesh", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("banner_kingdom_b", 0, "banner6", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_kingdom_c", 0, "banner3", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_kingdom_d", 0, "banner1", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_kingdom_e", 0, "empty_mesh", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ...
  ("ui_kingdom_shield_5", 0, "empty_mesh", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ###ie's stuff##
  ("arty_icon_call_artillery", 0, "arty_icon_call_artillery", 0, 0, 0, 0, 0, 0, 1, 1, 1),
...
#  ("compass", 0, "compass", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ####IRON EUROPE stuff begin##########
  
  ("ie_walkicon_1", 0, "ie_user_interface_icon_2", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ie_running_icon", 0, "ie_user_interface_icon_1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ie_crouching_icon", 0, "ie_user_interface_icon_3", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ie_standing_icon", 0, "ie_user_interface_icon_4", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ie_wounded_player_icon", 0, "ie_medic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  
  ("ie_sniper_view", 0, "ie_scope_view", 0, 0, 0, 0, 0, 0, 1, 1, 1),
