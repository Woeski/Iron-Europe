...
##           
##           (this_or_next|eq, ":player_item", "itm_germangewehr98"),
##           (this_or_next|eq, ":player_item", "itm_germangewehr98_b"),
##           (this_or_next|eq, ":player_item", "itm_germank98az"),
##
##           (this_or_next|eq, ":player_item", "itm_russian_rifle_1805"),
##           
##           (eq, ":player_item", "itm_frenchlebelrifle"),
##
##           (game_key_is_down, gk_zoom),
##
##           (agent_get_look_position, pos1, ":player_agent"),
##
##           (position_move_x, pos1, 11.5),
##
##           (position_move_z, pos1, 37),
##
##           (init_position, pos2),
##
##           (init_position, pos3),
...
##
##           (mission_cam_set_aperture, 50),
#           
#         (else_try),
#        # (mission_cam_is_mode, 1),
#
#           (agent_get_wielded_item, ":player_item", ":player_agent", 0),
#
#           (this_or_next|eq, ":player_item", "itm_germangewehr98"),
...
multiplayer_server_sail_ship = (
  ...
  [
    ...
    (scene_prop_get_num_instances, ":end_cond", "spr_mm_ship"),
    (try_for_range,":cur_instance",0,":end_cond"),
      (scene_prop_get_instance, ":instance_id", "spr_mm_ship", ":cur_instance"),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (val_add,":cur_y_vel",20),
          (try_begin),
            (gt,":cur_y_vel",180),
            (assign,":cur_y_vel",180),
          (try_end),
        (else_try),
...
multiplayer_client_control_ship = (
  0.25, 0, 0, [(neg|multiplayer_is_dedicated_server),
              ...
              (eq, "$g_cur_control_prop_kind", "spr_mm_ship"),
...
#Firing System Begin#
#Client & Server sided - Initialize this shit#
multiplayer_ie_weapons_declarations = (ti_before_mission_start, 0, 0, [],
	[
	#(display_message,"@Begin initialization"),
	#zombie gun classifications zgc
	#1 - Handgun or Automatic Revolver
	#2 - Single or Double Action Revolver
	#3 - Bolt or Lever-Action Rifle
	#4 - Semi/Automatic Rifle
	#5 - Barrets - Sniper rifles
	#6 - SMG
	#7 - Double-Barrel or Automatic Shotgun
	#8 - Pump-Action Shotgun
    (item_set_slot, "itm_britishtrenchgun", slot_item_guntype, 8),
	(item_set_slot, "itm_british_webley", slot_item_guntype, 1),
    (item_set_slot, "itm_britishsmle", slot_item_guntype, 3),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_guntype, 3),
    (item_set_slot, "itm_british_lewis", slot_item_guntype, 4),
	(item_set_slot, "itm_frenchautorifle", slot_item_guntype, 4),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_guntype, 3),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_guntype, 3),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_guntype, 3),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_guntype, 3),
	(item_set_slot, "itm_french_chauchat", slot_item_guntype, 4),
	(item_set_slot, "itm_german_mg08", slot_item_guntype, 4),
	(item_set_slot, "itm_french_revolver", slot_item_guntype, 1),
	(item_set_slot, "itm_french_m73_revolver", slot_item_guntype, 1),
	(item_set_slot, "itm_german_revolver", slot_item_guntype, 1),
	(item_set_slot, "itm_german_c96", slot_item_guntype, 1),
	(item_set_slot, "itm_german_arty_luger", slot_item_guntype, 1),
	(item_set_slot, "itm_german_luger", slot_item_guntype, 1),
	(item_set_slot, "itm_french_ruby", slot_item_guntype, 1),
	(item_set_slot, "itm_germangewehr98", slot_item_guntype, 3),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_guntype, 3),		
	(item_set_slot, "itm_germangewehr98_b", slot_item_guntype, 3),
	(item_set_slot, "itm_germank98az", slot_item_guntype, 3),
	(item_set_slot, "itm_germank98az_sniper", slot_item_guntype, 3),
	(item_set_slot, "itm_germank98az_b", slot_item_guntype, 3),
	(item_set_slot, "itm_assault_rifle", slot_item_guntype, 4),
	(item_set_slot, "itm_sniper_rifle", slot_item_guntype, 4),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher", slot_item_guntype, 6),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_guntype, 3),
	
	#zombie ammo declaration... this MUST BE the same as the value in the items tuple
    (item_set_slot, "itm_britishtrenchgun", slot_item_maxammo, 3),
    (item_set_slot, "itm_british_webley", slot_item_maxammo, 6),
    (item_set_slot, "itm_britishsmle", slot_item_maxammo, 10),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_maxammo, 10),
    (item_set_slot, "itm_british_lewis", slot_item_maxammo, 40),
	(item_set_slot, "itm_frenchautorifle", slot_item_maxammo, 5),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_maxammo, 8),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_maxammo, 8),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_maxammo, 5),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_maxammo, 8),
	(item_set_slot, "itm_germangewehr98", slot_item_maxammo, 5),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_maxammo, 5),
	(item_set_slot, "itm_germangewehr98_b", slot_item_maxammo, 5),
	(item_set_slot, "itm_french_chauchat", slot_item_maxammo, 20),
	(item_set_slot, "itm_german_mg08", slot_item_maxammo, 100),
	(item_set_slot, "itm_french_revolver", slot_item_maxammo, 6),
	(item_set_slot, "itm_french_m73_revolver", slot_item_maxammo, 6),
	(item_set_slot, "itm_french_ruby", slot_item_maxammo, 9),
	(item_set_slot, "itm_german_revolver", slot_item_maxammo, 6),
	(item_set_slot, "itm_german_c96", slot_item_maxammo, 10),
	(item_set_slot, "itm_german_arty_luger", slot_item_maxammo, 32),
	(item_set_slot, "itm_german_luger", slot_item_maxammo, 8),
	(item_set_slot, "itm_germank98az", slot_item_maxammo, 5),
	(item_set_slot, "itm_germank98az_sniper", slot_item_maxammo, 5),
	(item_set_slot, "itm_germank98az_b", slot_item_maxammo, 5),
	(item_set_slot, "itm_assault_rifle", slot_item_maxammo, 250),
	(item_set_slot, "itm_sniper_rifle", slot_item_maxammo, 100),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher", slot_item_maxammo, 1),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_maxammo, 8),
	
	#zombie ammo type declaration, 1 = pistol rounds 2 = rifle rounds
    (item_set_slot, "itm_britishtrenchgun", slot_item_ammotype, 2),
	(item_set_slot, "itm_british_webley", slot_item_ammotype, 1),
    (item_set_slot, "itm_britishsmle", slot_item_ammotype, 2),
    (item_set_slot, "itm_britishsmle", slot_item_ammotype, 2),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_ammotype, 2),
    (item_set_slot, "itm_british_lewis", slot_item_ammotype, 2),
    (item_set_slot, "itm_frenchautorifle", slot_item_ammotype, 2),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_ammotype, 2),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_ammotype, 2),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_ammotype, 2),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_ammotype, 2),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_ammotype, 2),
	(item_set_slot, "itm_germangewehr98", slot_item_ammotype, 2),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_ammotype, 2),
	(item_set_slot, "itm_germangewehr98_b", slot_item_ammotype, 2),
	(item_set_slot, "itm_germank98az", slot_item_ammotype, 2),
	(item_set_slot, "itm_germank98az_sniper", slot_item_ammotype, 2),
	(item_set_slot, "itm_germank98az_b", slot_item_ammotype, 2),
	(item_set_slot, "itm_french_chauchat", slot_item_ammotype, 2),
	(item_set_slot, "itm_german_mg08", slot_item_ammotype, 2),
	(item_set_slot, "itm_french_revolver", slot_item_ammotype, 1),
	(item_set_slot, "itm_french_m73_revolver", slot_item_ammotype, 1),
	(item_set_slot, "itm_german_revolver", slot_item_ammotype, 1),
	(item_set_slot, "itm_german_c96", slot_item_ammotype, 1),
	(item_set_slot, "itm_german_arty_luger", slot_item_ammotype, 1),
	(item_set_slot, "itm_german_luger", slot_item_ammotype, 1),
	(item_set_slot, "itm_french_ruby", slot_item_ammotype, 1),
	(item_set_slot, "itm_assault_rifle", slot_item_ammotype, 2),
	


	#zombie reload anim declaration
	(item_set_slot, "itm_britishtrenchgun", slot_item_reload_anim, "anim_reload_pistol_single_recoil"),
	(item_set_slot, "itm_british_webley", slot_item_reload_anim, "anim_reload_pistol_single_recoil"),
    (item_set_slot, "itm_britishsmle", slot_item_reload_anim, "anim_reload_bolt_german"),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_reload_anim, "anim_reload_bolt_german"),
    (item_set_slot, "itm_british_lewis", slot_item_reload_anim, "anim_reload_lmg_standing"),
	(item_set_slot, "itm_frenchautorifle", slot_item_reload_anim, "anim_reload_lmg"),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_reload_anim, "anim_reload_bolt_single"),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_reload_anim, "anim_reload_bolt_single"),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_reload_anim, "anim_reload_bolt_single"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_reload_anim, "anim_reload_bolt_single"),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_reload_anim, "anim_reload_bolt_german"),
	(item_set_slot, "itm_germangewehr98", slot_item_reload_anim, "anim_reload_bolt_german"),	
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_reload_anim, "anim_reload_bolt_single"),
	(item_set_slot, "itm_germangewehr98_b", slot_item_reload_anim, "anim_reload_bolt_german"),
	(item_set_slot, "itm_germank98az", slot_item_reload_anim, "anim_reload_bolt_german"),
	(item_set_slot, "itm_germank98az_sniper", slot_item_reload_anim, "anim_reload_bolt_single"),
	(item_set_slot, "itm_germank98az_b", slot_item_reload_anim, "anim_reload_bolt_german"),
	(item_set_slot, "itm_french_chauchat", slot_item_reload_anim, "anim_reload_lmg"),
	(item_set_slot, "itm_german_mg08", slot_item_reload_anim, "anim_reload_lmg_standing"),
	(item_set_slot, "itm_french_revolver", slot_item_reload_anim, "anim_reload_pistol_single_recoil"),
	(item_set_slot, "itm_german_c96", slot_item_reload_anim, "anim_reload_lmg_standing"),
	(item_set_slot, "itm_german_luger", slot_item_reload_anim, "anim_reload_pistol_magazine"),
	(item_set_slot, "itm_german_arty_luger", slot_item_reload_anim, "anim_reload_pistol_magazine"),
	(item_set_slot, "itm_french_m73_revolver", slot_item_reload_anim, "anim_reload_pistol_single_recoil"),
	(item_set_slot, "itm_french_ruby", slot_item_reload_anim, "anim_reload_pistol_magazine"),
	(item_set_slot, "itm_german_revolver", slot_item_reload_anim, "anim_reload_pistol_single_recoil"),  
	#zombie fire animation declaration
    (item_set_slot, "itm_britishtrenchgun", slot_item_fire_anim, "anim_fire_lmg"),
	(item_set_slot, "itm_british_webley", slot_item_fire_anim, "anim_fire_pistol_recoil"),
    (item_set_slot, "itm_britishsmle", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
    (item_set_slot, "itm_british_lewis", slot_item_fire_anim, "anim_fire_lmg"),
	(item_set_slot, "itm_frenchautorifle", slot_item_fire_anim, "anim_fire_lmg_german"),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_germangewehr98", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_germangewehr98_b", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_germank98az", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_germank98az_sniper", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_germank98az_b", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),
	(item_set_slot, "itm_french_chauchat", slot_item_fire_anim, "anim_fire_lmg"),
	(item_set_slot, "itm_german_mg08", slot_item_fire_anim, "anim_fire_lmg_german"),
	(item_set_slot, "itm_assault_rifle", slot_item_fire_anim, "anim_fire_m4"),
	(item_set_slot, "itm_french_revolver", slot_item_fire_anim, "anim_fire_pistol_recoil"),
	(item_set_slot, "itm_french_m73_revolver", slot_item_fire_anim, "anim_fire_pistol_recoil"),
	(item_set_slot, "itm_french_ruby", slot_item_fire_anim, "anim_fire_pistol_recoil"),	
	(item_set_slot, "itm_german_c96", slot_item_fire_anim, "anim_fire_pistol_recoil"),(item_set_slot, "itm_german_arty_luger", slot_item_fire_anim, "anim_fire_pistol_recoil_heavy"),	
	(item_set_slot, "itm_german_luger", slot_item_fire_anim, "anim_fire_pistol_recoil"),	
	(item_set_slot, "itm_german_revolver", slot_item_fire_anim, "anim_fire_pistol_recoil"),
	(item_set_slot, "itm_sniper_rifle", slot_item_fire_anim, "anim_release_musket"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher", slot_item_fire_anim, "anim_aim_grenadelauncher"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_fire_anim, "anim_fire_boltaction_high_recoil"),

	#zombie aim animation declaration
    (item_set_slot, "itm_britishtrenchgun", slot_item_aim_anim, "anim_aim_lmg"),
    (item_set_slot, "itm_british_webley", slot_item_aim_anim, "anim_aim_pistol_recoil"),
    (item_set_slot, "itm_britishsmle", slot_item_aim_anim, "anim_aim_boltaction"),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_aim_anim, "anim_aim_boltaction"),
    (item_set_slot, "itm_british_lewis", slot_item_aim_anim, "anim_aim_lmg"),
	(item_set_slot, "itm_frenchautorifle", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_germangewehr98", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_germangewehr98_b", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_germank98az", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_germank98az_sniper", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_germank98az_b", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_french_chauchat", slot_item_aim_anim, "anim_aim_lmg"),
	(item_set_slot, "itm_german_mg08", slot_item_aim_anim, "anim_aim_lmg_german"),
	(item_set_slot, "itm_french_revolver", slot_item_aim_anim, "anim_aim_pistol_recoil"),
	(item_set_slot, "itm_french_m73_revolver", slot_item_aim_anim, "anim_aim_pistol_recoil"),
	(item_set_slot, "itm_german_c96", slot_item_aim_anim, "anim_aim_pistol_recoil"),
	(item_set_slot, "itm_german_luger", slot_item_aim_anim, "anim_aim_pistol_recoil"),
	(item_set_slot, "itm_german_arty_luger", slot_item_aim_anim, "anim_aim_pistol_recoil_heavy"),
	(item_set_slot, "itm_french_ruby", slot_item_aim_anim, "anim_aim_pistol_recoil"),
	(item_set_slot, "itm_german_revolver", slot_item_aim_anim, "anim_aim_pistol_recoil"),
	(item_set_slot, "itm_assault_rifle", slot_item_aim_anim, "anim_aim_boltaction"),
	(item_set_slot, "itm_sniper_rifle", slot_item_aim_anim, "anim_ready_musket"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher", slot_item_aim_anim, "anim_aim_grenadelauncher"),
	
	#zombie firing sound declaration
	(item_set_slot, "itm_britishtrenchgun", slot_item_firesound, "snd_ie_fire_berthier"),
	(item_set_slot, "itm_british_webley", slot_item_firesound, "snd_ie_fire_revolver"),
    (item_set_slot, "itm_britishsmle", slot_item_firesound, "snd_ie_fire_gewehr98"),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_firesound, "snd_ie_fire_gewehr98"),
    (item_set_slot, "itm_british_lewis", slot_item_firesound, "snd_ie_fire_m4"),
	(item_set_slot, "itm_frenchautorifle", slot_item_firesound, "snd_ie_fire_berthier"),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_firesound, "snd_ie_fire_lebel"),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_firesound, "snd_ie_fire_lebel"),	
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_firesound, "snd_ie_fire_lebel"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_firesound, "snd_ie_fire_lebel"),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_firesound, "snd_ie_fire_berthier"),
	(item_set_slot, "itm_germangewehr98", slot_item_firesound, "snd_ie_fire_gewehr98"),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_firesound, "snd_ie_fire_gewehr98"),
	(item_set_slot, "itm_germangewehr98_b", slot_item_firesound, "snd_ie_fire_gewehr98"),
	(item_set_slot, "itm_germank98az", slot_item_firesound, "snd_ie_fire_gewehr98"),
	(item_set_slot, "itm_germank98az_sniper", slot_item_firesound, "snd_ie_fire_gewehr98"),
	(item_set_slot, "itm_germank98az_b", slot_item_firesound, "snd_ie_fire_gewehr98"),
	(item_set_slot, "itm_german_c96", slot_item_firesound, "snd_ie_fire_c96"),
	(item_set_slot, "itm_german_luger", slot_item_firesound, "snd_ie_fire_c96"),
	(item_set_slot, "itm_german_arty_luger", slot_item_firesound, "snd_ie_fire_c96"),
	(item_set_slot, "itm_french_chauchat", slot_item_firesound, "snd_ie_fire_chauchat"),
	(item_set_slot, "itm_german_mg08", slot_item_firesound, "snd_ie_fire_mg08"),
	(item_set_slot, "itm_french_revolver", slot_item_firesound, "snd_ie_fire_revolver"),
	(item_set_slot, "itm_french_m73_revolver", slot_item_firesound, "snd_ie_fire_revolver"),
	(item_set_slot, "itm_german_revolver", slot_item_firesound, "snd_ie_fire_revolver"),
	(item_set_slot, "itm_french_ruby", slot_item_firesound, "snd_ie_fire_ruby"),
	(item_set_slot, "itm_assault_rifle", slot_item_firesound, "snd_ie_fire_m4"),
	(item_set_slot, "itm_sniper_rifle", slot_item_firesound, "snd_ie_fire_rpg"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher", slot_item_firesound, "snd_ie_fire_rpg"),

	#zombie action sound declaration
    (item_set_slot, "itm_britishtrenchgun", slot_item_action_sound, "snd_ie_action_gewehr98"),
    (item_set_slot, "itm_britishsmle", slot_item_action_sound, "snd_ie_action_gewehr98"),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_action_sound, "snd_ie_action_gewehr98"),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_action_sound, "snd_ie_action_lebel"),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_action_sound, "snd_ie_action_lebel"),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_action_sound, "snd_ie_action_lebel"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_action_sound, "snd_ie_action_lebel"),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_action_sound, "snd_ie_action_lebel"),
	(item_set_slot, "itm_germangewehr98", slot_item_action_sound, "snd_ie_action_gewehr98"),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_action_sound, "snd_ie_action_gewehr98"),
	(item_set_slot, "itm_germangewehr98_b", slot_item_action_sound, "snd_ie_action_gewehr98"),
	(item_set_slot, "itm_germank98az", slot_item_action_sound, "snd_ie_action_gewehr98"),
	(item_set_slot, "itm_germank98az_sniper", slot_item_action_sound, "snd_ie_action_gewehr98"),
	(item_set_slot, "itm_germank98az_b", slot_item_action_sound, "snd_ie_action_gewehr98"),

	#zombie reload sound declaration
    (item_set_slot, "itm_britishtrenchgun", slot_item_reloadsound, "snd_ie_load_lmg"),
	(item_set_slot, "itm_british_webley", slot_item_reloadsound, "snd_ie_reload_revolver"),
    (item_set_slot, "itm_britishsmle", slot_item_reloadsound, "snd_ie_reload_gewehr98"),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_reloadsound, "snd_ie_reload_gewehr98"),
    (item_set_slot, "itm_british_lewis", slot_item_reloadsound, "snd_ie_load_lmg"),
	(item_set_slot, "itm_frenchautorifle", slot_item_reloadsound, "snd_ie_load_lmg"),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_reloadsound, "snd_ie_load_lebel"), #snd_ie_load_lebel
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_reloadsound, "snd_ie_load_lebel"),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_reloadsound, "snd_ie_load_lebel"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_reloadsound, "snd_ie_load_lebel"),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_reloadsound, "snd_ie_reload_gewehr98"),
	(item_set_slot, "itm_germangewehr98", slot_item_reloadsound, "snd_ie_reload_gewehr98"),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_reloadsound, "snd_ie_load_lebel"),
	(item_set_slot, "itm_germangewehr98_b", slot_item_reloadsound, "snd_ie_reload_gewehr98"),
	(item_set_slot, "itm_germank98az", slot_item_reloadsound, "snd_ie_reload_gewehr98"),
	(item_set_slot, "itm_germank98az_sniper", slot_item_reloadsound, "snd_ie_load_lebel"),
	(item_set_slot, "itm_germank98az_b", slot_item_reloadsound, "snd_ie_reload_gewehr98"),
	(item_set_slot, "itm_french_chauchat", slot_item_reloadsound, "snd_ie_load_lmg"),
	(item_set_slot, "itm_german_mg08", slot_item_reloadsound, "snd_ie_reload_mg08"),
	(item_set_slot, "itm_french_ruby", slot_item_reloadsound, "snd_ie_reload_ruby"),
	(item_set_slot, "itm_german_c96", slot_item_reloadsound, "snd_ie_mauser_c96_reload"),
	(item_set_slot, "itm_german_luger", slot_item_reloadsound, "snd_ie_mauser_c96_reload"),
	(item_set_slot, "itm_german_arty_luger", slot_item_reloadsound, "snd_ie_mauser_c96_reload"),
	(item_set_slot, "itm_french_revolver", slot_item_reloadsound, "snd_ie_reload_revolver"),
	(item_set_slot, "itm_french_m73_revolver", slot_item_reloadsound, "snd_ie_reload_revolver"),
	(item_set_slot, "itm_german_revolver", slot_item_reloadsound, "snd_ie_reload_revolver"),
	
	
	#zombie reload time declaration... 42.5 = approx 1 second, NO FLOATING POINTS, REAL NUMBERS ONLY
    (item_set_slot, "itm_britishtrenchgun", slot_item_reload_time, 28),
    (item_set_slot, "itm_british_webley", slot_item_reload_time, 28),
    (item_set_slot, "itm_britishsmle", slot_item_reload_time, 240),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_reload_time, 240),
    (item_set_slot, "itm_british_lewis", slot_item_reload_time, 250),
	(item_set_slot, "itm_frenchautorifle", slot_item_reload_time, 180),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_reload_time, 45),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_reload_time, 45),
 	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_reload_time, 45),
 	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_reload_time, 45),
 	(item_set_slot, "itm_french_berthier_carbine", slot_item_reload_time, 180),
	(item_set_slot, "itm_germangewehr98", slot_item_reload_time, 180),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_reload_time, 45),
 	(item_set_slot, "itm_germangewehr98_b", slot_item_reload_time, 180),
	(item_set_slot, "itm_germank98az", slot_item_reload_time, 180),
	(item_set_slot, "itm_germank98az_sniper", slot_item_reload_time, 45),
 	(item_set_slot, "itm_germank98az_b", slot_item_reload_time, 180),
  	(item_set_slot, "itm_french_chauchat", slot_item_reload_time, 250),
	(item_set_slot, "itm_german_mg08", slot_item_reload_time, 335),
	(item_set_slot, "itm_french_ruby", slot_item_reload_time, 145),	
	(item_set_slot, "itm_german_c96", slot_item_reload_time, 145),	
	(item_set_slot, "itm_german_luger", slot_item_reload_time, 145),
	(item_set_slot, "itm_german_arty_luger", slot_item_reload_time, 150),	
    (item_set_slot, "itm_french_revolver", slot_item_reload_time, 28),
    (item_set_slot, "itm_french_m73_revolver", slot_item_reload_time, 28),
    (item_set_slot, "itm_german_revolver", slot_item_reload_time, 28),

	#zombie reload type declaration... 1 = single, 0 = magazine
    (item_set_slot, "itm_britishtrenchgun", slot_item_single_reload, 1),
    (item_set_slot, "itm_british_webley", slot_item_single_reload, 1),
    (item_set_slot, "itm_britishsmle", slot_item_single_reload, 0),
	(item_set_slot, "itm_frenchautorifle", slot_item_single_reload, 0),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_single_reload, 1),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_single_reload, 1),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_single_reload, 1),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_single_reload, 1),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_single_reload, 0),
	(item_set_slot, "itm_germangewehr98", slot_item_single_reload, 0),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_single_reload, 1), #Since the scope only allows you to load bullets one by one
	(item_set_slot, "itm_germangewehr98_b", slot_item_single_reload, 0),
	(item_set_slot, "itm_germank98az", slot_item_single_reload, 0),
	(item_set_slot, "itm_germank98az_sniper", slot_item_single_reload, 1),
	(item_set_slot, "itm_germank98az_b", slot_item_single_reload, 0),
	(item_set_slot, "itm_french_revolver", slot_item_single_reload, 1),
	(item_set_slot, "itm_french_m73_revolver", slot_item_single_reload, 1),
	(item_set_slot, "itm_french_ruby", slot_item_single_reload, 0),
	(item_set_slot, "itm_german_c96", slot_item_single_reload, 0),
	(item_set_slot, "itm_german_luger", slot_item_single_reload, 0),
	(item_set_slot, "itm_german_arty_luger", slot_item_single_reload, 0),
	(item_set_slot, "itm_german_revolver", slot_item_single_reload, 1),
	
	#zombie fire rate declaration... units before firing the next shot, again, 42.5 per second
    (item_set_slot, "itm_britishtrenchgun", slot_item_fire_rate, 65),
	(item_set_slot, "itm_british_webley", slot_item_fire_rate, 26),  
    (item_set_slot, "itm_britishsmle", slot_item_fire_rate, 55),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_fire_rate, 55),
    (item_set_slot, "itm_british_lewis", slot_item_fire_rate, 8),
	(item_set_slot, "itm_frenchautorifle", slot_item_fire_rate, 26),  
	(item_set_slot, "itm_frenchlebelrifle", slot_item_fire_rate, 65),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_fire_rate, 55),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_fire_rate, 65),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_fire_rate, 65),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_fire_rate, 55),
	(item_set_slot, "itm_germangewehr98", slot_item_fire_rate, 65),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_fire_rate, 65),
	(item_set_slot, "itm_germangewehr98_b", slot_item_fire_rate, 65),
	(item_set_slot, "itm_germank98az", slot_item_fire_rate, 55),
	(item_set_slot, "itm_germank98az_sniper", slot_item_fire_rate, 55),
	(item_set_slot, "itm_germank98az_b", slot_item_fire_rate, 55),
	(item_set_slot, "itm_french_chauchat", slot_item_fire_rate, 11),
	(item_set_slot, "itm_german_mg08", slot_item_fire_rate, 6),
	(item_set_slot, "itm_french_revolver", slot_item_fire_rate, 25),  
	(item_set_slot, "itm_french_m73_revolver", slot_item_fire_rate, 25),  
	(item_set_slot, "itm_french_ruby", slot_item_fire_rate, 15),  
	(item_set_slot, "itm_german_c96", slot_item_fire_rate, 20),  
	(item_set_slot, "itm_german_luger", slot_item_fire_rate, 35),
	(item_set_slot, "itm_german_arty_luger", slot_item_fire_rate, 25),  
	(item_set_slot, "itm_german_revolver", slot_item_fire_rate, 25),
	(item_set_slot, "itm_assault_rifle", slot_item_fire_rate, 10),
	(item_set_slot, "itm_sniper_rifle", slot_item_fire_rate, 40),
	
	#zombie auto declaration... 1 = full auto
	(item_set_slot, "itm_british_lewis", slot_item_automatic, 1),
	(item_set_slot, "itm_french_chauchat", slot_item_automatic, 1),
	(item_set_slot, "itm_frenchautorifle", slot_item_automatic, 1),
	(item_set_slot, "itm_assault_rifle", slot_item_automatic, 1),
	(item_set_slot, "itm_german_mg08", slot_item_automatic, 1),

	#zombie accuracy declaration... degrees deviation from zero, 1000 = 1 degree
    (item_set_slot, "itm_britishtrenchgun", slot_item_accuracy, 8400),
	(item_set_slot, "itm_british_webley", slot_item_accuracy, 840),
    (item_set_slot, "itm_britishsmle", slot_item_accuracy, 100),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_accuracy, 100),
    (item_set_slot, "itm_british_lewis", slot_item_accuracy, 1400),
	(item_set_slot, "itm_frenchautorifle", slot_item_accuracy, 100),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_accuracy, 100),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_accuracy, 100),	
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_accuracy, 1100),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_accuracy, 100),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_accuracy, 500),
	(item_set_slot, "itm_germangewehr98", slot_item_accuracy, 100),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_accuracy, 100),
	(item_set_slot, "itm_germangewehr98_b", slot_item_accuracy, 1000),
	(item_set_slot, "itm_germank98az", slot_item_accuracy, 150),
	(item_set_slot, "itm_germank98az_sniper", slot_item_accuracy, 100),
	(item_set_slot, "itm_germank98az_b", slot_item_accuracy, 1100),
	(item_set_slot, "itm_french_chauchat", slot_item_accuracy, 1500),
	(item_set_slot, "itm_german_mg08", slot_item_accuracy, 1400),
	(item_set_slot, "itm_french_revolver", slot_item_accuracy, 850),
	(item_set_slot, "itm_french_m73_revolver", slot_item_accuracy, 850),
	(item_set_slot, "itm_french_ruby", slot_item_accuracy, 875),
	(item_set_slot, "itm_german_revolver", slot_item_accuracy, 850),
	(item_set_slot, "itm_german_c96", slot_item_accuracy, 750),
	(item_set_slot, "itm_german_luger", slot_item_accuracy, 500),
	(item_set_slot, "itm_german_arty_luger", slot_item_accuracy, 430),
	(item_set_slot, "itm_assault_rifle", slot_item_accuracy, 100),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher", slot_item_accuracy, 1200),
	(item_set_slot, "itm_sniper_rifle", slot_item_accuracy, 100),
	#zombie recoil X declaration (VERTICAL)... in degrees, 1000 = 1 degree
	(item_set_slot, "itm_britishtrenchgun", slot_item_recoil_x, 50),
	(item_set_slot, "itm_british_webley", slot_item_recoil_x, 125),
    (item_set_slot, "itm_british_lewis", slot_item_recoil_x, 20),
	(item_set_slot, "itm_french_chauchat", slot_item_recoil_x, 20),
	(item_set_slot, "itm_german_mg08", slot_item_recoil_x, 0),
	(item_set_slot, "itm_french_revolver", slot_item_recoil_x, 125),
	(item_set_slot, "itm_french_m73_revolver", slot_item_recoil_x, 125),
	(item_set_slot, "itm_french_ruby", slot_item_recoil_x, 100),
	(item_set_slot, "itm_german_revolver", slot_item_recoil_x, 125),
	(item_set_slot, "itm_german_c96", slot_item_recoil_x, 125),
	(item_set_slot, "itm_german_arty_luger", slot_item_recoil_x, 100),
	(item_set_slot, "itm_assault_rifle", slot_item_recoil_x, 0),
	#zombie recoil Y declaration (HORIZONTAL)... in degrees, 1000 = 1 degree
    (item_set_slot, "itm_britishtrenchgun", slot_item_recoil_y, 0),
	(item_set_slot, "itm_british_webley", slot_item_recoil_y, -120), 
    (item_set_slot, "itm_british_lewis", slot_item_recoil_y, 0),
	(item_set_slot, "itm_french_chauchat", slot_item_recoil_y, 0),
	(item_set_slot, "itm_german_mg08", slot_item_recoil_y, 50), #30
	(item_set_slot, "itm_french_revolver", slot_item_recoil_y, -120), 
	(item_set_slot, "itm_french_m73_revolver", slot_item_recoil_y, -120), 
	(item_set_slot, "itm_french_ruby", slot_item_recoil_y, 0), 
	(item_set_slot, "itm_german_revolver", slot_item_recoil_y, -120),
	(item_set_slot, "itm_german_c96", slot_item_recoil_y, -120),
	(item_set_slot, "itm_german_arty_luger", slot_item_recoil_y, -100),
	(item_set_slot, "itm_assault_rifle", slot_item_recoil_y, 0),
	#zombie velocity declaration... meters/second, same accuracy for the sniper rifle since they're just the same rifles as the normal ones.
    (item_set_slot, "itm_britishtrenchgun", slot_item_velocity, 50),
	(item_set_slot, "itm_british_webley", slot_item_velocity, 720),
    (item_set_slot, "itm_britishsmle", slot_item_velocity, 701),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_velocity, 701),
    (item_set_slot, "itm_british_lewis", slot_item_velocity, 640),
	(item_set_slot, "itm_frenchautorifle", slot_item_velocity, 701),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_velocity, 701),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_velocity, 701),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_velocity, 701),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_velocity, 701),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_velocity, 620),
	(item_set_slot, "itm_germangewehr98", slot_item_velocity, 878),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_velocity, 878),
	(item_set_slot, "itm_germangewehr98_b", slot_item_velocity, 878),
	(item_set_slot, "itm_germank98az", slot_item_velocity, 878),
	(item_set_slot, "itm_germank98az_sniper", slot_item_velocity, 878),
	(item_set_slot, "itm_germank98az_b", slot_item_velocity, 878),
	(item_set_slot, "itm_french_chauchat", slot_item_velocity, 630),
	(item_set_slot, "itm_german_mg08", slot_item_velocity, 900),
	(item_set_slot, "itm_assault_rifle", slot_item_velocity, 1200),
	(item_set_slot, "itm_sniper_rifle", slot_item_velocity, 1500),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher", slot_item_velocity, 30),
	(item_set_slot, "itm_french_revolver", slot_item_velocity, 720),
	(item_set_slot, "itm_french_m73_revolver", slot_item_velocity, 720),
	(item_set_slot, "itm_french_ruby", slot_item_velocity, 705),	
	(item_set_slot, "itm_german_revolver", slot_item_velocity, 670),
	(item_set_slot, "itm_german_c96", slot_item_velocity, 425),
	(item_set_slot, "itm_german_luger", slot_item_velocity, 365),
	(item_set_slot, "itm_german_arty_luger", slot_item_velocity, 365),
	#zombie failure rate declaration # 100,000 = 100%, 1 = 0.001% 100 = .01% etc , removed due to Rigadoon's decision
	# (item_set_slot, "itm_frenchlebelrifle", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_frenchlebelrifle", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_frenchlebelrifle_b", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_germangewehr98", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_germangewehr98_sniper", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_germangewehr98_b", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_germank98az", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_germank98az_sniper", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_germank98az_b", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_french_chauchat", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_german_mg08", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_french_revolver", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_french_ruby", slot_item_failure_rate, 0),	
	# (item_set_slot, "itm_german_revolver", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_assault_rifle", slot_item_failure_rate, 0),
	# (item_set_slot, "itm_sniper_rifle", slot_item_failure_rate, 0),
	#zombie failure switch item declaration
    (item_set_slot, "itm_britishtrenchgun", slot_item_particle_sys_1, "itm_britishtrenchgun_melee"),
    (item_set_slot, "itm_british_webley", slot_item_particle_sys_1, "itm_british_webley_melee"),
    (item_set_slot, "itm_britishsmle", slot_item_particle_sys_1, "itm_britishsmlemelee"),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_particle_sys_1, "itm_britishsmle_snipermelee"),
	(item_set_slot, "itm_british_lewis", slot_item_particle_sys_1, "itm_british_lewis_melee"),
    (item_set_slot, "itm_frenchautorifle", slot_item_particle_sys_1, "itm_frenchautoriflemelee"),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_particle_sys_1, "itm_frenchlebelriflemelee"),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_particle_sys_1, "itm_frenchlebelrifle_sniper_melee"),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_particle_sys_1, "itm_frenchlebelriflemelee_b"),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_particle_sys_1, "itm_french_berthier_carbine_melee"),
	(item_set_slot, "itm_germangewehr98", slot_item_particle_sys_1, "itm_germangewehr98melee"),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_particle_sys_1, "itm_germangewehr98_sniper_melee"),
	(item_set_slot, "itm_germangewehr98_b", slot_item_particle_sys_1, "itm_germangewehr98melee_b"),
	(item_set_slot, "itm_germank98az", slot_item_particle_sys_1, "itm_germank98azmelee"),
	(item_set_slot, "itm_germank98az_sniper", slot_item_particle_sys_1, "itm_germank98az_sniper_melee"),
	(item_set_slot, "itm_germank98az_b", slot_item_particle_sys_1, "itm_germank98azmelee_b"),
	(item_set_slot, "itm_french_chauchat", slot_item_particle_sys_1, "itm_french_chauchat_melee"),
	(item_set_slot, "itm_german_mg08", slot_item_particle_sys_1, "itm_german_mg08_melee"),
	(item_set_slot, "itm_french_revolver", slot_item_particle_sys_1, "itm_french_revolver_melee"), 
	(item_set_slot, "itm_french_m73_revolver", slot_item_particle_sys_1, "itm_french_revolver_melee"), 
	(item_set_slot, "itm_french_ruby", slot_item_particle_sys_1, "itm_french_ruby_melee"), 
	(item_set_slot, "itm_german_revolver", slot_item_particle_sys_1, "itm_german_revolver_melee"),
	(item_set_slot, "itm_german_c96", slot_item_particle_sys_1, "itm_german_c96_melee"),
	(item_set_slot, "itm_german_arty_luger", slot_item_particle_sys_1, "itm_german_arty_luger_melee"),
	#zombie shotgun declaration 1 = shotgun
    (item_set_slot, "itm_britishtrenchgun", slot_item_is_shotgun, 1),
    (item_set_slot, "itm_britishsmle", slot_item_is_shotgun, 0),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_is_shotgun, 0),
	(item_set_slot, "itm_frenchautorifle", slot_item_is_shotgun, 0),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_is_shotgun, 0),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_is_shotgun, 0),
	(item_set_slot, "itm_germangewehr98", slot_item_is_shotgun, 0),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_is_shotgun, 0),
	(item_set_slot, "itm_germank98az", slot_item_is_shotgun, 0),
	(item_set_slot, "itm_germank98az_sniper", slot_item_is_shotgun, 0),

	#zombie shotgun pellet declaration
    (item_set_slot, "itm_britishtrenchgun", slot_item_shotgun_pellets, 20),
    (item_set_slot, "itm_britishsmle", slot_item_shotgun_pellets, 0),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_shotgun_pellets, 0),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_shotgun_pellets, 0),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_shotgun_pellets, 0),	
	(item_set_slot, "itm_germangewehr98", slot_item_shotgun_pellets, 0),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_shotgun_pellets, 0),
	(item_set_slot, "itm_germank98az", slot_item_shotgun_pellets, 0),
	(item_set_slot, "itm_germank98az_sniper", slot_item_shotgun_pellets, 0),

	#zombie movement accuracy penalty declaration... added onto the accuracy
    (item_set_slot, "itm_britishtrenchgun", slot_item_walk_penalty, 300),
	(item_set_slot, "itm_british_webley", slot_item_walk_penalty, 200),
    (item_set_slot, "itm_britishsmle", slot_item_walk_penalty, 500),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_walk_penalty, 1200),
    (item_set_slot, "itm_british_lewis", slot_item_walk_penalty, 1000),
	(item_set_slot, "itm_frenchautorifle", slot_item_walk_penalty, 600),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_walk_penalty, 500),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_walk_penalty, 1200),	
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_walk_penalty, 1500),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_walk_penalty, 1500),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_walk_penalty, 600),
	(item_set_slot, "itm_germangewehr98", slot_item_walk_penalty, 500),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_walk_penalty, 1250),
	(item_set_slot, "itm_germangewehr98_b", slot_item_walk_penalty, 1500),
	(item_set_slot, "itm_germank98az", slot_item_walk_penalty, 500),
	(item_set_slot, "itm_germank98az_sniper", slot_item_walk_penalty, 1100),
	(item_set_slot, "itm_germank98az_b", slot_item_walk_penalty, 1500),
	(item_set_slot, "itm_french_chauchat", slot_item_walk_penalty, 1000),
	(item_set_slot, "itm_german_mg08", slot_item_walk_penalty, 1300),
	(item_set_slot, "itm_assault_rifle", slot_item_walk_penalty, 200),
	(item_set_slot, "itm_french_revolver", slot_item_walk_penalty, 200),
	(item_set_slot, "itm_french_m73_revolver", slot_item_walk_penalty, 200),
	(item_set_slot, "itm_french_ruby", slot_item_walk_penalty, 150),	
	(item_set_slot, "itm_german_revolver", slot_item_walk_penalty, 200),
	(item_set_slot, "itm_german_c96", slot_item_walk_penalty, 200),
	(item_set_slot, "itm_german_luger", slot_item_walk_penalty, 200),
	(item_set_slot, "itm_german_arty_luger", slot_item_walk_penalty, 200),
	# (item_set_slot, "itm_frenchlebelrifle", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_walk_penalty, 0),	
	# (item_set_slot, "itm_frenchlebelrifle_b", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_germangewehr98", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_germangewehr98_sniper", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_germangewehr98_b", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_germank98az", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_germank98az_sniper", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_germank98az_b", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_french_chauchat", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_german_mg08", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_assault_rifle", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_french_revolver", slot_item_walk_penalty, 0),
	# (item_set_slot, "itm_french_ruby", slot_item_walk_penalty, 0),	
	# (item_set_slot, "itm_german_revolver", slot_item_walk_penalty, 0),
	
	#zombie magnification declaration.. UNKNOWN unit, do NOT GO OVER 200!!!
	(item_set_slot, "itm_britishtrenchgun", slot_item_magnification, 200),
	(item_set_slot, "itm_british_webley", slot_item_magnification, 200),
    (item_set_slot, "itm_britishsmle", slot_item_magnification, 200),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_magnification, 200),
    (item_set_slot, "itm_british_lewis", slot_item_magnification, 200),
	(item_set_slot, "itm_frenchautorifle", slot_item_magnification, 200),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_magnification, 200),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_magnification, 200),	
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_magnification, 200),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_magnification, 200),
	(item_set_slot, "itm_french_berthier_carbine", slot_item_magnification, 200),
	(item_set_slot, "itm_germangewehr98", slot_item_magnification, 200),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_magnification, 200),
	(item_set_slot, "itm_germangewehr98_b", slot_item_magnification, 200),
	(item_set_slot, "itm_germank98az", slot_item_magnification, 200),
	(item_set_slot, "itm_germank98az_sniper", slot_item_magnification, 200),
	(item_set_slot, "itm_germank98az_b", slot_item_magnification, 200),
	(item_set_slot, "itm_french_chauchat", slot_item_magnification, 200),
	(item_set_slot, "itm_german_mg08", slot_item_magnification, 200),
	(item_set_slot, "itm_assault_rifle", slot_item_magnification, 200),
	(item_set_slot, "itm_french_revolver", slot_item_magnification, 200),
	(item_set_slot, "itm_french_m73_revolver", slot_item_magnification, 200),
	(item_set_slot, "itm_french_ruby", slot_item_magnification, 200),
	(item_set_slot, "itm_german_revolver", slot_item_magnification, 200),
	(item_set_slot, "itm_german_c96", slot_item_magnification, 200),
	(item_set_slot, "itm_german_luger", slot_item_magnification, 200),
	(item_set_slot, "itm_german_arty_luger", slot_item_magnification, 200),
	#zombie has attachment declaration 0 = nothing, 1 = french bayonet, 3 = german standard bayonet, 4 = german grabendoch 5 = grenade launcher
    (item_set_slot, "itm_britishsmle", slot_item_has_attachment, 3),
    (item_set_slot, "itm_britishsmle_sniper", slot_item_has_attachment, 0),
	(item_set_slot, "itm_frenchautorifle", slot_item_has_attachment, 0),
	(item_set_slot, "itm_frenchlebelrifle", slot_item_has_attachment, 0),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_has_attachment, 1),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher", slot_item_has_attachment, 5),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_has_attachment, 0),
	(item_set_slot, "itm_germangewehr98", slot_item_has_attachment, 0),
	(item_set_slot, "itm_germangewehr98_b", slot_item_has_attachment, 3),
	(item_set_slot, "itm_germank98az", slot_item_has_attachment, 0),
	(item_set_slot, "itm_germank98az_b", slot_item_has_attachment, 4),
	
	#enhanced by danyele: melee mode for avoiding invalid items to be spawned when fixing bayonets. 1 = melee mode
    (item_set_slot, "itm_britishsmlemelee", slot_item_in_melee_mode, 1),
    (item_set_slot, "itm_britishsmle_snipermelee", slot_item_in_melee_mode, 1),
	(item_set_slot, "itm_frenchautoriflemelee", slot_item_in_melee_mode, 1),
	(item_set_slot, "itm_frenchlebelriflemelee", slot_item_in_melee_mode, 1),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded_melee", slot_item_in_melee_mode, 1),
	(item_set_slot, "itm_germangewehr98melee", slot_item_in_melee_mode, 1),
	(item_set_slot, "itm_germank98azmelee", slot_item_in_melee_mode, 1),
	(item_set_slot, "itm_frenchlebelriflemelee_b", slot_item_in_melee_mode, 1),
	(item_set_slot, "itm_germank98azmelee_b", slot_item_in_melee_mode, 1),
	(item_set_slot, "itm_germangewehr98melee_b", slot_item_in_melee_mode, 1),

	#recoded by danyele - zombieattachments declaration 1 = french bayonet and rifle grenade, 2 = german bayonets, only for guns that dont have attachments
	(item_set_slot, "itm_frenchlebelrifle", slot_item_compatible_attachments, 1),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_compatible_attachments, 1),
	(item_set_slot, "itm_germangewehr98", slot_item_compatible_attachments, 2),
	(item_set_slot, "itm_germank98az", slot_item_compatible_attachments, 2),
	

	#zombie unattached declaration
	(item_set_slot, "itm_frenchlebelrifle", slot_item_unattached, "itm_frenchlebelrifle"),
	(item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_unattached, "itm_frenchlebelrifle"),
	(item_set_slot, "itm_frenchlebelrifle_b", slot_item_unattached, "itm_frenchlebelrifle"),
	(item_set_slot, "itm_frenchlebelrifle_grenadelauncher", slot_item_unattached, "itm_frenchlebelrifle_grenadelauncher_unloaded"),
	(item_set_slot, "itm_germangewehr98", slot_item_unattached, "itm_germangewehr98"),
	(item_set_slot, "itm_germangewehr98_sniper", slot_item_unattached, "itm_germangewehr98"),
	(item_set_slot, "itm_germangewehr98_b", slot_item_unattached, "itm_germangewehr98"),
	(item_set_slot, "itm_germank98az", slot_item_unattached, "itm_germank98az"),
	(item_set_slot, "itm_germank98az_sniper", slot_item_unattached, "itm_germank98az"),
	(item_set_slot, "itm_germank98az_b", slot_item_unattached, "itm_germank98az"),
	#(item_set_slot, "itm_french_chauchat", slot_item_unattached, "itm_french_chauchat"),
	#(item_set_slot, "itm_german_mg08", slot_item_unattached, "itm_german_mg08"),

	#zombie scope declaration 0 = no scope 1 = scoped. Removed attachable scopes due to rigadoon's decision 
	# (item_set_slot, "itm_frenchlebelrifle", slot_item_scope, "itm_frenchlebelrifle_sniper"),
	# (item_set_slot, "itm_frenchlebelrifle_sniper", slot_item_scope, 1), 
	# (item_set_slot, "itm_germangewehr98", slot_item_scope, "itm_germangewehr98_sniper"),
	# (item_set_slot, "itm_germangewehr98_sniper", slot_item_scope, 1), 
	# (item_set_slot, "itm_germank98az", slot_item_scope, "itm_germank98az_sniper"),
	# (item_set_slot, "itm_germank98az_sniper", slot_item_scope, 1),
	
	#grenade launcher declarations 0 = no grenade launcher 1 = grenade launched
	 (item_set_slot, "itm_frenchlebelrifle_grenadelauncher_unloaded", slot_item_grenade_launcher, "itm_frenchlebelrifle_grenadelauncher"),
	 (item_set_slot, "itm_frenchlebelrifle_grenadelauncher", slot_item_grenade_launcher, 1), 
	


	#zombie bayonet declaration
	(item_set_slot, "itm_frenchlebelrifle", slot_item_bayonet, "itm_frenchlebelrifle_b"),
	(item_set_slot, "itm_germangewehr98", slot_item_bayonet, "itm_germangewehr98_b"),
	(item_set_slot, "itm_germank98az", slot_item_bayonet, "itm_germank98az_b"),

	#zombie muzzle effects
	#particle system 1 - fires off 6 particles
#	(item_set_slot, "itm_frenchlebelrifle", slot_item_particle_sys_1, "psys_gunfire_haze"),

	#particle system 2 - fires off 40 particles
#	(item_set_slot, "itm_frenchlebelrifle", slot_item_particle_sys_2, "psys_gunfire_smoke"),

	#movement x (left/right)
#	(item_set_slot, "itm_frenchlebelrifle", slot_item_part_move_x, 10),

	#movement y (forward/backward - approx gun length + 73 for pistols, gun length + 40 for rifles)
#	(item_set_slot, "itm_frenchlebelrifle", slot_item_part_move_y, 85),

	#movement z (up/down)
#	(item_set_slot, "itm_frenchlebelrifle", slot_item_part_move_z, 160),

	#(display_message,"@End initialization"),

	])
	
#Client sided - check if right click, left click, or C is clicked, send the correct cues to the server which then processes the information and distributes it to clients.#

# multiplayer_ie_attack_key_pressed = (0, 0, 0, [
    ...
    # (neg|is_presentation_active, "prsnt_ammobox_menu"),
    # (neg|is_presentation_active, "prsnt_ammobox_menu_closed"),
    # (neg|is_presentation_active, "prsnt_mg_ammobox_menu"),
    # (neg|is_presentation_active, "prsnt_mg_ammobox_menu_closed"),
...
# [
	...
	# (agent_get_animation, ":anim_upper", ":agent_no",1),
	# (agent_get_animation, ":anim_lower", ":agent_no",0),
  ...
  #Left click handling
    ...
    # (try_begin),
      # (eq, ":item_id", "itm_german_mg08"),
      
      # (neq, ":anim_lower", "anim_stand_to_crouch"),	
      # (display_message, "@You can only fire this Light Machinegun while crouching",0xFF0000),
    # (else_try),
      # (item_get_slot,":aim_anim", ":item_id", slot_item_aim_anim),  
      # (this_or_next|eq,":anim_upper",":aim_anim"),
      # (eq,":anim_upper","anim_aim_standing_lmg"),
      
      # (neq, ":anim_lower", "anim_unfix_bayonet"),
      # (neq, ":anim_lower", "anim_jump"),
      # (neq, ":anim_lower", "anim_jump_loop"),
      # (neq, ":anim_lower", "anim_jump_end_hard"),
      # (neq, ":anim_upper", "anim_unfix_bayonet"),
      # (neq, ":anim_upper", "anim_fix_grenade"),
      # (neq, ":anim_lower", "anim_fix_grenade"),
      # (neq, ":anim_upper", "anim_fix_bayonet"),
      # (neq, ":anim_lower", "anim_fix_bayonet"),
      
      # (multiplayer_send_2_int_to_server,multiplayer_event_zombie,1,":player_no"), #reports left click & player number to server for processing
    # (try_end),
  # (try_end),

	# ])

# multiplayer_ie_defend_key_check = (0, 0, 0, [
...
#Right click handling
    ...
    # (try_begin),
      # (eq, ":item_id", "itm_german_mg08"),
      # (neq, ":anim_lower", "anim_stand_to_crouch"),	
      # (display_message, "@You can only aim with this Light Machinegun while crouching",0xFF0000),
    # (else_try),
		  # (multiplayer_send_2_int_to_server,multiplayer_event_zombie,2,":player_no"), #reports right click & player number to server for processing
    # (try_end),
	# ])
	
# multiplayer_ie_quests_window_check = (0, 0, 0, [
	# (neg|is_presentation_active, "prsnt_multiplayer_escape_menu"),
    # (neg|is_presentation_active, "prsnt_game_multiplayer_admin_panel"),
    # (neg|is_presentation_active, "prsnt_multiplayer_admin_chat"),
	# (neg|is_presentation_active, "prsnt_ammobox_menu"),
...
# [
    ...
    # (try_begin),
      # (neq, ":item_id", -1),
      # (item_get_slot, ":guntype", ":item_id", slot_item_guntype),
      
      # (try_begin),
        # (eq, ":guntype", 1), #if it's a pistol
        # (agent_get_slot,":pistol_count", ":agent_no", slot_agent_backpack_pistol_ammo),
        # (eq, ":pistol_count",0),
        # (display_message, "@You run out of pistol magazines",0xFFFFFF),
        # (assign, ":errored",1),
      # (else_try),
        # (neq, ":guntype", 1), #if it's not a pistol
        # (agent_get_slot,":rifle_count", ":agent_no", slot_agent_backpack_rifle_ammo),
        # (eq, ":rifle_count",0),
        # (display_message, "@You run out of rifle magazines",0xFFFFFF),
        # (assign, ":errored",1),
      # (try_end),
    # (try_end),
    ...
    # (neq, ":anim_lower", "anim_unfix_bayonet"),#if you aren't fixing a bayonet or a scope attachment, nor if you aren't jumping
    # (neq, ":anim_lower", "anim_jump"),
    # (neq, ":anim_lower", "anim_jump_loop"),
    # (neq, ":anim_lower", "anim_jump_end_hard"),
    # (neq, ":anim_upper", "anim_unfix_bayonet"),
    # (neq, ":anim_upper", "anim_fix_bayonet"),
    # (neq, ":anim_lower", "anim_fix_bayonet"),
    # (neq, ":anim_upper", "anim_"),
    # (neq, ":anim_upper", "anim_fix_grenade"),
    # (neq, ":anim_lower", "anim_fix_grenade"),
    # (neq, ":anim_lower", "anim_"),
    # (multiplayer_send_2_int_to_server,multiplayer_event_zombie,3,":player_no"), #reports q button & player number to server for processing
  # (try_end),

# ])

# multiplayer_ie_party_window_check = (0, 0, 0, [
	# (neg|is_presentation_active, "prsnt_multiplayer_escape_menu"),
    # (neg|is_presentation_active, "prsnt_game_multiplayer_admin_panel"),
    # (neg|is_presentation_active, "prsnt_multiplayer_admin_chat"),
	# (neg|is_presentation_active, "prsnt_ammobox_menu"),
...
# [
	 # (try_begin), 
		...
		# (neq, ":anim_lower", "anim_fix_grenade"),
		# (neq, ":anim_lower", "anim_"),
		# (multiplayer_send_2_int_to_server,multiplayer_event_zombie,13,":player_no"), #reports c & player number to server for processing
	# (try_end),
...
multiplayer_ie_keys_check = (0, 0, 0, 
  [
  ...
  # Left click handling
	(try_begin), 
    (game_key_clicked,gk_attack), #left mouse button, single click
    (neq, ":item_id", -1),
    
    (neg|item_slot_eq, ":item_id", slot_item_guntype, 0), # empty slot means no gun..
    ...
    (try_begin),
      (this_or_next|eq, ":item_id", "itm_german_mg08"),
      (eq, ":item_id", "itm_frenchlebelrifle_grenadelauncher"),
      
      (neq, ":anim_lower", "anim_stand_to_crouch"),	
      (display_message, "@You can only fire this weapon while crouching",0xFF0000),
    (else_try),
	  (neq, ":item_id", -1),
      (item_get_slot,":aim_anim", ":item_id", slot_item_aim_anim),  
      (this_or_next|eq,":anim_upper",":aim_anim"),
  ...
  # Right click handling
    ...
    (try_begin),
      ...
      (eq, ":item_id", "itm_frenchlebelrifle_grenadelauncher"),
      (neq, ":anim_lower", "anim_stand_to_crouch"),	
      (display_message, "@You can only aim with this weapon while crouching",0xFF0000),
    (else_try),
		  (multiplayer_send_2_int_to_server,multiplayer_event_zombie,2,":player_no"), #reports right click & player number to server for processing
    (try_end),
  (try_end),
  ...
  # handle Bayonet thing
  (try_begin), 
    (game_key_clicked,gk_party_window), #if you aren't fixing a bayonet or a scope attachment, nor if you aren't jumping
    (neq, ":anim_lower", "anim_unfix_bayonet"),
    (neq, ":anim_lower", "anim_jump"),
    (neq, ":anim_lower", "anim_jump_loop"),
    (neq, ":anim_lower", "anim_jump_end_hard"),
...
multiplayer_ie_keys_check_hold = (0.2, 0, 0, 
  [
    (game_key_is_down,gk_quests_window),
  ],
	[
    # Handle reload
...
#Client sided - check if full auto, send to server if held down#
multiplayer_ie_automatic_weapon_check = (0.05, 0, 0, [
      (game_key_is_down,gk_attack), #left mouse button, held
      ],
  [
  (try_begin),
    (multiplayer_get_my_player,":player_no"),
    ...
    (agent_is_active, ":agent_no"),
    (agent_is_alive,":agent_no"),
    (agent_get_wielded_item,":item_id",":agent_no"), #what are you carrying currently?
    (neq,":item_id",-1),
    (item_slot_eq, ":item_id", slot_item_automatic, 1),
    
    (agent_get_animation, ":anim_upper", ":agent_no",1),
    (agent_get_animation, ":anim_lower", ":agent_no",0),
    
    (try_begin), #let's see what keys are down...
      (eq, ":item_id", "itm_german_mg08"),
      
      (this_or_next|eq, ":anim_upper", "anim_aim_lmg_german"),
      (this_or_next|eq, ":anim_upper", "anim_clear_anim"),
      (eq, ":anim_upper", "anim_reload_lmg"),
      
      (neq, ":anim_lower", "anim_stand_to_crouch"),
      
      #(display_message, "@You can only fire a Light Machinegun while crouching",0xFF0000),
    (else_try),
      (this_or_next|eq, ":item_id", "itm_german_mg08"),
      (eq, ":item_id", "itm_frenchlebelrifle_grenadelauncher"),
      (eq, ":anim_lower", "anim_stand_to_crouch"),
	  (neg|is_presentation_active, "prsnt_multiplayer_escape_menu"),
	  (neg|is_presentation_active, "prsnt_game_multiplayer_admin_panel"),
	  (neg|is_presentation_active, "prsnt_multiplayer_admin_chat"),
      (neg|is_presentation_active, "prsnt_ammobox_menu"),
      ...
      (neg|is_presentation_active, "prsnt_multiplayer_team_select"),
      (neg|is_presentation_active, "prsnt_multiplayer_item_select"),
      #(display_message, "@The second condition is being verified, permission to fire granted"),
      (multiplayer_send_2_int_to_server,multiplayer_event_zombie,1,":player_no"), #reports left click & player number to server for processing
    (else_try), 
      (neq, ":item_id", "itm_german_mg08"),
      (neq, ":item_id", "itm_frenchlebelrifle_grenadelauncher"),
	  (neg|is_presentation_active, "prsnt_multiplayer_escape_menu"),
	  (neg|is_presentation_active, "prsnt_game_multiplayer_admin_panel"),
	  (neg|is_presentation_active, "prsnt_multiplayer_admin_chat"),
      (neg|is_presentation_active, "prsnt_ammobox_menu"),
      ...
      (neq, ":anim_upper", "anim_fix_grenade"),
      (neq, ":anim_lower", "anim_fix_grenade"),
      #(display_message, "@The third condition is being verified, you're not wielding a MG08"),
      (multiplayer_send_2_int_to_server,multiplayer_event_zombie,1,":player_no"), #reports left click & player number to server for processing
    (try_end),
  (try_end),
	])

	#Client sided - check if holding automatic weapon with fire button held down, else send to server to reduce recoil by 1#
# multiplayer_ie_automatic_weapon_recoil = (0.25, 0, 0, [],
	# [
  # (try_begin),
    # (multiplayer_get_my_player,":player_no"),
    # (player_is_active, ":player_no"),
    ...
    # (agent_is_active, ":agent_no"),
    # (agent_is_alive,":agent_no"),
    # (agent_get_wielded_item,":weapon",":agent_no"), #what are you carrying currently?
    # (neq,":weapon",-1),
    # (item_slot_eq, ":weapon", slot_item_automatic, 1),#is it auto?
    # (neg|game_key_is_down,gk_attack), # and not holding button
    # (multiplayer_send_2_int_to_server,multiplayer_event_zombie,11,":agent_no"), # Send the reduce
  # (try_end),
	# ])
multiplayer_client_ie_artillery_arrow_show = (
  0.05, 0, 0.03, [
	  ...
	  (try_begin), 
		...
		(agent_is_alive,":agent_id"), #Tipical checks to make sure agent is alive when holding Q
		(agent_get_troop_id, ":troop_id", ":agent_id"),
	 
	  
	  (agent_get_wielded_item, ":item_id", ":agent_id"),
	  (this_or_next|eq, ":item_id", "itm_german_spyglass"),  #If the agent is wielding binoculars
      (this_or_next|eq, ":item_id", "itm_french_spyglass"),
	  (eq, ":item_id", "itm_french_working_spyglass"),
	  
	  (this_or_next|is_presentation_active, "prsnt_spyglass_french_dummy"),
      (this_or_next|is_presentation_active, "prsnt_spyglass_british_dummy"),
	  (is_presentation_active, "prsnt_spyglass_german_dummy"), #If the agent is using his binoculars
	  
	 (game_key_is_down, gk_attack),
	 (try_begin),
		(this_or_next|eq, ":troop_id", "trp_germanStandardInfantry_officer"), #Ze Germans
		(this_or_next|eq, ":troop_id", "trp_germanstormtrooper_officer"),
		(this_or_next|eq, ":troop_id", "trp_german_sentry"),
		(this_or_next|eq, ":troop_id", "trp_prussian_blucher"),
		(this_or_next|eq, ":troop_id", "trp_prussian_arty_officer"),
		(this_or_next|eq, ":troop_id", "trp_frenchStandardInfantry_officer"), #Le french
		(this_or_next|eq, ":troop_id", "trp_french_arty_officer"),
		(this_or_next|eq, ":troop_id", "trp_french_sentry"),
		(this_or_next|eq, ":troop_id", "trp_napoleon"), 
		(this_or_next|eq, ":troop_id", "trp_britishStandardInfantry_nco"), #Brits
		#(this_or_next|eq, ":troop_id", "trp_britishBomber_officer"),
		(this_or_next|eq, ":troop_id", "trp_british_sentry"),
		(this_or_next|eq, ":troop_id", "trp_wellington"),
		(eq, ":troop_id", "trp_british_arty_nco"),
	  ...
	  (else_try),
		(multiplayer_send_int_to_player, ":player_no", multiplayer_event_zombieclient, 42),
	  (try_end),
	  ...
	  (try_begin),
		 ...
		 # (neg|game_key_is_down, gk_attack),
		  ...
		  (position_get_x, ":x_position", pos43),
		  (assign, reg1, ":x_position"),
		  
		  (position_get_y, ":y_position", pos43),
		  (assign, reg2, ":y_position"),
		  
		  (position_get_z, ":z_position", pos43),
		  (assign, reg3, ":z_position"),
		 
		 
			  (display_message, "@Artillery target marked at X: {reg1} . Y:  {reg2} . Z:  {reg3}"),
		  
		  (assign, "$g_art_coordinates_x_position", ":x_position"),
		  (assign, "$g_art_coordinates_y_position", ":y_position"),
		  (assign, "$g_art_coordinates_z_position", ":z_position"),
...
multiplayer_server_ie_splash_artillery = (2, 0, 1, [ (multiplayer_is_server),
	(try_begin),
		(eq, "$g_artillery_incoming_splash", 1),
		
		(assign, "$g_artillery_incoming_splash", 2),
		(display_message, "@1 cond is true"),
	(else_try),
		(eq, "$g_artillery_incoming_splash", 2),
	
		(assign, "$g_artillery_incoming_splash", 3),
		(display_message, "@2 cond is true"),
	(else_try),
		(eq, "$g_artillery_incoming_splash", 3),
	
		(assign, "$g_artillery_incoming_splash", 4),
		(display_message, "@3 cond is true"),
	(else_try),
		(eq, "$g_artillery_incoming_splash", 4),
		
		(assign, "$g_artillery_incoming_splash", 5),
		(display_message, "@4 cond is true"),
	(else_try),
		(eq, "$g_artillery_incoming_splash", 5),
		
		(assign, "$g_artillery_incoming_splash", 6),
		(display_message, "@5 cond is true"),
		
	(else_try),
		(eq, "$g_artillery_incoming_splash", 6),
		(assign, "$g_artillery_incoming_splash", 7),
		(display_message, "@6 cond is true"),
	...
	[
	(try_begin),
		#trigger explosion in a specific range

		(this_or_next|eq,"$g_artillery_incoming_splash", 1),
		(this_or_next|eq,"$g_artillery_incoming_splash", 2),
		(this_or_next|eq,"$g_artillery_incoming_splash", 3),
		(this_or_next|eq,"$g_artillery_incoming_splash", 4),
		(this_or_next|eq,"$g_artillery_incoming_splash", 5),
		(eq,"$g_artillery_incoming_splash", 6),
		
		(store_add, ":x_upper", "$g_art_coordinates_x_position", 701),
		(store_sub, ":x_lower", "$g_art_coordinates_x_position", 701),
		
		(store_add, ":y_upper", "$g_art_coordinates_y_position", 701),
		(store_sub, ":y_lower", "$g_art_coordinates_y_position", 701),
				
		(store_random_in_range, ":art_x", ":x_lower", ":x_upper"),
		(store_random_in_range, ":art_y", ":y_lower", ":y_upper"),
		
		(position_set_x, pos47,":art_x"),
		(position_set_y, pos47,":art_y"),

		(position_set_z, pos47,"$g_art_coordinates_z_position"),
		
		(assign, ":agent_id", "$g_artillery_general_agent_caller"),
		(agent_is_active, ":agent_id"),
		
		(call_script, "script_explosion_at_position", "$g_artillery_general_agent_caller", 500, 500),
		
	(try_end),

	])

#Server sided - cycle through all players, see if they should be aiming, and play the aim animation.#
multiplayer_ie_aiming_template = (0.1, 0, 0, [(multiplayer_is_server), #this only runs server-side
],
	[
	(try_for_range,":cur_player",0,multiplayer_player_loops_end), #cycle through players
		(player_is_active,":cur_player"), #the player is actually present in the game
		(player_get_agent_id,":agent_no",":cur_player"),
		(agent_is_active, ":agent_no"),
		(agent_is_alive,":agent_no"),
    (agent_slot_eq, ":agent_no", slot_agent_aiming, 1),#is the agent supposed to be aiming? #yes, not bipod-mounted
		(try_begin),
      (agent_get_wielded_item,":weapon",":agent_no"), #what are you carrying currently?
		  (neq,":weapon",-1),
			(try_begin), #playing different animations for different gun types
        (item_get_slot,":guntype",":weapon",slot_item_guntype), #what type of weapon is it?
				(this_or_next|eq,":guntype",0), #if guntype is invalid then turn off aiming
				(gt,":guntype",8),
				(agent_set_slot,":agent_no",slot_agent_aiming,0),
				(agent_set_animation,":agent_no","anim_clear_anim",1), #clear the anim
		  (else_try),
				(item_get_slot,":aim_anim", ":weapon", slot_item_aim_anim),
				(agent_get_animation, ":anim_upper", ":agent_no", 1),
				(agent_get_animation, ":anim_lower", ":agent_no", 0),
				(try_begin),
                    (this_or_next|eq, ":weapon", "itm_british_lewis"),
                    (eq, ":weapon", "itm_french_chauchat"),
					(neq, ":anim_lower", "anim_stand_to_crouch"),
          (try_begin),
            (neq,":anim_upper","anim_aim_standing_lmg"), # set it if its not already there.
            (agent_set_animation,":agent_no","anim_aim_standing_lmg",1), #different anim for aiming
          (try_end),
				(else_try),
					(this_or_next|eq, ":weapon", "itm_german_mg08"),
					(eq, ":weapon", "itm_frenchlebelrifle_grenadelauncher"),
					(this_or_next|eq, ":anim_upper", "anim_aim_lmg_german"),
					(eq, ":anim_upper", "anim_reload_lmg"),
					(neq, ":anim_lower", "anim_stand_to_crouch"),
					(agent_set_animation, ":agent_no", "anim_clear_anim", 1),
					(agent_set_slot,":agent_no",slot_agent_aiming,0), #dont aim
				(else_try),
          (neq,":anim_upper",":aim_anim"), # set it if its not already there.
					(agent_set_animation,":agent_no",":aim_anim",1), #aim
				(try_end),	
			(try_end),
		(try_end),
	(try_end),
	...
	#Server sided - cycle through all players, reduce attachment remove timer by 1 if necessary#
multiplayer_ie_attachment_timer = (1, 0, 0, [(multiplayer_is_server),],
	[ #this only runs server-side
	
	#(get_max_players,multiplayer_player_loops_end),
	(try_for_range,":cur_player",0,multiplayer_player_loops_end), #cycle through players
		(player_is_active,":cur_player"), #the player is actually present in the game
		(player_get_agent_id,":agent_no",":cur_player"),
		(agent_is_active, ":agent_no"),
    (agent_get_slot,":timer",":agent_no",slot_agent_remove_attachment_timer),
    (try_begin),
      (eq,":timer",0),
      (assign,":timer",-2),
      (agent_set_slot,":agent_no", slot_agent_remove_attachment_timer, -2), #apply it			
    (try_end),
    (set_fixed_point_multiplier,1000),
    (agent_get_speed,pos2,":agent_no"),
    ...
    (try_begin),
      ...
      (neq,":y",0),
      (assign,":timer",-2),
      (multiplayer_send_int_to_player,":cur_player",multiplayer_event_zombieclient,7,":timer"),
      (agent_set_slot,":agent_no", slot_agent_remove_attachment_timer, ":timer"), #apply it			
    (try_end),
    (try_begin),
      (gt,":timer",0),
      (val_sub,":timer",1),
      (multiplayer_send_2_int_to_player,":cur_player",multiplayer_event_zombieclient,6,":timer"),
      (try_begin),
        (eq,":timer",1),
        (assign,":timer",-1),
      (try_end),
      ...
      (agent_get_wielded_item,":weapon",":agent_no"), #what are you carrying currently?
      (neq, ":weapon", -1),
      (item_get_slot,":has_attachment",":weapon",slot_item_has_attachment),
      (this_or_next|eq,":has_attachment",1),
      (this_or_next|eq,":has_attachment",4),
     # (this_or_next|eq,":has_attachment",2),
      (eq,":has_attachment",3),
      (item_get_slot,":unattached_vers",":weapon",slot_item_unattached),
      (item_get_slot,":scope_vers",":unattached_vers",slot_item_scope),
      (item_get_slot,":sight_vers",":unattached_vers",slot_item_bayonet),
      (this_or_next|eq,":weapon",":scope_vers"),
      (eq,":weapon", ":sight_vers"),
      (try_for_range,":slot",0,4), #begin getting ammo in gun
        (agent_get_item_slot,":item",":agent_no",":slot"),
        (eq,":item",":weapon"),
        (agent_get_ammo_for_slot,":ammo",":agent_no",":slot"),
      (try_end), #end getting ammo in gun
      (agent_unequip_item,":agent_no",":weapon"),
      (agent_equip_item,":agent_no",":unattached_vers"),
      (agent_set_wielded_item,":agent_no",":unattached_vers"),
      (agent_set_ammo,":agent_no",":unattached_vers",":ammo"),
      # (try_begin),
        # (eq,":weapon",":scope_vers"),
        # (assign,":scope",1),
          # (else_try),
        # (eq,":weapon",":sight_vers"),
        # (assign,":scope",2),
      ...
      (try_begin), #Removed them scopes due to rigadoon's decision...
        (eq,":has_attachment",1),
        (agent_get_position,pos1,":agent_no"),
        (copy_position,pos56,pos1),
        (call_script,"script_multiplayer_server_play_sound_at_position","snd_ie_unfix_bayonet"),
		(agent_set_animation,":agent_no","anim_unfix_bayonet", 1),
	    (agent_set_animation,":agent_no","anim_unfix_bayonet", 0),
        (agent_equip_item, ":agent_no", "itm_french_lebel_bayonet"),
	  (else_try),
		(eq,":has_attachment",3),
        (agent_get_position,pos1,":agent_no"),
        (copy_position,pos56,pos1),
		...
		(agent_set_animation,":agent_no","anim_unfix_bayonet", 1),
        (agent_set_animation,":agent_no","anim_unfix_bayonet", 0),
        (agent_equip_item, ":agent_no", "itm_german_gewehr_bayonet"),
	 (else_try),
		(eq,":has_attachment",4),
        (agent_get_position,pos1,":agent_no"),
        (copy_position,pos56,pos1),
		...
		(agent_set_animation,":agent_no","anim_unfix_bayonet", 1),
        (agent_set_animation,":agent_no","anim_unfix_bayonet", 0),
        (agent_equip_item, ":agent_no", "itm_german_k98_bayonet"),
      (try_end),
        (assign,":timer",-2),
        (agent_set_slot,":agent_no", slot_agent_remove_attachment_timer, ":timer"), #apply it			
    (try_end),
...
#Server sided - cycle through all players, walk speedcrap
multiplayer_walk_speed = (0.25, 0, 0, [
	(multiplayer_is_server), #this only runs server-side
  ],
	[
	#(get_max_players,multiplayer_player_loops_end),
	(try_for_range,":cur_player",0,multiplayer_player_loops_end), #cycle through players
  ...
  (try_begin),
    (try_begin),
      ...
      (assign, ":mod_speed", 100),
		  (neg|agent_slot_eq,":agent_no",slot_agent_base_speed_mod,55),
      (try_begin),
				(agent_get_slot,":isAiming",":agent_no",slot_agent_aiming),
      (try_end),
      (try_begin),
        (gt,":isAiming",0),
        (val_sub,":mod_speed",45),
        (agent_set_slot, ":agent_no", slot_agent_cur_speed_modifier, ":mod_speed"),
      (try_end),
			(neg|agent_slot_eq, ":agent_no", slot_agent_cur_speed_modifier, 45),
			(agent_set_speed_modifier, ":agent_no", ":mod_speed"), # value is in percentage, 100 is default, value can be between [0..1000]
  ...
  (try_end),
		...
		# (agent_get_slot,":fire_delay",":agent_no",slot_agent_firedelay), #what's the current fire delay?
		# (agent_get_slot,":rl_delay",":agent_no",slot_agent_reloaddelay), #what's the current fire delay?
		
    # (agent_get_slot,":rc_x",":agent_no",slot_agent_recoil_x), #what's the current fire delay?
		# (agent_get_slot,":rc_y",":agent_no",slot_agent_recoil_y), #what's the current fire delay?
		# (agent_get_slot,":rc_t",":agent_no",slot_agent_recoil_time), #what's the current fire delay?
		
    # (try_begin),
			# (gt,":fire_delay",0), #is it over zero?
			# (val_sub,":fire_delay",1), #lower it by one
			# (agent_set_slot,":agent_no", slot_agent_firedelay, ":fire_delay"), #apply it
		# (try_end),
		# (try_begin),
			# (gt,":rl_delay",0), #is it over zero?
			# (val_sub,":rl_delay",1), #lower it by one
			# (agent_set_slot,":agent_no", slot_agent_reloaddelay, ":rl_delay"), #apply it
		# (try_end),
    
		# (try_begin),
			# (this_or_next|gt,":rc_x",0),
			# (gt,":rc_y",0),
			# (val_add,":rc_t",1),
			# (agent_set_slot,":agent_no", slot_agent_recoil_time, ":rc_t"), #apply it
		# (try_end),
#		(display_message,"@This is happening"),
	(try_end),
	])
	###################
	#FIRING SYSTEM END#
	...
	######################
	#BACKPACK STUFF BEGIN#
	######################
#Client sided - Check to see if you're pressing the backpack button, see what you've got in your hand, do appropriate action#
#Server action 4 = place ammo in backpack
multiplayer_ie_backpack_system = (0, 0, 0, [(game_key_clicked,gk_inventory_window),],
	[
	(multiplayer_get_my_player,":player_no"),
	(player_is_active, ":player_no"),
	(player_get_agent_id,":agent_no",":player_no"),
	(agent_is_active, ":agent_no"),
	(neq,":agent_no",-1), #agent exists
	(agent_is_alive,":agent_no"),
	(try_begin),
		(agent_get_wielded_item,":weapon",":agent_no"), #what are you carrying currently?
		(neq,":weapon",-1),
		(this_or_next|eq,":weapon","itm_bullets"),
		(eq,":weapon","itm_pistol_ammo"),
		(multiplayer_send_3_int_to_server,multiplayer_event_zombie,4,":weapon",":agent_no"),
#			(else_try),
#		(item_get_slot,":medical_value",":weapon",slot_item_medical_value),
#		(gt,":medical_value",0),
#		(multiplayer_send_3_int_to_server,multiplayer_event_zombie,4,":weapon",":agent_no"),
#			(else_try),
#		(start_presentation,"prsnt_zombies_backpack_presentation"),
	(try_end),
	])

	#Server sided - cycle through all players, automagically add ammo to pack#
multiplayer_ie_add_ammo = (1, 0, 0, [
	(multiplayer_is_server), #this only runs server-side
  ],
	[
	(try_for_range,":cur_player",0,multiplayer_player_loops_end), #cycle through players
		...
		(agent_get_wielded_item,":weapon",":agent_no"), #what are you carrying currently?
		(neq,":weapon",-1),
		(try_begin), #begin backpack adding script
			(assign,":combinedammo_pistol",0),
			(assign,":combinedammo_rifle",0),
			#(assign,":combinedmeds",0),
			#(assign,":meds",0),
			#(agent_get_item_slot, ":backpack", ":agent_no", 6), useless
			#(item_get_slot, ":capacity", ":backpack", slot_item_backpack_slots), useless

			(try_for_range,":slot",0,4), #begin looking for ammo
				(agent_get_item_slot,":item",":agent_no",":slot"),
				(try_begin), #pistol ammo
					(eq,":item","itm_pistol_ammo"),
					(agent_get_ammo_for_slot,":magammo",":agent_no",":slot"),
					(neq,":magammo",0),
					(val_add,":combinedammo_pistol",":magammo"),
			    (agent_set_ammo,":agent_no","itm_pistol_ammo",0),
				(try_end), #end pistol ammo
				(try_begin), #rifle ammo
					(eq,":item","itm_bullets"),
					(agent_get_ammo_for_slot,":magammo",":agent_no",":slot"),
					(neq,":magammo",0),
					(val_add,":combinedammo_rifle",":magammo"),
		    	(agent_set_ammo,":agent_no","itm_bullets",0), #end removing ammo-type items
				(try_end), #end rifle ammo
				# (try_begin), #medical supplies
					# (neq,":item",-1),
					# (item_get_slot,":medical_value",":item",slot_item_medical_value),
					# (gt,":medical_value",0),
					# (val_add,":meds",":medical_value"),
					# (store_add,":use_this",":slot",1),
					# (agent_unequip_item,":agent_no",":item",":use_this"),
					# (neq,":meds",0),
					# (val_add,":combinedmeds",":meds"),
					# (assign,":meds",0),
				# (try_end), #end medical supplies
			(try_end), #end looking for ammo
      
      (try_begin),
        (this_or_next|gt,":combinedammo_pistol",0),
        (gt,":combinedammo_rifle",0),
        
        (agent_get_slot, ":pistol_ammo_cur", ":agent_no", slot_agent_backpack_pistol_ammo),
			  (agent_get_slot, ":rifle_ammo_cur", ":agent_no", slot_agent_backpack_rifle_ammo),
        (val_add,":pistol_ammo_cur",":combinedammo_pistol"),
			  (val_add,":rifle_ammo_cur",":combinedammo_rifle"),
        
        (agent_set_slot, ":agent_no", slot_agent_backpack_pistol_ammo, ":pistol_ammo_cur"),
        (agent_set_slot, ":agent_no", slot_agent_backpack_rifle_ammo, ":rifle_ammo_cur"),
        
        #update client.
				(multiplayer_send_4_int_to_player,":cur_player",multiplayer_event_zombieclient,2,":agent_no",":pistol_ammo_cur",":rifle_ammo_cur"),
      (try_end),
      
			# (try_begin),
        # (gt,":combinedmeds",0),
        
        # (agent_get_slot, ":meds_cur", ":agent_no", slot_agent_backpack_medkits),
        # (val_add,":meds_cur",":combinedmeds"),
        # (agent_set_slot, ":agent_no", slot_agent_backpack_medkits, ":meds_cur"),
        
        # (display_message,"@godverdekut"),
        
				# (multiplayer_send_4_int_to_player,":cur_player",multiplayer_event_zombieclient,9,":agent_no",":meds_cur"),
      # (try_end),
		(try_end),
	(try_end),
	])
	
#Client sided - Update backpack HUD#
multiplayer_ie_start_presentations = (0.1, 0, 0, [(neg|multiplayer_is_dedicated_server),],
	[
	(try_begin),
		(neg|is_presentation_active, "prsnt_zombie_backpack_hud"),
		(start_presentation, "prsnt_zombie_backpack_hud"),
	(try_end),
	
	(try_begin),
		(neg|is_presentation_active, "prsnt_walking_icon"),
		(start_presentation, "prsnt_walking_icon"),
	(try_end),
	
	(try_begin),
		(neg|is_presentation_active, "prsnt_wounded_player_icon"),
		(start_presentation, "prsnt_wounded_player_icon"),
	(try_end),
	...
	#BACKPACK STUFF END#
	####################
multiplayer_ie_german_spyglass = (0, 0, 1,
 [
  (neg|multiplayer_is_dedicated_server),
  (game_key_is_down,gk_defend),
  ],
  [
    (neg|is_presentation_active,"prsnt_spyglass_german_dummy"),
    (call_script,"script_client_get_my_agent"),
    (assign,":agent_id",reg0),
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    (agent_get_wielded_item,":item_id",":agent_id",0),
    (eq,":item_id","itm_german_spyglass"),
    (start_presentation,"prsnt_spyglass_german_dummy"),
  ])

multiplayer_ie_french_working_spyglass = (0, 0, 1,
 [
  (neg|multiplayer_is_dedicated_server),
  (game_key_is_down,gk_defend),
  ],
  [
    (neg|is_presentation_active,"prsnt_spyglass_french_dummy"),
    (call_script,"script_client_get_my_agent"),
    (assign,":agent_id",reg0),
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    (agent_get_wielded_item,":item_id",":agent_id",0),
    (eq,":item_id","itm_french_working_spyglass"),
    (start_presentation,"prsnt_spyglass_french_dummy"),
  ])
  
multiplayer_ie_french_spyglass = (0, 0, 1,
 [
  (neg|multiplayer_is_dedicated_server),
  (game_key_is_down,gk_defend),
  ],
  [
    (neg|is_presentation_active,"prsnt_spyglass_british_dummy"),
    (call_script,"script_client_get_my_agent"),
    (assign,":agent_id",reg0),
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    (agent_get_wielded_item,":item_id",":agent_id",0),
    (eq,":item_id","itm_french_spyglass"),
    (start_presentation,"prsnt_spyglass_british_dummy"),
  ])
  
  #Server sided - cycle through all players, see if they should be scoped, and send to zoom script#
# multiplayer_ie_zoom_script = (0, 0, 0, [],
	# [
	# (multiplayer_is_server), #this only runs server-side
	 #(get_max_players,multiplayer_player_loops_end),
	# (try_for_range,":cur_player",0,multiplayer_player_loops_end), #cycle through players
		...
		# (try_begin),
			...
			# (multiplayer_send_int_to_player,":cur_player",multiplayer_event_zombieclient,14),
		# (try_end),
		# (agent_is_alive,":agent_no"),
		# (agent_get_wielded_item,":weapon",":agent_no"), #what are you carrying currently?
		# (neq,":weapon",-1),
		# (agent_get_slot,":is_aiming",":agent_no",26), #is the agent supposed to be aiming?
		# (item_get_slot,":magnification",":weapon",slot_item_magnification), #is it auto?
		# (try_begin),
			# (eq,":is_aiming",1),
			# (gt,":magnification",0),
			# (multiplayer_send_int_to_player,":cur_player",multiplayer_event_zombieclient,13),
				# (else_try),
			# (multiplayer_send_int_to_player,":cur_player",multiplayer_event_zombieclient,14),
		# (try_end),
	# (try_end),
...
multiplayer_ie_french_sniper_view = (0, 0, 1,
 [
  (neg|multiplayer_is_dedicated_server),
  (game_key_clicked,gk_zoom),
  ],
  [
    (neg|is_presentation_active,"prsnt_french_sniper_view"),
    (call_script,"script_client_get_my_agent"),
    (assign,":agent_id",reg0),
   # (agent_get_slot,":is_aiming",":agent_id",26),
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    (agent_get_wielded_item,":item_id",":agent_id",0),
    (eq,":item_id","itm_frenchlebelrifle_sniper"),
    (agent_get_animation, ":anim_playing", ":agent_id",1),
	#(assign, reg1, ":anim_playing"),
	#(display_message,"@Your animation is {reg1}"),
	#(this_or_next|eq,":anim_playing",514),
	(eq,":anim_playing","anim_aim_boltaction"),
	# (this_or_next|eq,":anim_playing","anim_fire_boltaction_high_recoil"),
	# (eq,":anim_playing","anim_fire_boltaction_low_recoil"),
    #(eq,":is_aiming",1),
    (start_presentation,"prsnt_french_sniper_view"),

  ])
  
multiplayer_ie_german_sniper_view_gewehr = (0, 0, 1,
 [
  (neg|multiplayer_is_dedicated_server),
  (game_key_clicked,gk_zoom),
  ],
  [
    (neg|is_presentation_active,"prsnt_german_sniper_view_gewehr"),
    (call_script,"script_client_get_my_agent"),
    (assign,":agent_id",reg0),
    #(agent_get_slot,":is_aiming",":agent_id",26),
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    (agent_get_wielded_item,":item_id",":agent_id",0),
    (eq,":item_id","itm_germangewehr98_sniper"),
    (agent_get_animation, ":anim_playing", ":agent_id",1),
	#(assign, reg1, ":anim_playing"),
	#(display_message,"@Your animation is {reg1}"),
	#(this_or_next|eq,":anim_playing",514),
	...
	# (this_or_next|eq,":anim_playing","anim_fire_boltaction_high_recoil"),
	# (eq,":anim_playing","anim_fire_boltaction_low_recoil"),
    (start_presentation,"prsnt_german_sniper_view_gewehr"),

  ])
  
multiplayer_ie_german_sniper_view_kahr = (0, 0, 1,
 [
  (neg|multiplayer_is_dedicated_server),
  (game_key_clicked,gk_zoom),
  ],
  [
    (neg|is_presentation_active,"prsnt_german_sniper_view_kahr"),
    (call_script,"script_client_get_my_agent"),
    (assign,":agent_id",reg0),
   # (agent_get_slot,":is_aiming",":agent_id",26),
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    (agent_get_wielded_item,":item_id",":agent_id",0),
    (eq,":item_id","itm_britishsmle_sniper"),
    (agent_get_animation, ":anim_playing", ":agent_id",1),
	#(assign, reg1, ":anim_playing"),
	#(display_message,"@Your animation is {reg1}"),
	#(this_or_next|eq,":anim_playing",514),
	...
	# (this_or_next|eq,":anim_playing","anim_fire_boltaction_high_recoil"),
	# (eq,":anim_playing","anim_fire_boltaction_low_recoil"),
    (start_presentation,"prsnt_german_sniper_view_kahr"),

  ])
#  multiplayer_ie_british_sniper_view_smle = (0, 0, 1,
# [
#  (neg|multiplayer_is_dedicated_server),
#  (game_key_clicked,gk_zoom),
#  ],
#  [
#    (neg|is_presentation_active,"prsnt_british_sniper_view_smle"),
#    (call_script,"script_client_get_my_agent"),
#    (assign,":agent_id",reg0),
#    #(agent_get_slot,":is_aiming",":agent_id",26),
#    (agent_is_active,":agent_id"),
...
#	# (this_or_next|eq,":anim_playing","anim_fire_boltaction_high_recoil"),
#	# (eq,":anim_playing","anim_fire_boltaction_low_recoil"),
#    (start_presentation,"prsnt_british_sniper_view_smle"),
#
#  ])
...
multiplayer_client_control_cannon = (
  0, 0, 1, [ #0, 0, 1, #Beaver: changed for faster response time # Execute conditions.
             (neg|multiplayer_is_dedicated_server), 
             (eq, "$g_currently_controlling_object", 1),
             #Beaver Machine Gun Begin
             #(this_or_next|game_key_is_down, gk_attack),
             #(this_or_next|game_key_clicked, gk_defend),
             #(neg|game_key_is_down, gk_attack),
             #Beaver Machine Gun End
             #I realised these will always trigger now since either attack key is down or not, so we'll just have to run this script every frame
             #It's no big deal, it's not a very heavy script...
  ...
  [
    ...
    (agent_get_slot,":cur_command",":my_agent",slot_agent_current_command),
    (try_begin),
      (game_key_is_down, gk_defend),
      (neq,":cur_command",cannon_command_stop_aim),
      (assign,":command",cannon_command_stop_aim),
    (else_try),
      (game_key_is_down, gk_attack),
      (neq,":cur_command",cannon_command_fire),
      (assign,":command",cannon_command_fire),
    (else_try),
      (neg|game_key_is_down, gk_attack),
     # (eq,":cur_command",cannon_command_fire),
      (assign,":command",cannon_command_stop_fire),
      #Beaver Machine Gun End
    (try_end),
    ...
    (else_try),
      (call_script,"script_handle_agent_control_command",":my_agent",command_type_cannon,":command"),
    (try_end),
  ])
...
#Beaver Machine Gun Begin
#Hooking this up to its own trigger as having it in the aim cannon part doesn't work good with machine guns
multiplayer_server_fire_cannon  = (
  0.12, 0, 0, [(this_or_next|multiplayer_is_server),(neg|game_in_multiplayer_mode)],
  [  
    (set_fixed_point_multiplier, 100),
    (try_for_range,":cannon_type", mm_cannon_wood_types_begin, mm_cannon_wood_types_end),
      ...
      (try_for_range,":cur_instance",0,":end_cond"),
        ...
        (agent_is_active, ":cur_control_agent"),
        (agent_is_alive, ":cur_control_agent"),
        #Removed a bunch of checks - they will be checked in the aiming script every .5 secs anyway, no need to bloat this trigger with them
        ...
        (try_begin),
          (eq,":cur_time",1), #lower response time for MG fire
          (eq,":cannon_type","spr_mm_cannon_rocket_wood"), #using rockets for machine guns for now
          (call_script,"script_fire_mg",":instance_id",":cur_control_agent"),
        (else_try),
		  (eq,":cur_time",1), #lower response time for MG fire
		  (eq,":cannon_type","spr_fr_mm_cannon_rocket_wood"), #using rockets for machine guns for now
          (call_script,"script_fire_mg",":instance_id",":cur_control_agent"),
		(else_try),
          (eq,":cur_time",5), #1), #increased this, should be the same as before - but change if firing is too fast/slows
    ...
    (try_for_range,":cannon_type", mm_cannon_wood_types_begin, mm_cannon_wood_types_end),
      ...
      (try_for_range,":cur_instance",0,":end_cond"),
        ...
        (try_begin),
          (eq,":cur_command",cannon_command_fire),
          #Beaver Machine Gun Begin
          (neq,":cannon_type","spr_mm_cannon_rocket_wood"), #using rockets for machine guns for now
          (neq,":cannon_type","spr_fr_mm_cannon_rocket_wood"), #using rockets for machine guns for now
          
          #Moved firing to its own script to work with machine guns
          #This might slightly slow down the game, but shouldn't be a huge deal
          #You will now still be able to change aim of a machine gun while firing
        ...
        (else_try),
          ...
          (try_begin),
           ...
           (else_try),
			  (eq,":cannon_type","spr_ie_german_granatenwerfer_wood"),
			  (call_script,"script_search_for_first_ground_from_direction_to_angle"),
              (assign,":agent_y_rot",reg0),
		  (else_try),
			  (eq,":cannon_type","spr_ie_german_minenwerfer_wood"),
			  (call_script,"script_search_for_first_ground_from_direction_to_angle"),
              (assign,":agent_y_rot",reg0),
		  (else_try),
          ...
          #   (position_get_rotation_around_y,":agent_y_rot",pos11),
			...
			(try_begin),
				#(neq,":cannon_type","spr_mm_cannon_rocket_wood"), #to prevent them MGs to turn on the Y axis
            ...
            #Beaver Machine Gun Begin
            #Let's speed up machine gun rotation a little shall we?
            (try_begin),
              (eq,":cannon_type","spr_mm_cannon_rocket_wood"), #using rockets for machine guns for now
              (try_begin),
                (gt,":diffirence_z",8),
                (assign,":diffirence_z",8),
              (else_try),
                (lt,":diffirence_z",-8),
                (assign,":diffirence_z",-8),
              (try_end),
              ...
              (try_begin),
                (gt,":diffirence_y",4),
                (assign,":diffirence_y",4),
              (else_try),
                (lt,":diffirence_y",-4),
                (assign,":diffirence_y",-4),
              (try_end),
            (else_try),
              #Non-MGs below (the old values)
              (try_begin),
                (gt,":diffirence_z",4),
            ...
            (try_begin),
             ...
             (val_add,":prop_y_rot",":diffirence_y"),# Add the change towards the current rotation.
              ...
              (try_begin),
                ...
                (neq,":cannon_type","spr_ie_german_granatenwerfer_wood"),
			  ...
			  (try_begin),
			  (eq, ":cannon_type", "spr_fr_mm_cannon_rocket_wood"),
...
multiplayer_client_music_and_sapper = ( # Also for Sapper construction # and rocket placement.
  ...
  [
	...
	(else_try),
        (call_script,"script_cf_agent_is_calling_a_medic",":player_agent"),
        
        (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_call_medic, music_type_stop),
	  
	  (else_try),
        (call_script,"script_cf_agent_is_saluting",":player_agent"),
        
        (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_salute, music_type_stop),
      ...
      (else_try),
        ...
        (else_try),
          (this_or_next|eq,":player_rank",mm_rank_officer),
          ...
          (try_end),
		 (else_try),
		  (eq,":item_id", "itm_mg_ammobox"),
		  (multiplayer_send_int_to_server, multiplayer_event_send_player_action, player_action_place_mg_ammobox),
		(else_try),
		  (eq,":item_id", "itm_ammobox"),
		  (multiplayer_send_int_to_server, multiplayer_event_send_player_action, player_action_place_ammobox),
        (else_try),
	    ...
	    (else_try),
          (eq,":player_class",multi_troop_class_mm_rocket),   
          (eq,":item_id", "itm_fr_rocket_placement"),
          (multiplayer_send_int_to_server, multiplayer_event_send_player_action, player_action_place_fr_rocket),
		(else_try),
		  (eq, ":player_class", multi_troop_class_mm_artillery),
		  (eq, ":item_id", "itm_granaten_placement"),
		  (multiplayer_send_int_to_server, multiplayer_event_send_player_action, player_action_place_granatenwerfer),
		(else_try),
		  (eq, ":player_class", multi_troop_class_mm_artillery),
		  (eq, ":item_id", "itm_french_58mm_mortar"),
		  (multiplayer_send_int_to_server, multiplayer_event_send_player_action, player_action_place_58mm_mortar),
        (try_end),
      (try_end),
    (try_end),
  ])
...
multiplayer_client_ie_call_medic = (
  0, 0.5, 0.1, [
  (neg|multiplayer_is_dedicated_server),
  (neg|is_presentation_active, "prsnt_multiplayer_admin_chat"),
  (neg|is_presentation_active, "prsnt_game_multiplayer_admin_panel"),
  ...
  (try_begin),
    ...
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_call_medic,music_type_start),
...
multiplayer_client_ie_salute = (
  ...
  (try_begin),
    ...
    (agent_is_active,":agent_id"),
    (agent_is_alive,":agent_id"),
    (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_salute,music_type_start),
...
#		(this_or_next|eq, ":troop_id", "trp_french_sentry"),
#		(this_or_next|eq, ":troop_id", "trp_napoleon"), 
#        (this_or_next|eq, ":troop_id", "trp_british_sentry"), # The british
#        (this_or_next|eq, ":troop_id", "trp_wellington"),
#        (this_or_next|eq, ":troop_id", "trp_britishStandardInfantry_nco"),
#       # (this_or_next|eq, ":troop_id", "trp_british_arty_nco"),
#        (eq, ":troop_id", "trp_british_arty_nco"),
#		#in this case, continue
#		
#		(agent_get_look_position, pos1, ":agent_id"),
...
multiplayer_server_bonuses = ( # Officer and flag Bonuses
  ...
  [
    ...
    (try_for_range, ":player_id", "$g_player_loops_begin", multiplayer_player_loops_end),
      ...
      (this_or_next|eq,":player_class",multi_troop_class_ie_machine_gunner),
      ...
      (try_begin),
        ...
        (else_try),
          (eq,":player_class",multi_troop_class_ie_machine_gunner),
  ...
  [
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (call_script,"script_multiplayer_server_agent_stop_music", ":agent_id"),
	 (else_try),
        (call_script,"script_cf_agent_is_playing_gramophone",":agent_id"),
        
        (call_script,"script_multiplayer_server_agent_stop_music", ":agent_id"),
	(else_try),
		(call_script, "script_cf_agent_is_fixing_or_unfixing_a_bayonet",":agent_id"),
		
		(agent_set_animation,":agent_id","anim_fix_bayonet_end"),
	  (else_try),
        (call_script,"script_cf_agent_is_saluting",":agent_id"),
		
		(agent_set_animation, ":agent_id", "anim_salute_end"),
	 (else_try),
        (call_script,"script_cf_agent_is_calling_a_medic",":agent_id"),
  ...
  [
    ...
    (store_trigger_param_2,":item_id"),
	  ...
	  (try_begin),
		  (agent_is_active, ":agent_no"),
		  (agent_is_alive, ":agent_no"),
		  (call_script, "script_cf_agent_is_fixing_or_unfixing_a_bayonet", ":agent_no"),
		  (agent_set_animation,":agent_no","anim_fix_bayonet_end"),
	  (try_end),
	  
	   (try_begin),
		  (agent_is_active, ":agent_no"),
		  (agent_is_alive, ":agent_no"),
		  (call_script, "script_cf_agent_is_saluting", ":agent_no"),
		  (agent_set_animation,":agent_no","anim_salute_end"),
	  (try_end),
    ...
    (try_begin),
      ...
      (this_or_next|eq,":item_id","itm_rocket_placement"),
      (this_or_next|eq,":item_id","itm_granaten_placement"),
      (this_or_next|eq,":item_id","itm_french_58mm_mortar"),
      (this_or_next|eq,":item_id","itm_fr_rocket_placement"),
	  (this_or_next|eq, ":item_id", "itm_german_mg08"),
	  (eq, ":item_id", "itm_german_mg08_melee"),
      ...
      (try_begin),
        ...
        (neq, ":item_id", "itm_granaten_placement"),
		(neq,":item_id","itm_fr_rocket_placement"), # dont rotate up for the rocketplacement
		(neq,":item_id","itm_french_58mm_mortar"), # dont rotate up for the rocketplacement
		(neq, ":item_id", "itm_german_mg08"),
		(neq, ":item_id", "itm_german_mg08_melee"),
      ...
      (spawn_item,":item_id",0,300), # remove after 5 minutes
		   (try_begin),
			 ...
			 (try_for_range,":slot",0,4), #begin getting ammo in gun
				(agent_get_item_slot,":item",":agent_no",":slot"),
				(eq,":item",":item_id"),
				(agent_get_ammo_for_slot,":ammo_dropped_item",":agent_no",":slot"),
			(try_end),
			(scene_spawned_item_get_num_instances, ":total_num_instances", ":item_id"),
			
			(val_sub, ":total_num_instances", 1),
			(scene_spawned_item_get_instance, ":instance_id", ":item_id", ":total_num_instances"),
			(scene_prop_set_slot, ":instance_id", slot_prop_dropped_mg_ammo, ":ammo_dropped_item"),
			(scene_prop_set_slot, ":instance_id", slot_prop_is_dropped, 1),
	  (try_end), 
...
multiplayer_client_walking = (
  ...
  [
    ...
    (else_try),
      ...
      (agent_is_active,":agent_id"),
      (agent_is_alive,":agent_id"),
	  (neg|agent_slot_eq, ":agent_id", slot_agent_aiming, 1),
...
multiplayer_server_disallow_multiple_firearms = (
  ...
  [
    ...
    (store_trigger_param_3,":prop_instance_id"), # Trigger Param 3: scene prop id (will be deleted after this trigger)
	
	 (try_begin),
	 (store_trigger_param_1, ":agent_id"),
	 (agent_is_active, ":agent_id"),
	 (agent_is_alive, ":agent_id"),
      (scene_prop_get_slot, ":ammo_in_prop", ":prop_instance_id", slot_prop_nummedikit),
	   (this_or_next|eq, ":picked_item_id", "itm_french_bandages"),
	   (eq, ":picked_item_id", "itm_german_bandages"),
     (try_for_range,":slot",0,4), 
			(agent_get_item_slot,":item",":agent_id",":slot"),
			(eq,":item",":picked_item_id"),
			(agent_set_slot, ":agent_id", slot_agent_nummedikit, ":ammo_in_prop"),
			#(agent_get_slot, ":meds_in_agent", ":agent_id", slot_agent_nummedikit),
		#	(assign, reg5, ":meds_in_agent"),
			#(display_message, "@The agent has used the bandages when picking it up {reg5} times "),
	 ...
	 (agent_is_active, ":agent_id"),
	 (agent_is_alive, ":agent_id"),
      (scene_prop_get_slot, ":ammo_in_prop", ":prop_instance_id", slot_prop_nummorphine),
	   (eq, ":picked_item_id", "itm_morphine_ampoule"),
     (try_for_range,":slot",0,4), 
			(agent_get_item_slot,":item",":agent_id",":slot"),
			(eq,":item",":picked_item_id"),
			(agent_set_slot, ":agent_id", slot_agent_nummorphine, ":ammo_in_prop"),
		#	(agent_get_slot, ":meds_in_agent", ":agent_id", slot_agent_nummorphine),
			#(assign, reg6, ":meds_in_agent"),
			#(display_message, "@The agent has used the morphine {reg5} times "),
    ...
    (try_begin), # firearm?
      ...
      (try_begin),
      (scene_prop_get_slot, ":ammo_in_prop", ":prop_instance_id", slot_prop_dropped_mg_ammo),
	  (scene_prop_get_slot, ":is_dropped", ":prop_instance_id", slot_prop_is_dropped),
      (eq, ":picked_item_id", "itm_german_mg08"),
	  (eq, ":is_dropped", 1),
     (try_for_range,":slot",0,4), #begin getting ammo in gun
			(agent_get_item_slot,":item",":agent_id",":slot"),
			(eq,":item",":picked_item_id"),
			#(agent_get_item_cur_ammo, ":ammo_in_wielded_item", ":agent_id", ":slot"),
			(agent_set_ammo, ":agent_id", ":picked_item_id", ":ammo_in_prop"),
...
multiplayer_server_bird_spawn_common = (
  ...
  [
    ...
    (try_for_range,":unused",0,":num_birds_to_spawn"),
      ...
      (call_script, "script_find_or_create_scene_prop_instance", "spr_ie_airplane", 0, 0),
    (try_end),
  ])
...
multiplayer_server_cleanup_props = (
  ...
  [
    ...
    (scene_prop_get_num_instances, ":num_instances_of_scene_prop", "spr_mm_ship"),     
    (try_for_range, ":cur_instance", 0, ":num_instances_of_scene_prop"),
      (scene_prop_get_instance, ":cur_instance_id", "spr_mm_ship", ":cur_instance"), 
      ...
      (gt,":time_difirence",200), #(4.5 * 60 = 270)
	...
	#clean up ammoboxes
	(try_for_range, ":ammoboxes", "spr_ie_rifle_ammobox",  "spr_ie_ammoboxes_end"),
		(scene_prop_get_num_instances, ":num_instances_ammoboxes", ":ammoboxes"),   
		(try_for_range, ":cur_instance", 0, ":num_instances_ammoboxes"),
		    (scene_prop_get_instance, ":cur_instance_id", ":ammoboxes", ":cur_instance"),
			(try_begin),
				(scene_prop_slot_eq, ":cur_instance_id", slot_prop_num_times_used, 2),
				(prop_instance_is_valid, ":cur_instance_id"),
				   (scene_prop_get_slot,":spawned_at",":cur_instance_id", scene_prop_slot_spawned_at),
				   (store_sub,":time_difirence",":cur_time",":spawned_at"),
				   (gt,":time_difirence",120),
				    (call_script, "script_clean_up_prop_instance_with_childs", ":cur_instance_id"), # clean cannon
			(try_end),
		(try_end),
	(try_end),
  ])
  
multiplayer_ie_grenades = (2, 0, 0, [(multiplayer_is_server)],
 [
     # Smoke Grenades
       (scene_prop_get_num_instances, ":end_cond", "spr_grenade_field_smoke"),
	(try_for_range, ":cur_instance", 0, ":end_cond"),
		(scene_prop_get_instance, ":instance_id", "spr_grenade_field_smoke", ":cur_instance"),
        (scene_prop_get_slot,":cur_time",":instance_id",slot_prop_timer),
		(gt, ":cur_time",0),
		(val_sub,":cur_time",1),
		(prop_instance_get_position, pos47, ":instance_id"), 
        #(try_begin),
            (le, ":cur_time", 0),
		     (scene_prop_get_slot,":agent_id",":instance_id",slot_prop_belongs_to_agent),
			# (call_script,"script_grenade_explosion_at_position",":agent_id",270,450), # Input: shooter_agent_no, max_damage points, range in cm
             #(call_script, "script_clean_up_prop_instance", ":instance_id"),
        #(else_try),
            (scene_prop_set_slot, ":instance_id", slot_prop_timer, ":cur_time"),
        (try_end),
	(try_end),
# The British Grenades
    (scene_prop_get_num_instances, ":end_cond", "spr_sw_british_grenade_tmp"),
	(try_for_range, ":cur_instance", 0, ":end_cond"),
		(scene_prop_get_instance, ":instance_id", "spr_sw_british_grenade_tmp", ":cur_instance"),
        (scene_prop_get_slot,":cur_time",":instance_id",slot_prop_timer),
		(gt, ":cur_time",0),
		(val_sub,":cur_time",1),
		(prop_instance_get_position, pos47, ":instance_id"), 
	...
	(try_end),
 #Ze german grenades
 (scene_prop_get_num_instances, ":end_cond", "spr_sw_grenade_tmp"),
	(try_for_range, ":cur_instance", 0, ":end_cond"),
		(scene_prop_get_instance, ":instance_id", "spr_sw_grenade_tmp", ":cur_instance"),
        (scene_prop_get_slot,":cur_time",":instance_id",slot_prop_timer),
		(gt, ":cur_time",0),
		(val_sub,":cur_time",1),
		(prop_instance_get_position, pos47, ":instance_id"), 
	...
	(try_end),
	 ...
	 # ze french grenades
	#(scene_prop_get_num_instances, ":num_instances", "spr_sw_french_grenade_tmp"),
	(scene_prop_get_num_instances, ":end_cond", "spr_sw_french_grenade_tmp"),
	(try_for_range, ":cur_instance", 0, ":end_cond"),
		(scene_prop_get_instance, ":instance_id", "spr_sw_french_grenade_tmp", ":cur_instance"),
        (scene_prop_get_slot,":cur_time",":instance_id",slot_prop_timer),
		(gt, ":cur_time",0),
		(val_sub,":cur_time",1),
		(prop_instance_get_position, pos47, ":instance_id"), 
	...
	#Ze big german grenades
	#(scene_prop_get_num_instances, ":num_instances", "spr_explosive_grenade_tmp"),
	(scene_prop_get_num_instances, ":end_cond", "spr_explosive_grenade_tmp"),
	(try_for_range, ":cur_instance", 0, ":end_cond"),
		(scene_prop_get_instance, ":instance_id", "spr_explosive_grenade_tmp", ":cur_instance"),
        (scene_prop_get_slot,":cur_time",":instance_id",slot_prop_timer),
		(gt, ":cur_time",0),
		(val_sub,":cur_time",1),
		(prop_instance_get_position, pos47, ":instance_id"), 
        (try_begin),
            (le, ":cur_time", 0),
		     (scene_prop_get_slot,":agent_id",":instance_id",slot_prop_belongs_to_agent),
			 (call_script,"script_grenade_explosion_at_position",":agent_id",350,650), # Input: shooter_agent_no, max_damage points, range in cm
             (call_script, "script_clean_up_prop_instance", ":instance_id"),
        (else_try),
            (scene_prop_set_slot, ":instance_id", slot_prop_timer, ":cur_time"),
        (try_end),
...
multiplayer_ie_bandages_morphine =  (ti_on_agent_hit, 0, 0, [],
     [
    (multiplayer_is_server),
...
multiplayer_ie_bleeding = (6, 0, 0, [],
           #bleeding
 [
    (multiplayer_is_server),
    (try_for_agents,":agent"),
		(agent_is_active, ":agent"),
        (agent_get_slot,":bleeding",":agent", 41),
        (eq,":bleeding",1),
        (agent_get_slot,":assailant",":agent", 45),
        (agent_is_alive,":agent"),
		(agent_is_active, ":assailant"),
		(neq,":agent",-1),
	...
	(try_begin),
            ...
            (particle_system_burst,"psys_game_blood_2", pos1, 50),
	(else_try),
	...
	(try_end),
        ...
        (else_try),
			(try_begin),
					...
					(agent_is_active, ":assailant"),
					(agent_is_active, ":agent"),
					(agent_deliver_damage_to_agent,":assailant",":agent",20, 0),
			(try_end),
        (try_end),
...
multiplayer_ie_spawn_blood = (ti_on_agent_hit, 0, 0, [],
           #spawn ZE BLOD
 [
	
    (store_trigger_param_1,":my_agent"),
    (store_trigger_param_2,":assailant"),
    (store_trigger_param_3,":damage"),
    ...
    (position_set_z_to_ground_level,pos1),
    (set_spawn_position,pos1),
    (ge,":damage",25), #For testing. Normally it's 20-25
    # (store_random_in_range,":random",1,5),
	(agent_set_slot,":my_agent",41,1),
	#(get_max_players, multiplayer_player_loops_end),
	(try_for_range, ":tot_players" ,0, multiplayer_player_loops_end),
		(player_is_active, ":tot_players"),
		(player_get_agent_id, ":total_agents", ":tot_players"),
		(agent_is_active, ":total_agents"),
		(neq, ":total_agents", -1),
		(agent_is_alive, ":total_agents"),
		(multiplayer_send_2_int_to_player, ":tot_players", multiplayer_event_zombieclient, 34,":my_agent"),
		(agent_set_slot,":my_agent",45,":assailant"),
	(try_end),
])
...
multiplayer_server_on_item_dropped = (
  ...
  [
	...
	(call_script,"script_multiplayer_server_drop_ammobox", ":agent_no"),
      ...
      (prop_instance_get_position, pos25, ":dropped_prop"), #AKA instance_id
	...
	(try_begin), #mg ammoboxes
	 (store_trigger_param_1,":agent_no"),
	 (agent_is_active, ":agent_no"),
	 (eq, ":item_id", "itm_mg_ammobox"),
	 (agent_set_wielded_item, ":agent_no", -1),
	(call_script,"script_multiplayer_server_drop_mg_ammobox", ":agent_no"),
	  (store_trigger_param_3, ":dropped_prop"),
      (prop_instance_get_position, pos25, ":dropped_prop"), #AKA instance_id
	  (position_move_y, pos25,-500),
	  (prop_instance_set_position,":dropped_prop",pos25),
	...
	(try_end),
	 ...
	 (try_begin),
			 (this_or_next|eq, ":item_id", "itm_german_bandages"), 
			 (eq, ":item_id", "itm_french_bandages"),
			 
			 (try_for_range,":slot",0,4), #begin getting ammo in gun
				(agent_get_item_slot,":item",":agent_no",":slot"),
				(eq,":item",":item_id"),
				#(agent_get_ammo_for_slot,":ammo_dropped_item",":agent_no",":slot"),
				(agent_get_slot, ":num_meds_used", ":agent_no", slot_agent_nummedikit),
			(try_end),
			(store_trigger_param_3, ":instance_id"),
			(scene_prop_set_slot, ":instance_id", slot_prop_nummedikit, ":num_meds_used"),
			#(assign, reg1, ":instance_id"),
		#	(assign, reg2, ":num_meds_used"),
			#(display_message, "@When dropping this item, the slot prop is worth {reg2} whereas its instance is {reg1}"),
	  (try_end), 
	  
	   (try_begin),
			 (eq, ":item_id", "itm_morphine_ampoule"), 
			 
			 (try_for_range,":slot",0,4), #begin getting ammo in gun
				(agent_get_item_slot,":item",":agent_no",":slot"),
				(eq,":item",":item_id"),
				#(agent_get_ammo_for_slot,":ammo_dropped_item",":agent_no",":slot"),
				(agent_get_slot, ":num_meds_used", ":agent_no", slot_agent_nummorphine),
			(try_end),
			(store_trigger_param_3, ":instance_id"),
			(scene_prop_set_slot, ":instance_id", slot_prop_nummorphine, ":num_meds_used"),
		#	(assign, reg1, ":instance_id"),
			#(assign, reg2, ":num_meds_used"),
			#(display_message, "@When dropping this item, the morphine slot prop is worth {reg2} whereas its instance is {reg1}"),
	  (try_end), 
	...
	(try_end),
	  ...
	  (try_begin),
			 (eq, ":item_id", "itm_german_mg08"), #ze powerful german MG
			 (try_for_range,":slot",0,4), #begin getting ammo in gun
				(agent_get_item_slot,":item",":agent_no",":slot"),
				(eq,":item",":item_id"),
				(agent_get_ammo_for_slot,":ammo_dropped_item",":agent_no",":slot"),
...
mm_multiplayer_common = [
  ...
  multiplayer_server_drag_limber,
  multiplayer_server_move_bird_common,
  # multiplayer_server_bird_spawn_common, removed because we don't want airplanes in random maps
  multiplayer_server_sail_ship,
  multiplayer_thunder_server,
  multiplayer_server_on_item_dropped,
  multiplayer_server_disallow_multiple_firearms,
  ...
  multiplayer_play_sounds_and_particles,
  multiplayer_battle_window_opened,
  multiplayer_ie_weapons_declarations,
  #multiplayer_ie_keys_check,
  multiplayer_ie_keys_check_hold,
  multiplayer_ie_automatic_weapon_check,
  #multiplayer_ie_automatic_weapon_recoil,
  multiplayer_ie_aiming_template,
  multiplayer_ie_attachment_timer,
  multiplayer_walk_speed,
  #multiplayer_ie_backpack_system, no idea what this is
  multiplayer_ie_add_ammo,
  multiplayer_ie_start_presentations,
  multiplayer_ie_german_spyglass,
  multiplayer_ie_french_working_spyglass,
  multiplayer_ie_french_spyglass,
  multiplayer_ie_grenades,
  multiplayer_ie_bandages_morphine,
  multiplayer_ie_bleeding,
  multiplayer_ie_spawn_blood,
  multiplayer_ie_german_sniper_view_gewehr,
  multiplayer_ie_german_sniper_view_kahr,
#  multiplayer_ironsight_mode,
#  multiplayer_ie_british_sniper_view_smle,
  multiplayer_ie_french_sniper_view,
  multiplayer_ie_keys_check,
  multiplayer_client_surrender,
  multiplayer_client_ie_salute,
  multiplayer_client_ie_call_medic,
  multiplayer_client_ie_artillery_arrow_show,
  multiplayer_server_ie_splash_artillery,
 # multiplayer_client_ie_splash_artillery,
  ]
...
#-----------------------------------------------------------------
  ...
  (
    ...
    [
      ...
      #multiplayer_server_drowning,
      multiplayer_client_voicecommands,multiplayer_server_order_voicecommands,#multiplayer_client_drowning,
  ...
  (
    ...
    [
      ...
      (1, 0, 0, [(multiplayer_is_server),], #respawn HQ
       [
         # Vincenzo begin
         (store_mission_timer_a, ":current_time"),
         (store_sub, ":respawntime", ":current_time", "$g_hq_last_spawn_wave"),
         ...
         (try_for_range, ":player_no", "$g_player_loops_begin", multiplayer_player_loops_end),
           ...
           (eq, ":has_flags", 1), # More than 0 flags are owned, if not stop trying to spawn this agent.
           # Vincenzo end
           ...
           (try_begin),
             (gt,":player_team_entrypoints_count",0), # More than 0 entry points are found.
