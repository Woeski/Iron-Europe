 ...
 #   ),
    ...
    ("war_smoke_tall", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_rotation|psf_randomize_size, "prt_mesh_smoke_1",
     ...
     0.2,
        ...
        ("smoke_grenade", psf_billboard_3d|psf_randomize_size|psf_2d_turbulance|psf_randomize_rotation|psf_global_emit_dir, "prtcl_dust_a", # psf_global_emit_dir psf_billboard_3d | psf_randomize_size psf_always_emit
     5, 20.5, 0.45, -0.016, 10, 2,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.55), (0.8, 0.05),       #alpha keys
     (0.0, 0.99),(1, 0.99),      #red keys
     (0.0, 0.99),(1, 0.99),       #green keys
     (0.40, 0.99), (1, 10000.99),      #blue keys
     (0.01, 5.9),   (0.8, 100.9),   #scale keys
     (0.05, 0.05, 0.05),           #emit box size
     (0, 5.6, 0),                 #emit velocity
     0.7,                        #emit dir randomness
     28,                       #rotation speed
     0,                        #rotation damping
    ),   
	
    ("smoke_grenade_trail", psf_billboard_3d|psf_randomize_size|psf_2d_turbulance|psf_randomize_rotation|psf_always_emit, "prtcl_dust_a", # psf_global_emit_dir psf_billboard_3d | psf_randomize_size psf_always_emit
     5, 3.5, 0.45, 0.020, 10, 2,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.55), (0.8, 0.05),       #alpha keys
     (0.0, 0.99),(1, 0.99),      #red keys
     (0.0, 0.99),(1, 0.99),       #green keys
     (0.40, 0.99), (1, 10000.99),      #blue keys
     (0.01, 5.9),   (0.8, 8.9),   #scale keys
     (0.05, 0.05, 0.05),           #emit box size
     (0, 5.6, 0),                 #emit velocity
     0.7,                        #emit dir randomness
     28,                       #rotation speed
     0,                        #rotation damping
        ...
        ("smoke_tall", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_rotation|psf_randomize_size, "prt_mesh_smoke_1",
     30, 13, 0, 0, 7, 7, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 0.25), (1, 0),          #alpha keys
     (0.0, 1), (1, 0.8),      #red keys
     (0.0, 1),(1, 0.8),      #green keys
     (0.0, 1), (1, 0.8),     #blue keys
    ...
    ("fire_sparks_1", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size,  "prt_sparks_mesh_1",
     10, 0.03, 0.9, 0, 3, 10,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.6, 1), (1, 1),          #alpha keys
     (0.1, 0.7), (1, 0.7),      #red keys
     (0.1, 0.5),(1, 0.5),       #green keys
     (0.1, 0.1), (1, 0.1),      #blue keys
     (0.1, 0.07),   (1, 0.03),    #scale keys
     (0.57, 0.57, 0.05),           #emit box size
     (0, 0, 1),                 #emit velocity
...
#################### MM Particles #######################   
    ...
    # ),    
    ("pistol_smoke", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prtcl_dust_b", # psf_global_emit_dir psf_billboard_3d | psf_randomize_size psf_always_emit
     10, 0.1, 0.5, -0.00003, 40, 1,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
...
#*-*-*-*-* D U M M Y *-*-*-*-#
    ...
    ("dummy_smoke_big", psf_billboard_3d|psf_randomize_size,  "prt_mesh_dust_1",
     550, 20, 15, -0.05, 15.0, 0.2,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
...
##### Dungeon Water Drops  END #####
   ...
   ("cannon_blood", psf_billboard_3d |psf_randomize_size|psf_randomize_rotation,  "prt_mesh_blood_1",
    ...
    ("cannon_blood_2", psf_billboard_3d | psf_randomize_size|psf_randomize_rotation ,  "prt_mesh_blood_3",
     ...
     0,                       #rotation damping
      ...
      ("artillery_smoke", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prtcl_dust_b",
     400, 5, 0.1, -0.00003, 40, 10,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.75), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
     (0, 8.1),   (0.5, 13.0),   #scale keys
     (2.0, 0.9, 0.6),           #emit box size
     (0.0, -2.7, 0.0),                 #emit velocity
     0.1,                        #emit dir randomness
     100,                       #rotation speed
     0.6,                        #rotation damping
    ),
    ("mortar_smoke", psf_billboard_3d, "prtcl_dust_b",
     50, 4, 2.50, 0.206, 40, 2.75,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    ...
    # ),
    ("cannon_flash", psf_billboard_3d | psf_randomize_size , "prt_sparks_mesh_1",
     3000, 0.2, 0.1, -0.001, 50.0, 1.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    (0.1, 0.8), (1, 0),        #alpha keys
     (0.5, 1.0), (1, 0.9),      #red keys
     (0.5, 0.6), (1, 0.1),      #green keys
     (0.5, 0.2), (1, 0.0),      #blue keys
   ...
   # ("musket_flint_sparks", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size,  "prt_sparks_mesh_1",
    ...
    ("musket_flash", psf_billboard_3d | psf_randomize_size , "prt_sparks_mesh_1",
     500, 0.030, 0.1, -0.00003, 50.0, 1.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    ...
    ("musket_smoke", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prtcl_dust_b", # psf_global_emit_dir psf_billboard_3d | psf_randomize_size psf_always_emit
     2, 0.6, 2.3, -0.00003, 40, 6,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.75), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
     (0, 2.05),   (0, 2.05),   #scale keys
     (0.1, 0.225, 0.1),           #emit box size
     (0.0, 0.0, 0.0),                 #emit velocity
     0.01,                        #emit dir randomness
     100,                       #rotation speed
     0.5,                        #rotation damping
   ...
   ("pan_smoke", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prtcl_dust_b", # psf_global_emit_dir psf_billboard_3d | psf_randomize_size psf_always_emit
  ...
  ("musket_sparks", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size,  "prt_sparks_mesh_1",
   ...
   ("cannon_frizzle_smoke", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prtcl_dust_b", # psf_global_emit_dir psf_billboard_3d | psf_randomize_size psf_always_emit
  ...
  (0.1, 0.5), (1, 0),        #alpha keys
    ...
    ("bird_blood", psf_billboard_3d | psf_randomize_size|psf_randomize_rotation ,  "prt_mesh_blood_3",
     ...
     0,                       #rotation damping
       ...
       ("explosion_img", psf_billboard_2d|psf_always_emit|psf_2d_turbulance,  "prtcl_dust_n",
     5000, 3, 0, 0.01, 0, 0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 1), (0.5, 0),        #alpha keys
     (0, 0.258823529412), (1, 0.258823529412),      #red keys
     (0, 0.219607843137), (1, 0.219607843137),      #green keys
     (0, 0.160784313725), (1, 0.160784313725),      #blue keys
     (0, 5),   (0.5, 30),    #scale keys
     (0.00001, 0.00001, 0.00001),         #emit box size
     (0, 0, 0),               #emit velocity
     0,                         #emit dir randomness
     0,                        #rotation speed
     0,                       #rotation damping
    ...
    ("explosion_flash", psf_billboard_3d | psf_randomize_size , "prt_sparks_mesh_1",
     3000, 0.20, 1.9, -0.00003, 50.0, 1.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
   (0.1, 0.8), (1, 0),        #alpha keys
     (0.5, 1.0), (1, 0.9),      #red keys
     (0.5, 0.6), (1, 0.1),      #green keys
     (0.5, 0.2), (1, 0.0),      #blue keys
     (0.05, 3.55),   (0.5, 0.1),   #scale keys
     ...
     0.5                        #rotation damping
        ...
        ("spent_shell", psf_randomize_rotation,  "prtcl_bullet_casing",
     1, 3, 0, 1.4, 0, 0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 1), (1, 1),        #alpha keys
     (0.1, 0.5), (1, 0.5),      #red keys
     (0.1, 0.5),(1, 0.5),       #green keys
     (0.1, 0.5), (1, 0.5),      #blue keys
     (0.6, 3.2),   (1, 2.0),    #scale keys
     (0.025, 0.025, 0.025),           #emit box size
     (0, 0, 2.1),               #emit velocity
     0,                         #emit dir randomness
     130,                        #rotation speed
     0,                       #rotation damping
    ),
    ("explosion_smoke", psf_billboard_3d|psf_randomize_size,  "prtcl_dust_b",
     800, 8, 15, -0.04, 10.0, 0.2,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.5), (1, 0),        #alpha keys
     (0.1, 0.8), (1, 0.8),      #red keys
     (0.1, 0.7),(1, 0.7),       #green keys
     (0.1, 0.6), (1, 0.7),      #blue keys
   ...
   ("explosion_smoke2", psf_billboard_3d|psf_randomize_size,  "prtcl_dust_b",
     1000, 7, 15, -0.04, 10.0, 0.2,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.5), (1, 0),        #alpha keys
     (0.1, 0.8), (1, 0.8),      #red keys
     (0.1, 0.7),(1, 0.7),       #green keys
     (0.1, 0.6), (1, 0.7),      #blue keys
   ...
   ("explosion_mud", psf_billboard_3d|psf_always_emit|psf_randomize_size|psf_randomize_rotation,  "prtcl_dust_c",
      5000, 3, 2, 0.95, 12.0, 3.4,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
      (0.1, 0.5), (1, 0),        #alpha keys
      (0.1, 0.8), (1, 0.8),      #red keys
      (0.1, 0.7),(1, 0.7),       #green keys
      (0.1, 0.6), (1, 0.7),      #blue keys
      (9.0, 10.05),   (10.05, 12.3),    #scale keys
      (0.225, 0.230, 1.6),         #emit box size
      (0, 0, 5.1),               #emit velocity
      3.5,                         #emit dir randomness
      15,                        #rotation speed
      0.4,                       #rotation damping
     ),
   ...
   ("explosion_mud", psf_billboard_3d|psf_always_emit|psf_randomize_size|psf_randomize_rotation,  "prtcl_dust_c",
     10000, 3, 0.00500, 1, 12.0, 3.4,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.5), (1, 0),        #alpha keys
     (0.1, 0.8), (1, 0.8),      #red keys
     (0.1, 0.7),(1, 0.7),       #green keys
     (0.1, 0.6), (1, 0.7),      #blue keys
     (9.0, 10.05),   (10.05, 12.3),    #scale keys
     (0.45, 0.460, 3.2),         #emit box size
     (0, 0, 15.1),               #emit velocity
     1.75,                         #emit dir randomness
     15,                        #rotation speed
     0.4,                       #rotation damping
    ),
   ...
   ("explosives_fuse_smoke", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prtcl_dust_b", # psf_global_emit_dir psf_billboard_3d | psf_randomize_size psf_always_emit
...
("woodwallhit_particles", psf_randomize_size | psf_randomize_rotation,  "prtcl_dust_f",
  ...
  ("fort_complete_wallhit_smoke", psf_billboard_3d|psf_randomize_size,  "prtcl_dust_a",
   ...
   ("fort_complete_wallhit_particles", psf_randomize_size | psf_randomize_rotation,  "prtcl_dust_e",
    ...
    ("explosion_close", psf_billboard_3d|psf_always_emit|psf_randomize_size|psf_randomize_rotation,  "prtcl_dust_a",
     5000, 4, 2, 0.02, 12.0, 3.4,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 0.3), (1, 0),        #alpha keys
     (0, 0.258823529412), (1, 0.258823529412),      #red keys
     (0, 0.219607843137), (1, 0.219607843137),      #green keys
     (0, 0.160784313725), (1, 0.160784313725),      #blue keys
     (0.2, 8.05),   (1, 15.3),    #scale keys
     (0.1125, 0.115, 0.8),         #emit box size
     (0, 0, 8.1),               #emit velocity
     6,                         #emit dir randomness
     15,                        #rotation speed
     0.4,                       #rotation damping
    ),
