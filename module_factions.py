...
# Factions before this point are hardwired into the game end their order should not be changed.
  ...
  ("britain",  "British Empire",    0, 0.9, [("outlaws",-0.05),], [], 0xCCBB99),
  ("france",  "République Française", 0, 0.9, [("outlaws",-0.05)], [], 0xCC99FF),
  ("prussia",  "Deutsches Reich", 0, 0.9, [("outlaws",-0.05)], [], 0xCCBB99), 
        ("kingdoms_end","{!}kingdoms_end", 0, 0,[], []),
  ("russia",  "Rossiyskaya Imperiya",    0, 0.9, [("outlaws",-0.05)], [], 0x33DDDD),
  ("austria",  "Österreichisch-Ungarische Monarchie",  0, 0.9, [("outlaws",-0.05)], [], 0x33DD33),
