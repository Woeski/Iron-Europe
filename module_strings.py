...
# Strings before this point are hardwired.  
  ...
  # MM
  ("kingdom_1_adjective",                     "British Empire"),
  ("kingdom_2_adjective",                     "République Francaise"),
  ("kingdom_3_adjective",                     "Deutsches Reich"),
  ("kingdom_4_adjective",                     "Rossiyskaya Imperiya"),
  ("kingdom_5_adjective",                     "Österreich-Ungarn"),
...
#multiplayer scene names
  ("mp_arabian_harbour", "Strafexpedition (Day)"),
  ("mp_arabian_harbour_night", "Strafexpedition (Snow)"),
  ("mp_arabian_village", "Passchendaele (Day)"),
  ("mp_arabian_village_conq", "Passchendaele (Day)"),
  ("mp_arabian_village_conq_morning", "Passchendaele (Storm)"),
  ("mp_ardennes", "Belgian Forest (Night)"),
  ("mp_ardennes_morning", "Belgian Forest (Storm)"),
  ("mp_avignon", "River of Death (Day)"),
  ("mp_avignon_morning", "River of Death (Storm)"),
 # ("mp_berezina_crossing", "Berezina Crossing"),
  ("mp_bavarian_river", "Bavarian River (Day)"),
  ("mp_beach_morning", "Beach (Morning)"),
  ("mp_beach_evening", "Beach (Day)"),
  ("mp_borodino", "War of Trenches (Evening)"),
  ("mp_borodino_morn", "War of Trenches (Night)"),
  ("mp_champs_elysees", "Champagne (Day)"),
  ("mp_champs_elysees_rain", "Champagne (Evening)"),
  ("mp_columbia_hill_farm", "Fields of Flanders (Day)"),
  ("mp_columbia_farm_morning", "Fields of Flanders (Night)"),
  ("mp_countryside", "Countryside (Day)"),
  ("mp_dust", "The Village (Day)"),
  ("mp_dust_night", "The Village (Night)"),
  ("mp_european_city_summer", "Siegfriedlinie (Day)"),
  ("mp_european_city_winter", "Siegfriedlinie (Morning)"),
  ("mp_floodplain_storm", "Flooplain (Storm)"),
  ("mp_fort_beaver", "Forest Assault (Day)"),
  ("mp_fort_beaver_morning", "Forest Assault (Night)"),
  ...
  ("mp_french_farm", "Canal de Ypres (Day)"),
  ("mp_french_farm_storm", "Canal de Ypres (Storm)"),
  ("mp_german_village", "German Village (Day)"),
  ("mp_german_village_rain", "German Village (Night)"),
  ("mp_hougoumont", "Hougoumont (Day)"),
  ("mp_hougoumont_night", "Hougoumont (Night)"),
  ("mp_hungarian_plains", "Somerby Farm (Day)"),
  ("mp_hungarian_plains_cloud", "Somerby Farm (Cloudy)"),
  ("mp_theisland", "The Island (Day)"),
  ("mp_la_haye_sainte", "Poelcapelle (Day)"),
  ("mp_la_haye_sainte_night", "La Haye Sainte (Night)"),
  ("mp_landshut", "Hill 87 (Day)"),
  ("mp_landshut_night", "Hill 87 (Night)"),
  ("mp_minden", "Canal de Nord (Bot)"),
  ("mp_minden_night", "Canal de Nord (Day)"),
  ("mp_oaksfield_day", "Battle of the Ardennes (Day)"),
  ("mp_oaksfield_storm", "Battle of the Ardennes (Storm)"),
  ...
  ("mp_schemmerbach", "Bois D'Argonne (Day)"),
  ("mp_schemmerbach_storm", "Bois D'Argonne (Storm)"),
  ...
  ("mp_spanish_mountain_pass", "Ypres Salient (Day)"),
  ("mp_spanish_mountain_pass_evening", "Ypres Salient (Storm)"),
  ("mp_spanish_village", "Verdun (Day)"),
  ("mp_spanish_village_evening", "Verdun (Evening)"),
  ("mp_strangefields", "Strangefields (Fog)"),
  ("mp_strangefields_storm", "Strangefields (Storm)"),
  ("mp_swamp", "baillie's swaggy tunnels"),
...
#multiplayer game type names
  ...
  ("ban_leaker_message", "You are banned forever from all servers for leaking the mod or contributing to the leak. Ignorantia legis non excusat. "),
  ...
  ("server_hq_base_retake_s1", "The {s1} is Retaking Their HQ!!"),
  ("server_hq_base_attack_s1", "The HQ of {s1} is Under Attack!!"),
  ...
  ("load_bomb", "Place Mortar Shell"),
  ("load_rocket", "Place Ammo Belt"),
  ...
  ("pick_up_bomb", "Take a Mortar Shell"),
  ("pick_up_rocket", "Pick Up"),
  ("play_piano", "Play Piano"),
  ("play_organ", "Play Gramophone"),
  ...
  ("organ_in_use", "Someone else is already playing the gramophone!"),
  ("toilet_in_use", "Someone else is already using the toilet!"),
  ("cannot_use_cannon", "You are not part of the Artillery Squad and cannot use cannons!"),
  ("cannot_use_rocket", "You are not part of the Heavy Machinegun Squad and cannot use machineguns!"),
  ...
  ("need_to_have_a_horse", "This cannon cannot be limbered!"),
  ...
  ("limit_grenadier", "Limit of Grenadiers in each team (%):"),
  ("limit_sentry", "Limit of Sentries in each team (%):"),
  ("limit_medic", "Limit of Field Medics in each team (%):"),
  ("limit_general_new", "Limit of Generals in each team (%):"),
  ("limit_heavy_grenadier", "Limit of Heavy Grenadiers in each team (%):"),
  ("limit_skirmisher", "Limit of Snipers in each team (%):"),
  ("limit_rifle", "Max Riflemen of Light Infantry count (%):"),
  ("limit_cavalry", "Limit of Light Machinegunners in each team (%):"),
  ...
  ("limit_rocket", "Limit of Heavy Machine Gunners in each team (%):"),
  ...
  ("admin_set_mod_variable_max_teamkills_before_kick_s0_reg1", "{s0} Set the amount of teamkills before auto-kick/ban to {reg1}."),
  ...
  ("admin_set_limit_sentry_s0_reg1", "{s0} Set the class limit for Sentries to {reg1} % of the team."),
  ("admin_set_limit_medic_s0_reg1", "{s0} Set the class limit for Field Medics to {reg1} % of the team."),
  ("admin_set_limit_general_new_s0_reg1", "{s0} Set the class limit for Generals to {reg1} % of the team."),
  ("admin_set_limit_heavy_grenadier_s0_reg1", "{s0} Set the class limit for Heavy Grenadiers to {reg1} % of the team."),
  ("admin_set_limit_skirmisher_s0_reg1", "{s0} Set the class limit for Snipers to {reg1} % of the team."),
  ("admin_set_limit_rifle_s0_reg1", "{s0} Set the class limit for Riflemen to {reg1} % of the Light Infantry."),
  ("admin_set_limit_cavalry_s0_reg1", "{s0} Set the class limit for Light Machinegunners to {reg1} % of the team."),
  ...
  ("admin_set_limit_rocket_s0_reg1", "{s0} Set the class limit for Heavy Machinegunners to {reg1} % of the team."),
  ...
  ("cheat_spawn_hammer", "Spawn Lightsaber"),
  ("cheat_spawn_hammer_s2", "{s2} Spawned a Lightsaber."),
  ...
  ("cheat_spawn_shotgun", "Spawn M4"),
  ("cheat_spawn_shotgun_s2", "The Almighty {s2} Spawned a M4."),
  ("cheat_spawn_rocketlauncher", "Spawn Holy Hand Grenade"),
  ("cheat_spawn_rocketlauncher_s2", "{s2} Spawned a Hand Grenade."),
  ("cheat_spawn_grenade", "Spawn RPG"),
  ("cheat_spawn_grenade_s2", "{s2} Spawned a RPG. Run for your life!"),
  ...
  ("cheat_spawn_horse", "Spawn Angry Elephant"),
  ("cheat_spawn_horse_s2", "{s2} Spawned an Angry Elephant."),
  ...
  ("intern_admin_chat", "Internal Admin Chat"),
  ...
  ("reset_map", "Reset Map"),
  ("reset_map_s2", "{s2} Reset the Map."),
  ("console_command","Admin Console"),
  ("player_kicked_cheating_s2","{s2} Is auto-kicked from the server for mismatching files with the servers'."),
  ...
  #Faction selection
  ("britain_name", "British Empire"),
  ("france_name", "French Republic"),
  ("prussia_name", "German Empire"),
  ...
  #Build Props
  ("ie_iron_plank","Iron Plank"),
  ("mm_stakes2_construct","Wooden Stakes"),
  ("sandbags_construct","Sandbags"),
  ("ie_barbedwire_construct","Small Barbedwire"),
  ("gabion_construct","Gabion"),
  ("fence_construct","Large Barbedwire"),
 ...
 # ("drum_prussia_2","Dessauer Marsch"),
  ...
  #BUGLE
  #British
  ("bugle_britain_1","Charge!"),
  ("bugle_britain_2","Advance!"),
  ("bugle_britain_3","Hold your position!"),
  ("bugle_britain_4","Retreat!"),
  #French
  ("bugle_france_1","Charge!"),
  ("bugle_france_2","Advance!"),
  ("bugle_france_3","Hold your position!"),
  ("buble_france_4","Retreat!"),
  #Prussian
  ("bugle_prussia_1","Charge!"),
  ("bugle_prussia_2","Advance!"),
  ("bugle_prussia_3","Hold your position!"),
  ("bugle_prussia_4","Retreat!"),
  ...
  #ORGAN
  ("organ_tune_1","Argonnerwald"),
  ("organ_tune_2","Die Watch am Rhein"),
  ("organ_tune_3","Heil dir im Siegerkranz"),
  ("organ_tune_4","Pariser Einzugsmarsch"),
  ("organ_tune_5","La Marseillaise"),
  ("organ_tune_6","La Toussaint Rouge"),
  ("organ_tune_7","Le Chant Du Depart"),
  ("organ_tune_8","Minuit Chrétiens"),
  ("organ_tune_9","It's a long way to Tipperary"),
  ("organ_tune_10","Oh it's a lovely war!"),
  ("organ_tune_11","We all went marching home"),
  ("organ_tune_12","Oui, Oui, Marie!"),
  ("organ_tune_13","Are we Downhearted?"),
  ("organ_tune_14","Goodbye-ee"),
  # ## CONQUEST FLAG NAMES ###
  #Undefined
  ("flag_reg3","Flag {reg3}"),
 ...
 # ("mp_arabian_harbour_flag_5","Marketplace"),
  ...
  ("mp_arabian_village_flag_1","Southern Trench"),
  ("mp_arabian_village_flag_2","Northern Trench"),
  ("mp_arabian_village_flag_3","No Man's Land"), 
  
  ("mp_dust_flag_1","Southern Trench"),
  ("mp_dust_flag_2","Northern Trench"),
  ("mp_dust_flag_3","Northern Barn"),
  ("mp_dust_flag_4","Southern Barn"),
  ("mp_dust_flag_5","Crashed Airplane"),
  
  ("mp_beach_flag_1","Main Trench"),
  ("mp_beach_flag_2","Bunker"),
  ("mp_beach_flag_3","North Western Trench"),
  ("mp_beach_flag_4","North Eastern Trench"),
  ("mp_beach_flag_5","Beach"),
  ("mp_beach_flag_6","Destroyed Barn"),
  
  ("mp_ardennes_flag_1","Forest"),
  ("mp_ardennes_flag_2","Trench"),
  ("mp_ardennes_flag_3","Road"),
  ("mp_ardennes_flag_4","Bridge"),
  ...
  ("mp_avignon_flag_1","North Eastern Trench"),
  ("mp_avignon_flag_2","South Eastern Trench"),
  ("mp_avignon_flag_3","North Western Trench"),
  ("mp_avignon_flag_4","South Western Trench"),
  ("mp_avignon_flag_5","Crashed airplane"),
  ("mp_avignon_flag_6","Middle Trench"),
  ("mp_avignon_flag_7","South Western Trench"),
  
  ("mp_borodino_flag_1","Northern Trench"),
  ("mp_borodino_flag_2","Middle Trench"),
  ("mp_borodino_flag_3","Southern Trench"),
  # ("mp_borodino_flag_4","Mill"),
  # ("mp_borodino_flag_5","Shevradino"),
  # ("mp_borodino_flag_6","Great Redoubt"),
  # ("mp_borodino_flag_7","Small Redoubt"),
  
  ("mp_columbia_hill_farm_flag_1","North Eastern Farmhouse"),
  ("mp_columbia_hill_farm_flag_2","South Western Trenches"),
  ("mp_columbia_hill_farm_flag_3","North Western Trenches"),
  ("mp_columbia_hill_farm_flag_4","Village"),
  
  ("mp_european_city_flag_1","Village"),
  ("mp_european_city_flag_2","Northern Bunker"),
  ("mp_european_city_flag_3","Street"),
  ("mp_european_city_flag_4","Western Forest"),
  ("mp_european_city_flag_5","South Western Trenches"),
  ("mp_european_city_flag_6","North Eastern Trenches"),
  ("mp_european_city_flag_7","North Western Trenches"),
  ("mp_european_city_flag_8","Eastern Forest"),
  ("mp_european_city_flag_9","No Man's Land"),
  
  ("mp_french_farm_flag_1","North Eastern Trench"),
  ("mp_french_farm_flag_2","South Eastern Trench"),
  ("mp_french_farm_flag_3","Outpost"),
  ("mp_french_farm_flag_4","Channel Trench"),
  
  ("mp_hungarian_plains_flag_1","Somerby Farm"),
  ("mp_hungarian_plains_flag_2","Artillery Position"),
  ("mp_hungarian_plains_flag_3","Mud Trench"),
  ("mp_hungarian_plains_flag_4","The Abandoned House"),
  ("mp_hungarian_plains_flag_5","Middle Trench"),
  
  ("mp_landshut_flag_1","North Trench"),
  ("mp_landshut_flag_2","South Trench"),
  ("mp_landshut_flag_3","The Red House"),
  ("mp_landshut_flag_4","Hill 87"),
  ...
  ("mp_champs_elysees_flag_1","Southern Street"),
  ("mp_champs_elysees_flag_2","Northern Street"),
  ("mp_champs_elysees_flag_3","Village"),
  ("mp_champs_elysees_flag_4","Forest"),
  ("mp_champs_elysees_flag_5","Farm"),
  ...
  ("mp_spanish_mountain_pass_flag_1","Jump-off line"),
  ("mp_spanish_mountain_pass_flag_2","Command Post"),
  ("mp_spanish_mountain_pass_flag_3","Middle"),
  ("mp_spanish_mountain_pass_flag_4","Mill"),
  ("mp_spanish_mountain_pass_flag_5","Outpost"),
# 
#  ("mp_spanish_mountain_pass_evening_flag_1","Jump-off line"),
#  ("mp_spanish_mountain_pass_evening_flag_2","Command Post"),
#  ("mp_spanish_mountain_pass_evening_flag_3","Middle"),
#  ("mp_spanish_mountain_pass_evening_flag_4","Mill"),
#  ("mp_spanish_mountain_pass_evening_5","West Outpost"),
 ...
 ("tutorial_info_26","This is the end of the tutorial. You now know all the basics of fighting in Mount&Blade: Napoleonic Wars. Press 'Tab' to leave this tutorial when you are ready.^^Good luck on the battlefield, sir! Dismissed for tea and crumpets!"),
  ...
  ("german_sniper","Scharfschutze"),
  ("french_sniper","Tireur d'Elite"),
  ("mg_gunner","Gunner"),
  ("french_bomber","Bomber"),
  ("artilleryman","Artilleryman"),
  ("call_artillery","Call Artillery"),
  ("mortar_squad","Mortar Squad"),
  ("pioneer","Pioneer"),
  ("mg_assistant","Assistant"),
  ("mg_ammo_bearer","Ammo Bearer"),
  ("ammo_count","{reg0} / {reg1}"),
